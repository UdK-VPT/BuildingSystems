...
# -*- coding: utf-8 -*-
#
# BuildingSystems documentation build configuration file, created by
...
htmlhelp_basename = 'BuildingSystemsdoc'
...
man_pages = [
    (master_doc, 'buildingsystems', 'BuildingSystems Documentation',
     [author], 1)
]
