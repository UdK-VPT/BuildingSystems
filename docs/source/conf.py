...
extensions = ['sphinx.ext.autodoc', 'mathjax', 'sphinxcontrib.bibtex']
...
project = u'Modelica library Building Systems'
...
html_title = "Modelica library Building Systems"
...
latex_documents = [
  ('index',
   'UserGuide_BuildingSystems.tex',
   u'Modelica library BuildingSystems',
   u'User Guide', 'manual'),
]
...
latex_logo = '_static/Logo_UdK_Berlin.png'
