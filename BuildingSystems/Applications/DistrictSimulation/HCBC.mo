...
model HCBC
  ...
  connect(surfacesToAmbience.toConstructionPorts[1], outerCapacity.toSurfacePort_1)
    annotation (Line(points={{-173.9,0},{-40,0},{-40,30},{-32,30}},color={127,0,0}));
  connect(surfacesToAmbience.toConstructionPorts[2], leftWindow.toSurfacePort_1)
    annotation (Line(points={{-173.9,0},{-40,0},{-40,-50},{-32,-50}},  color={127,0,0}));
  connect(surfacesToAmbience.toConstructionPorts[3], rightWindow.toSurfacePort_1)
    annotation (Line(points={{-173.9,0},{-173.9,0},{-40,0},{-40,-64},{-18,-64},{-18,-50},{-12,-50}},color={127,0,0}));
  connect(surfacesToAmbience.toConstructionPorts[4], frontWindow.toSurfacePort_1)
    annotation (Line(points={{-173.9,0},{-173.9,0},{-40,0},{-40,-64},{2,-64},{2,
          -50},{8,-50}},color={127,0,0}));
  connect(surfacesToAmbience.toConstructionPorts[5], backWindow.toSurfacePort_1)
...
equation
  ...
  connect(ambience.toSurfacePorts[1:5], building1.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[6:10], building2.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[11:15], building3.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[16:20], building5.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[186:190], building6.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[21:25], building7.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[26:30], building8.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[31:35], building9.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[36:40], building10.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[41:45], building11.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[46:50], building12.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[51:55], building13.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[56:60], building14.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[61:65], building16.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[66:70], building17.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[71:75], building21.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[76:80], building23.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[81:85], building25.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[86:90], building27.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[91:95], building29.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[96:100], building30.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[101:105], building33.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[106:110], building34.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[111:115], building35.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[116:120], building39.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[121:125], building40.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[126:130], building43.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[131:135], building44.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[136:140], building45.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[141:145], building46.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[146:150], building47.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[151:155], building48.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[156:160], building50.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[161:165], building51.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[166:170], building52.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[171:175], building53.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[176:180], building54.toAmbienceSurfacesPorts);
  connect(ambience.toSurfacePorts[181:185], building55.toAmbienceSurfacesPorts);

  connect(ambience.toAirPorts[1:5], building1.toAmbienceAirPorts);
  connect(ambience.toAirPorts[6:10], building2.toAmbienceAirPorts);
  connect(ambience.toAirPorts[11:15], building3.toAmbienceAirPorts);
  connect(ambience.toAirPorts[16:20], building5.toAmbienceAirPorts);
  connect(ambience.toAirPorts[186:190], building6.toAmbienceAirPorts);
  connect(ambience.toAirPorts[21:25], building7.toAmbienceAirPorts);
  connect(ambience.toAirPorts[26:30], building8.toAmbienceAirPorts);
  connect(ambience.toAirPorts[31:35], building9.toAmbienceAirPorts);
  connect(ambience.toAirPorts[36:40], building10.toAmbienceAirPorts);
  connect(ambience.toAirPorts[41:45], building11.toAmbienceAirPorts);
  connect(ambience.toAirPorts[46:50], building12.toAmbienceAirPorts);
  connect(ambience.toAirPorts[51:55], building13.toAmbienceAirPorts);
  connect(ambience.toAirPorts[56:60], building14.toAmbienceAirPorts);
  connect(ambience.toAirPorts[61:65], building16.toAmbienceAirPorts);
  connect(ambience.toAirPorts[66:70], building17.toAmbienceAirPorts);
  connect(ambience.toAirPorts[71:75], building21.toAmbienceAirPorts);
  connect(ambience.toAirPorts[76:80], building23.toAmbienceAirPorts);
  connect(ambience.toAirPorts[81:85], building25.toAmbienceAirPorts);
  connect(ambience.toAirPorts[86:90], building27.toAmbienceAirPorts);
  connect(ambience.toAirPorts[91:95], building29.toAmbienceAirPorts);
  connect(ambience.toAirPorts[96:100], building30.toAmbienceAirPorts);
  connect(ambience.toAirPorts[101:105], building33.toAmbienceAirPorts);
  connect(ambience.toAirPorts[106:110], building34.toAmbienceAirPorts);
  connect(ambience.toAirPorts[111:115], building35.toAmbienceAirPorts);
  connect(ambience.toAirPorts[116:120], building39.toAmbienceAirPorts);
  connect(ambience.toAirPorts[121:125], building40.toAmbienceAirPorts);
  connect(ambience.toAirPorts[126:130], building43.toAmbienceAirPorts);
  connect(ambience.toAirPorts[131:135], building44.toAmbienceAirPorts);
  connect(ambience.toAirPorts[136:140], building45.toAmbienceAirPorts);
  connect(ambience.toAirPorts[141:145], building46.toAmbienceAirPorts);
  connect(ambience.toAirPorts[146:150], building47.toAmbienceAirPorts);
  connect(ambience.toAirPorts[151:155], building48.toAmbienceAirPorts);
  connect(ambience.toAirPorts[156:160], building50.toAmbienceAirPorts);
  connect(ambience.toAirPorts[161:165], building51.toAmbienceAirPorts);
  connect(ambience.toAirPorts[166:170], building52.toAmbienceAirPorts);
  connect(ambience.toAirPorts[171:175], building53.toAmbienceAirPorts);
  connect(ambience.toAirPorts[176:180], building54.toAmbienceAirPorts);
  connect(ambience.toAirPorts[181:185], building55.toAmbienceAirPorts);
