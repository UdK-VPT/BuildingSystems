...
package BaseClasses "Base classes used in the District Heating Network package"
extends Modelica.Icons.BasesPackage;
  ...
  //Pipes and stations:
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p8(
      redeclare package Medium = Medium,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        Umodel(
        d_i=0.3,
        d_o=0.324,
        U1_constant=0.523),
      length=60.7,
      m_flow_nominal=181.5) annotation (Placement(transformation(
          extent={{-1.33013,7.69615},{1.33013,-7.69615}},
          rotation=-30,
          origin={200,-113})));

    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p9(
      redeclare package Medium = Medium,
      length=64.3,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.432,
        d_o=0.168),
      m_flow_nominal=35.7) annotation (Placement(transformation(
          extent={{6,5},{-6,-5}},
          rotation=90,
          origin={184,-95})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p11(
      redeclare package Medium = Medium,
      length=87.5,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.432,
        d_o=0.168),
      m_flow_nominal=32.24) annotation (Placement(transformation(
          extent={{6,5},{-6,-5}},
          rotation=180,
          origin={152,-89})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p14(
      redeclare package Medium = Medium,
      length=217.2,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.432,
        d_o=0.168),
      m_flow_nominal=17.7) annotation (Placement(transformation(
          extent={{4,4},{-4,-4}},
          rotation=180,
          origin={42,-106})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p10(
      redeclare package Medium = Medium,
      length=41.8,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.298,
        d_o=0.089),
      m_flow_nominal=3.44) annotation (Placement(transformation(
          extent={{6,5},{-6,-5}},
          rotation=270,
          origin={158,-117})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p12(
      redeclare package Medium = Medium,
      length=78.4,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        d_o=0.048,
        U1_constant=0.216),
      m_flow_nominal=1.22) annotation (Placement(transformation(
          extent={{6,5},{-6,-5}},
          rotation=180,
          origin={114,-105})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p13(
      redeclare package Medium = Medium,
      length=17.8,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.365,
        d_o=0.14),
      m_flow_nominal=13.3) annotation (Placement(transformation(
          extent={{4,4},{-4,-4}},
          rotation=180,
          origin={94,-76})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p15(
      redeclare package Medium = Medium,
      length=238.4,
      ...
      redeclare
        ...
        d_o=0.324)) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={162,-175})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p1(
      redeclare package Medium = Medium,
      length=98.6,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.31,
        d_o=0.114),
      m_flow_nominal=15.74) annotation (Placement(transformation(
          extent={{-7.33013,-2.69615},{7.33013,2.69615}},
          rotation=150,
          origin={222,-139})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p2(
      redeclare package Medium = Medium,
      length=35,
      m_flow_nominal=2.2,
      redeclare
        ...
        d_o=0.06)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={268,-153})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p7(
      redeclare package Medium = Medium,
      length=174.5,
      m_flow_nominal=4.66,
      redeclare
        ...
        d_i=0.08,
        d_o=0.089,
        U1_constant=0.298)) annotation (Placement(transformation(
          extent={{-6,5},{6,-5}},
          rotation=270,
          origin={336,-103})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p3(
      redeclare package Medium = Medium,
      length=15,
      ...
      redeclare
        ...
        d_o=0.114)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={250,-163})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p4(
      redeclare package Medium = Medium,
      length=76.8,
      m_flow_nominal=8.87,
      redeclare
        ...
        d_i=0.08,
        U1_constant=0.298,
        d_o=0.089)) annotation (Placement(transformation(
          extent={{-6,5},{6,-5}},
          rotation=90,
          origin={252,-183})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p6(
      redeclare package Medium = Medium,
      length=175.24,
      m_flow_nominal=4.56,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={200,-237})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p5(
      redeclare package Medium = Medium,
      length=17.4,
      m_flow_nominal=4.3,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={232,-195})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p16(
      redeclare package Medium = Medium,
      length=36.6,
      m_flow_nominal=17.1,
      redeclare
        ...
        d_o=0.114)) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={74,-257})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p17(
      redeclare package Medium = Medium,
      length=36.2,
      m_flow_nominal=12.4,
      redeclare
        ...
        d_o=0.114)) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={62,-277})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p19(
      redeclare package Medium = Medium,
      length=101,
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p23(
      ...
      redeclare
        ...
        d_i=0.04,
        U1_constant=0.216,
        d_o=0.048)) annotation (Placement(transformation(
          extent={{-6,-5},{6,5}},
          rotation=270,
          origin={50,-199})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p22(
      redeclare package Medium = Medium,
      length=36.8,
      m_flow_nominal=4.7,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={34,-189})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p25(
      redeclare package Medium = Medium,
      length=13.34,
      m_flow_nominal=7.3,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p34(
      ...
      redeclare
        ...
        d_i=0.2,
        U1_constant=0.477,
        d_o=0.22)) annotation (Placement(transformation(
          extent={{-6,-5},{6,5}},
          rotation=270,
          origin={-94,-99})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p35(
      redeclare package Medium = Medium,
      length=200.5,
      ...
      redeclare
        ...
        d_o=0.324)) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-82,-33})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p36(
      redeclare package Medium = Medium,
      length=157.4,
      m_flow_nominal=13.5,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p41(
      ...
      redeclare
        ...
        d_o=0.06)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-240,49})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p37(
      redeclare package Medium = Medium,
      length=21,
      m_flow_nominal=7.62,
      redeclare
        ...
        d_o=0.114)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-196,33})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p27(
      redeclare package Medium = Medium,
      length=28.6,
      m_flow_nominal=30,
      redeclare
        ...
        d_o=0.22)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-104,-129})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p30(
      redeclare package Medium = Medium,
      length=41,
      m_flow_nominal=10.7,
      redeclare
        ...
        d_o=0.14)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-156,-109})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p31(
      redeclare package Medium = Medium,
      length=35.8,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        ...
        U1_constant=0.179,
        d_o=0.027),
      m_flow_nominal=0.34) annotation (Placement(transformation(
          extent={{6,5},{-6,-5}},
          rotation=270,
          origin={-152,-135})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p29(
      redeclare package Medium = Medium,
      redeclare
        Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPrescribed
        Umodel(
        ...
        d_o=0.089),
      length=16.76,
      m_flow_nominal=11.04) annotation (Placement(transformation(
          extent={{6,5},{-6,-5}},
          rotation=180,
          origin={-136,-121})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p28(
      redeclare package Medium = Medium,
      length=50.2,
      m_flow_nominal=29.1,
      redeclare
        ...
        d_o=0.22)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-122,-133})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p32(
      redeclare package Medium = Medium,
      length=19.17,
      m_flow_nominal=18.1,
      redeclare
        ...
        d_o=0.168)) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-142,-173})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p33(
      redeclare package Medium = Medium,
      length=104,
      ...
      redeclare
        ...
        d_o=0.168)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-130,-193})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p57(
      redeclare package Medium = Medium,
      length=230,
      m_flow_nominal=4.5,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=-30,
          origin={-220,253})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p55(
      redeclare package Medium = Medium,
      length=102.6,
      m_flow_nominal=10.6,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=-30,
          origin={-180,231})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p42(
      redeclare package Medium = Medium,
      length=100,
      m_flow_nominal=62.7,
      redeclare
        ...
        d_o=0.22)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-138,15})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p43(
      redeclare package Medium = Medium,
      length=41,
      m_flow_nominal=2.63,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p44(
      ...
      redeclare
        ...
        d_o=0.22)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-116,75})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p48(
      redeclare package Medium = Medium,
      length=20.2,
      m_flow_nominal=4.47,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-160,173})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p46(
      redeclare package Medium = Medium,
      length=13,
      m_flow_nominal=1.8,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p58(
      ...
      redeclare
        ...
        d_o=0.168)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-122,119})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p60(
      redeclare package Medium = Medium,
      length=34,
      m_flow_nominal=37.6,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p61(
      ...
      redeclare
        ...
        d_o=0.048)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-92,139})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p62(
      redeclare package Medium = Medium,
      length=66,
      m_flow_nominal=36.4,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p47(
      ...
      redeclare
        ...
        d_o=0.114)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-146,155})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p49(
      redeclare package Medium = Medium,
      length=32,
      m_flow_nominal=15.7,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p52(
      ...
      redeclare
        ...
        d_o=0.048)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-102,195})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p64(
      redeclare package Medium = Medium,
      length=42.42,
      m_flow_nominal=34,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p68(
      ...
      redeclare
        ...
        d_o=0.14)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-18,89})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p67(
      redeclare package Medium = Medium,
      length=82.1,
      m_flow_nominal=7.5,
      redeclare
        ...
        d_o=0.114)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-28,131})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p66(
      redeclare package Medium = Medium,
      length=11,
      m_flow_nominal=1.97,
      redeclare
        ...
        d_o=0.06)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-42,119})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p72(
      redeclare package Medium = Medium,
      length=20.3,
      m_flow_nominal=11,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p75(
      ...
      redeclare
        ...
        d_o=0.06)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={68,35})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p69(
      redeclare package Medium = Medium,
      length=26.3,
      m_flow_nominal=10.1,
      redeclare
    ...
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p71(
      ...
      redeclare
        ...
        d_o=0.076)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={14,65})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p65(
      redeclare package Medium = Medium,
      length=25.2,
      m_flow_nominal=9.51,
      redeclare
        ...
        d_o=0.089)) annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-24,111})));
    Technologies.DistrictHeatingNetworks.UndergroundPipes.ParallelPipes p63(
      redeclare package Medium = Medium,
      length=60.68,
      m_flow_nominal=2.34,
      redeclare
