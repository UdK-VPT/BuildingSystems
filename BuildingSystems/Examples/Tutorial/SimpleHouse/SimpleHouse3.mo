...
model SimpleHouse3 "Air model"
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor conRes(R=1/hWall/
      ...
      Placement(transformation(
        ...
        rotation=270,
        origin={110,20})));
  BuildingSystems.Fluid.MixingVolumes.MixingVolume zon(
...
src=\"modelica://BuildingSystems/Resources/Images/Examples/Tutorial/SimpleHouse/result3.png\" width=\"1000\"/>
</p>
</html>"),
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Examples/Tutorial/SimpleHouse/SimpleHouse3.mos"
        "Simulate and plot"));
end SimpleHouse3;
