...
model SimpleHouse0
  ...
  package MediumAir = BuildingSystems.Media.Air "Medium model for air";
  package MediumWater = BuildingSystems.Media.Water "Medium model for water";
...
Replace IDEAS by BuildingSystems models and general revision/update of the model.
</li>
<li>
...
<a href=\"modelica://BuildingSystems.Examples.Tutorial.SimpleHouse\">BuildingSystems.Examples.Tutorial.SimpleHouse</a>
tutorial.
...
(<a href=\"https://github.com/open-ideas/__CrashCourse__\">https://github.com/open-ideas/__CrashCourse__</a>).
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Examples/Tutorial/SimpleHouse/SimpleHouse0.mos"
        "Simulate and plot"));
end SimpleHouse0;
