within BuildingSystems.Examples;
model SimpleHouse
...
Move the example model to <a href=\"modelica://BuildingSystems.Examples\">BuildingSystems.Examples</a>, 
...
<a href=\"modelica://BuildingSystems.Examples.Tutorial.SimpleHouse\">
BuildingSystems.Examples.Tutorial.SimpleHouse</a>.
...
a proportional-controller instead of a hysteresis controller.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Examples/SimpleHouse.mos"
        "Simulate and plot"));
end SimpleHouse;
