...
model Central
  extends
    BuildingSystems.Technologies.DistrictHeatingNetworks.EnergyProductionUnits.BaseClasses.PartialCentral;
  Fluid.Sources.MassFlowSource_T source(
    redeclare package Medium = Medium,
    m_flow=999999999,
    T=T,
    nPorts=1) annotation (Placement(transformation(extent={{36,2},{16,22}})));
  Fluid.Sources.FixedBoundary bou(redeclare package Medium = Medium, nPorts=1)
