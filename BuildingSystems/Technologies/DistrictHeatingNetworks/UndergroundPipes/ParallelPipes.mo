...
extends BuildingSystems.Fluid.Interfaces.PartialFourPort(final allowFlowReversal1 = allowFlowReversal,final allowFlowReversal2 = allowFlowReversal,redeclare
  ...
  parameter Modelica.SIunits.Pressure dp_nominal "Nominal pressure drop" annotation(Dialog(group = "Nominal condition"));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a port_a annotation (Placement(transformation(extent={{-10,88},{10,108}})));
  BuildingSystems.Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.Qmodel
                                                                                           qmodel(len=length, nEle=nNodes,
  ...
  replaceable
    BuildingSystems.Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPartialClass
        ...
        constrainedby
    BuildingSystems.Technologies.DistrictHeatingNetworks.UndergroundPipes.BaseClasses.DHN_Umodels.UPartialClass
    "Heat transfer coefficient model"        annotation (   choicesAllMatching=true, Placement(transformation(extent={{62,-10},{42,10}})));
