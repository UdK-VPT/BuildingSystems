...
class ReciprocatingCompressor(object):
    ...
    def modelicaModelPath(self):
        ...
        Usage: Type
           ...
           'BuildingSystems.Fluid.HeatPumps.Compressors.ReciprocatingCompressor'

        """
        return 'BuildingSystems.Fluid.HeatPumps.Compressors.ReciprocatingCompressor'
...
#                  (0., 1.), (0., None), (0., None)]
    ...
    def modelicaModelPath(self):
        ...
        Usage: Type
           >>> com = ScrollCompressor([2.362, 0.00287, 0.0041, 0.922, 398.7, 6.49])
           >>> com.modelicaModelPath()
           'BuildingSystems.Fluid.HeatPumps.Compressors.ScrollCompressor'

        """
        return 'BuildingSystems.Fluid.HeatPumps.Compressors.ScrollCompressor'
