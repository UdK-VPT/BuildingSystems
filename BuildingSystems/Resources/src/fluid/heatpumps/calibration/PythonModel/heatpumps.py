...
class SingleStageHeatPump(object):
    ...
    def modelicaCalibrationModelPath(self):
        ...
        :return: Full path to the compressor model in the BuildingSystems library.
        ...
        Usage: Type
           ...
           'BuildingSystems.Fluid.HeatPumps.Calibration.ScrollWaterToWater'

        """
        if self.com.modelicaModelPath() == "BuildingSystems.Fluid.HeatPumps.Compressors.ReciprocatingCompressor":
            return "BuildingSystems.Fluid.HeatPumps.Calibration.ReciprocatingWaterToWater"
        elif self.com.modelicaModelPath() == "BuildingSystems.Fluid.HeatPumps.Compressors.ScrollCompressor":
            return "BuildingSystems.Fluid.HeatPumps.Calibration.ScrollWaterToWater"
    ...
    def modelicaModelPath(self):
        ...
        Usage: Type
           ...
           'BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater'

        """
        if self.com.modelicaModelPath() == "BuildingSystems.Fluid.HeatPumps.Compressors.ReciprocatingCompressor":
            return "BuildingSystems.Fluid.HeatPumps.ReciprocatingWaterToWater"
        elif self.com.modelicaModelPath() == "BuildingSystems.Fluid.HeatPumps.Compressors.ScrollCompressor":
            return "BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater"
