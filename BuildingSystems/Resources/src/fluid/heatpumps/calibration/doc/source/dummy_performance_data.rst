...
`BuildingSystems/Resources/src/fluid/heatpumps/calibration/Examples/somePerformanceData.txt`.

The following script can be found in
`BuildingSystems/Resources/src/fluid/heatpumps/calibration/Examples/example_calibration.py`:
