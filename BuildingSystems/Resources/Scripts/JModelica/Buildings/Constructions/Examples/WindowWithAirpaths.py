...
model_name = 'BuildingSystems.Buildings.Constructions.Examples.WindowWithAirpaths'
...
P.xlabel('Time (s)')
# Mass flow rates
y1 = res['window.port_a1.m_flow']
y2 = res['window.port_b1.m_flow']
P.subplot(3,1,2)
P.plot(t, y1, t, y2)
P.legend(['window.port_a1.m_flow','window.port_b1.m_flow'])
