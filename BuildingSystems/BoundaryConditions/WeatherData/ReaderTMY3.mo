...
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput HGloHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if
         (HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2") if
         (HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or
          HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
...
protected
  ...
  Modelica.Blocks.Math.Gain conRelHum(final k=0.01) if
       relHumSou == BuildingSystems.BoundaryConditions.Types.DataSource.File
  ...
  SkyTemperature.BlackBody TBlaSkyCom(final calTSky=calTSky) if
       TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.File
