within BuildingSystems.BoundaryConditions.WeatherData;
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2") if
                          (HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
  ...
  parameter BuildingSystems.BoundaryConditions.Types.SkyTemperatureCalculation
    calTSky=BuildingSystems.BoundaryConditions.Types.SkyTemperatureCalculation.TemperaturesAndSkyCover
...
protected
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckTemperature
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.ConvertRelativeHumidity
  ...
  SkyTemperature.BlackBody TBlaSkyCom(final calTSky=calTSky) if
       not (TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter or
            TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.Input)
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LocalCivilTime locTim(
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.ConvertTime conTim1(
  ...
  BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulPhi tWetBul_TDryBulXi(
  ...
  Modelica.Blocks.Math.Gain conTotSkyCov(final k=0.1) if
       totSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
    annotation (Placement(transformation(extent={{120,-40},{140,-20}})));
  Modelica.Blocks.Math.Gain conOpaSkyCov(final k=0.1) if
       opaSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
    annotation (Placement(transformation(extent={{120,-158},{140,-138}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckBlackBodySkyTemperature cheTemBlaSky(TMin=0)
...
equation
  ...
  if pAtmSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    pAtm_in_internal = pAtm;
  elseif pAtmSou == BuildingSystems.BoundaryConditions.Types.DataSource.File then
  ...
  if ceiHeiSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    ceiHei_in_internal = ceiHei;
  elseif ceiHeiSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if totSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    totSkyCov_in_internal = totSkyCov;
  elseif totSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if opaSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    opaSkyCov_in_internal = opaSkyCov;
  elseif opaSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDewPoiSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    TDewPoi_in_internal = TDewPoi;
  elseif TDewPoiSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDryBulSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    TDryBul_in_internal = TDryBul;
  elseif TDryBulSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    TBlaSky_in_internal = TBlaSky;
  elseif TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if relHumSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    relHum_in_internal = relHum;
  elseif relHumSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if winSpeSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    winSpe_in_internal = winSpe;
  elseif winSpeSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if winDirSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    winDir_in_internal = winDir;
  elseif winDirSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
  ...
  if HSou ==  BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
    connect(HGloHor_in, HGloHor_in_internal)
      "Get HGloHor using user input file";
  elseif HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  if HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
     connect(HDifHor_in, HDifHor_in_internal)
      "Get HDifHor using user input file";
  elseif  HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
  ...
  if HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
     connect(HDirNor_in, HDirNor_in_internal)
      "Get HDirNor using user input file";
  elseif  HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor then
      BuildingSystems.Utilities.Math.Functions.smoothMin(
        solCon,
        (HGloHor_in_internal -HDifHor_in_internal)*
          BuildingSystems.Utilities.Math.Functions.spliceFunction(
            x=cos(zenAng.zen),
            pos=BuildingSystems.Utilities.Math.Functions.inverseXRegularized(cos(zenAng.zen),epsCos),
            neg=0,
            deltax=epsCos),
        0.1)
        = HDirNor_in_internal
  ...
  if HInfHorSou == BuildingSystems.BoundaryConditions.Types.DataSource.Parameter then
    HInfHor_in_internal = HInfHor;
  elseif HInfHorSou == BuildingSystems.BoundaryConditions.Types.DataSource.Input then
...
<code>BuildingSystems/Resources/bin/ConvertWeatherData.jar</code> that converts
...
when exporting <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone\">
BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone</a>
as an FMU. Instead, if the weather file is specified as a Modelica, URI, syntax such as
<code>Modelica.Utilities.Files.loadResource(\"modelica://BuildingSystems/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos\")</code>
should be used.<br/>
This is for
...
<a href=\"modelica://BuildingSystems.BoundaryConditions.SkyTemperature.Examples.BlackBody\">TBlaSky</a>
are consistent.
This is for
