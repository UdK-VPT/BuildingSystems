...
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput TBlaSky_in(
    ...
    displayUnit="degC",
    final unit="K")
 if (TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.Input)
    "Black-body sky temperature"
  ...
  Modelica.Blocks.Interfaces.RealInput HGloHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2")
      if (HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or
          HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
  ...
  Modelica.Blocks.Interfaces.RealInput HDifHor_in(
    ...
    final unit="W/m2")
      if (HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or
          HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor)
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2")
      if (HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or
          HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
...
//--------------------------------------------------------------
  ...
  final parameter Modelica.Units.SI.Angle lon(displayUnit="deg") =
    BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.getLongitudeTMY3(filNam)
    "Longitude";
  final parameter Modelica.Units.SI.Angle lat(displayUnit="deg") =
    BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.getLatitudeTMY3(filNam)
    "Latitude";
  ...
  final parameter Modelica.Units.SI.Length alt(displayUnit="m") =
    BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.getAltitudeLocationTMY3(
    filNam) "Location altitude above sea level";

protected
  final parameter Modelica.Units.SI.Time[2] timeSpan=
      BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.getTimeSpanTMY3(filNam,
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckDewPointTemperature
  ...
  Modelica.Blocks.Math.Gain conRelHum(final k=0.01)
    if relHumSou == BuildingSystems.BoundaryConditions.Types.DataSource.File
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterRelativeHumidity limRelHum
    "Limiter for relative humidity"
    annotation (Placement(transformation(extent={{160,20},{180,40}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterTotalSkyCover limTotSkyCov
    "Limits the total sky cover"
    annotation (Placement(transformation(extent={{160,-40},{180,-20}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterOpaqueSkyCover limOpaSkyCov
    "Limits the opaque sky cover"
    annotation (Placement(transformation(extent={{160,-160},{180,-140}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterCeilingHeight limCeiHei "Limits the ceiling height"
    annotation (Placement(transformation(extent={{160,-120},{180,-100}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterWindSpeed limWinSpe "Limits the wind speed"
    annotation (Placement(transformation(extent={{160,-80},{180,-60}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterHorizontalInfraredIrradiation limHorInfRad
    "Limits the horizontal infrared irradiation"
    annotation (Placement(transformation(extent={{160,60},{180,80}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.LimiterWindDirection limWinDir
  ...
  SkyTemperature.BlackBody TBlaSkyCom(final calTSky=calTSky)
    if TBlaSkySou == BuildingSystems.BoundaryConditions.Types.DataSource.File
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.ConvertTime conTimMin(final
  ...
  Modelica.Blocks.Math.Gain conTotSkyCov(final k=0.1)
    if totSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
    annotation (Placement(transformation(extent={{40,-40},{60,-20}})));
  Modelica.Blocks.Math.Gain conOpaSkyCov(final k=0.1)
    if opaSkyCovSou == BuildingSystems.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
