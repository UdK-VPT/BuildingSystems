...
protected
  Modelica.Blocks.Tables.CombiTable1Ds datRea(
    ...
    final fileName=BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath(filNam),
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckBlackBodySkyTemperature
                                                                                  cheTemBlaSky(TMin=0)
...
equation
  ...
  elseif  HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor then
      (HGloHor_in_internal -HDifHor_in_internal)/BuildingSystems.Utilities.Math.Functions.smoothMax(x1=cos(zenAng.zen), x2=epsCos, deltaX=0.1*epsCos)
       = HDirNor_in_internal
...
<a href=\"modelica://BuildingSystems.Rooms.Validation.MixedAirInitialization\">
