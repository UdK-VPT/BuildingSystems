...
model ThreeYears_usingTwoYearDataNegativeStart
  ...
  extends
    BuildingSystems.BoundaryConditions.WeatherData.Validation.ThreeYears_usingTwoYearData;

  annotation (experiment(
      StartTime=-47174400,
      StopTime=47433600,
      Tolerance=1e-006),
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/ThreeYears_usingTwoYearDataNegativeStart.mos"
        "Simulate and plot"),
