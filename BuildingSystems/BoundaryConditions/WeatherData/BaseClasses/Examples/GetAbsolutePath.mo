...
model GetAbsolutePath "Test model to get the absolute path of a URI"
  ...
  parameter String f = Modelica.Utilities.Files.loadResource("modelica://BuildingSystems/package.mo")
   "Name of a file that exists";
  parameter String fAbs=
    BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath(uri=f)
    "Absolute path of f";
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/GetAbsolutePath.mos"
        "Simulate and plot"),
