...
model CheckPressure "Test model for pressure check"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckPressure chePre
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckPressure.mos"
        "Simulate and plot"));
end CheckPressure;
