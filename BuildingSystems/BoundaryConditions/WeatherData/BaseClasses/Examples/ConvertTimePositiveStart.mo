...
model ConvertTimePositiveStart
  ...
  extends BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.Examples.ConvertTime;
  annotation (
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertTimePositiveStart.mos"
        "Simulate and plot"));
