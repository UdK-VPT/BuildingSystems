...
model CheckWindDirection "Test model for wind direction check"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckWindDirection
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckWindDirection.mos"
        "Simulate and plot"));
