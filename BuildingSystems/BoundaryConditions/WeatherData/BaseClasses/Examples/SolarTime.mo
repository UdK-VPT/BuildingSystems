...
model SolarTime "Test model for solar time"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.SolarTime solTim
    "Block that computes the solar time"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.EquationOfTime eqnTim
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/SolarTime.mos"
        "Simulate and plot"));
end SolarTime;
