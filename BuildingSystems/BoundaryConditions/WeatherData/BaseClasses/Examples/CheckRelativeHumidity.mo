...
model CheckRelativeHumidity "Test model for CheckRelativeHumidity"
  extends
    BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.Examples.ConvertRelativeHumidity;

  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckRelativeHumidity cheRelHum
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckRelativeHumidity.mos"
        "Simulate and plot"));
