...
model CheckTemperature "Test model for CheckTemperature"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.BaseClasses.CheckDryBulbTemperature
  ...
  BuildingSystems.Utilities.Time.ModelTime modTim
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckTemperature.mos"
        "Simulate and plot"));
