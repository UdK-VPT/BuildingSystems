...
equation
  alt_c=Modelica.Math.cos(BuildingSystems.Utilities.Math.Functions.smoothLimit(
  ...
  verAzi=Modelica.Math.acos(
       BuildingSystems.Utilities.Math.Functions.smoothLimit(x=rat, l=-1+deltaX, u=1-deltaX, deltaX=deltaX/10));

  annotation (Icon(graphics={Bitmap(extent={{-90,-90},{90,90}}, fileName=
              "modelica://BuildingSystems/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/WallSolarAzimuth.png")}),
...
<a href=\"modelica://BuildingSystems.HeatTransfer.Windows.BaseClasses.Examples.Overhang\">
BuildingSystems.HeatTransfer.Windows.BaseClasses.Examples.Overhang</a>.
</li>
<li>
