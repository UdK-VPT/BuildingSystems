...
model IncidenceAngle "Test model for incidence angle"
  ...
  BuildingSystems.BoundaryConditions.SolarGeometry.BaseClasses.IncidenceAngle incAng(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/IncidenceAngle.mos"
        "Simulate and plot"));
end IncidenceAngle;
