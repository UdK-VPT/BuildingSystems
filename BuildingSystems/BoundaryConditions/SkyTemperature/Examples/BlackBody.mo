within BuildingSystems.BoundaryConditions.SkyTemperature.Examples;
model BlackBody "Test model for black body sky temperature"
  ...
  BuildingSystems.BoundaryConditions.SkyTemperature.BlackBody TBlaSky
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
      ...
      Placement(transformation(extent={{0,0},{20,20}}), iconTransformation(
          extent={{0,0},{2,2}})));
  BuildingSystems.BoundaryConditions.SkyTemperature.BlackBody TBlaSkyIrr(calTSky=
        BuildingSystems.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation)
...
experiment(Tolerance=1e-6, StartTime=0, StopTime=86400),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/SkyTemperature/Examples/BlackBody.mos"
        "Simulate and plot"),
