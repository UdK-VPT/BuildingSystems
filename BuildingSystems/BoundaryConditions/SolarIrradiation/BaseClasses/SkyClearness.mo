within BuildingSystems.BoundaryConditions.SolarIrradiation.BaseClasses;
...
equation
  tmp1 =  k*zen^3;
  HDifHorBou = BuildingSystems.Utilities.Math.Functions.smoothMax(
                 x1 = HDifHor,
                 x2 = hSmall,
                 deltaX = deltaX);
  ...
  skyCle = BuildingSystems.Utilities.Math.Functions.smoothLimit(
...
<p>
In the <code>BuildingSystems</code> library, <code>HGloHor</code>
...
<p>
The function call
<code>BuildingSystems.Utilities.Math.Functions.smoothMax</code>
