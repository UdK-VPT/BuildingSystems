...
model DiffuseIsotropic
  ...
  BuildingSystems.BoundaryConditions.SolarIrradiation.BaseClasses.DiffuseIsotropic
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/DiffuseIsotropic.mos"
        "Simulate and plot"));
