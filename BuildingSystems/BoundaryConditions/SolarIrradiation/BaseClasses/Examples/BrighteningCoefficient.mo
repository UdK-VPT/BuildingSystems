...
model BrighteningCoefficient "Test model for brightening coeffcients"
  ...
  BuildingSystems.BoundaryConditions.SolarIrradiation.BaseClasses.BrighteningCoefficient
  ...
  BuildingSystems.BoundaryConditions.SolarIrradiation.BaseClasses.SkyBrightness
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/BrighteningCoefficient.mos" "run"));
