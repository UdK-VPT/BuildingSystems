...
model DirectTiltedSurface
  ...
  BuildingSystems.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirRoo(
    til=BuildingSystems.Types.Tilt.Ceiling,
    lat=0.6457718232379,
    azi=0.78539816339745) "Direct irradiation on roof"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  BuildingSystems.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirFlo(
    til=BuildingSystems.Types.Tilt.Floor,
    lat=0.6457718232379,
    azi=0.78539816339745) "Direct irradiation on floor"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
  BuildingSystems.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirWal(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/Examples/DirectTiltedSurface.mos"
        "Simulate and plot"),
