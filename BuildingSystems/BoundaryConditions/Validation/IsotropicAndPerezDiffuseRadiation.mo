...
model IsotropicAndPerezDiffuseRadiation
  ...
  extends BuildingSystems.BoundaryConditions.SolarIrradiation.BaseClasses.PartialSolarIrradiation;
  ...
  parameter Modelica.Units.SI.Angle lat(displayUnit="deg") "Latitude angle";
