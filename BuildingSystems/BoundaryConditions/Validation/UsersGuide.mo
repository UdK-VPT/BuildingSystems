within BuildingSystems.BoundaryConditions.Validation;
package UsersGuide
  "User's Guide"
  ...
  annotation (
    ...
    Documentation(
      info="<html>
<p>
The package <a href=\"modelica://BuildingSystems.BoundaryConditions.Validation.BESTEST\">BuildingSystems.BoundaryConditions.Validation.BESTEST</a>
...
<li>
<a href=\"modelica://BuildingSystems.BoundaryConditions.SkyTemperature.BlackBody\">Sky black body temperature</a>
calculated using Horizontal radiation or dew point temperature and sky cover.
</li>
<li>Diffused radiation calculated using <a href=\"modelica://BuildingSystems.BoundaryConditions.SolarIrradiation.DiffusePerez\">Perez</a> and
<a href=\"modelica://BuildingSystems.BoundaryConditions.SolarIrradiation.DiffuseIsotropic\">Isotropic</a> sky models</li>
</ul>
...
<pre>
cd BuildingSystems/Resources/Data/BoundaryConditions/Validation/BESTEST
...
<ul>
<li>Clone the last master branch of the BuildingSystems repository into a temporary directory</li>
