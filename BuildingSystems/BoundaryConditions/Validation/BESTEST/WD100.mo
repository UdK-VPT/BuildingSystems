...
model WD100
  ...
  WeatherData.ReaderTMY3 weaDatHHorIR(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
      "modelica://BuildingSystems/Resources/Data/BoundaryConditions/Validation/BESTEST/725650.mos"),
    calTSky=BuildingSystems.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation)
  ...
  IsotropicAndPerezDiffuseRadiation azi000til00(
    til=BuildingSystems.Types.Tilt.Ceiling,
    lat=lat,
  ...
  IsotropicAndPerezDiffuseRadiation azi000til90(
    til=BuildingSystems.Types.Tilt.Wall,
    lat=lat,
    azi=BuildingSystems.Types.Azimuth.S,
    rho=rho)
  ...
  IsotropicAndPerezDiffuseRadiation azi315til90(
    til=BuildingSystems.Types.Tilt.Wall,
    lat=lat,
    azi=BuildingSystems.Types.Azimuth.SE,
    rho=rho)
  ...
  IsotropicAndPerezDiffuseRadiation azi045til90(
    til=BuildingSystems.Types.Tilt.Wall,
    lat=lat,
    azi=BuildingSystems.Types.Azimuth.SW,
    rho=rho)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD100.mos" "Simulate and plot"),
    Documentation(
      info="<html>
...
The model
<a href=\"modelica://BuildingSystems.BoundaryConditions.Validation.IsotropicAndPerezDiffuseRadiation\">BuildingSystems.BoundaryConditions.Validation.IsotropicAndPerezDiffuseRadiation</a>
