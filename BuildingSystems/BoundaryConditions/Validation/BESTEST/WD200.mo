...
model WD200
  ...
  extends WD100(
    ...
    weaDatHHorIR(
      filNam=Modelica.Utilities.Files.loadResource(
        "modelica://BuildingSystems/Resources/Data/BoundaryConditions/Validation/BESTEST/722190.mos")),
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD200.mos" "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
<li>
