...
model WD400
  ...
  extends WD100(
    ...
    weaDatHHorIR(
      filNam=Modelica.Utilities.Files.loadResource(
        "modelica://BuildingSystems/Resources/Data/BoundaryConditions/Validation/BESTEST/700260.mos")),
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD400.mos" "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
<li>
