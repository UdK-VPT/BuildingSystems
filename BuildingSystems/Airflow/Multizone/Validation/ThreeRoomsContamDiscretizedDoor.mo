...
model ThreeRoomsContamDiscretizedDoor
  ...
  extends BuildingSystems.Airflow.Multizone.Validation.ThreeRoomsContam(
    redeclare BuildingSystems.Airflow.Multizone.DoorDiscretizedOperable dooOpeClo(
...
experiment(Tolerance=1e-06, StopTime=3600),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Airflow/Multizone/Validation/ThreeRoomsContamDiscretizedDoor.mos"
        "Simulate and plot"),
