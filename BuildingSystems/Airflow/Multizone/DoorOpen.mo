...
model DoorOpen
  ...
  extends BuildingSystems.Airflow.Multizone.BaseClasses.Door(
...
equation
  ...
  VABp_flow = BuildingSystems.Airflow.Multizone.BaseClasses.powerLawFixedM(C=CVal,
  ...
  mABt_flow = BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
      k=kT,
...
<a href=\"modelica://BuildingSystems.Airflow.Multizone.DoorDiscretizedOpen\">
BuildingSystems.Airflow.Multizone.DoorDiscretizedOpen</a>.
</p>
<h4>References</h4>
<ul>
<li>
