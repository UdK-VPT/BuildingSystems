...
initial equation
  ...
  assert(densitySelection == BuildingSystems.Airflow.Multizone.Types.densitySelection.fromTop
     or densitySelection == BuildingSystems.Airflow.Multizone.Types.densitySelection.fromBottom
     or densitySelection == BuildingSystems.Airflow.Multizone.Types.densitySelection.actual,
...
equation
  ...
  if (densitySelection == BuildingSystems.Airflow.Multizone.Types.densitySelection.fromTop) then
      Xi = inStream(port_a.Xi_outflow);
      rho = BuildingSystems.Utilities.Psychrometrics.Functions.density_pTX(
        p=port_a.p,
        T=Medium.temperature(Medium.setState_phX(port_a.p, inStream(port_a.h_outflow), Xi)),
        X_w=if Medium.nXi == 0 then 0 else Xi[1]);
  elseif (densitySelection == BuildingSystems.Airflow.Multizone.Types.densitySelection.fromBottom) then
...
<a href=\"modelica://BuildingSystems.Airflow.Multizone.MediumColumnDynamic\">
BuildingSystems.Airflow.Multizone.MediumColumnDynamic</a> instead of this model.
</p>
</html>",
revisions="<html>
<ul>
...
BuildingSystems.Utilities.Psychrometrics.Functions.density_pTX</a>
for the density computation
as
<a href=\"modelica://BuildingSystems.Media.Air.density\">
BuildingSystems.Media.Air.density</a>
...
to address issue
<a href=\"https://github.com/lbl-srg/modelica-BuildingSystems/issues/311\">#311</a>.
</li>
