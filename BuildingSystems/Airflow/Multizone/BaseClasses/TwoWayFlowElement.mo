...
equation
  ...
  rho_a1_inflow = BuildingSystems.Utilities.Psychrometrics.Functions.density_pTX(
        p=port_a1.p,
  ...
  rho_a2_inflow = BuildingSystems.Utilities.Psychrometrics.Functions.density_pTX(
        p=port_a2.p,
