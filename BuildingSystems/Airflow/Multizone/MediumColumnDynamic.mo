...
model MediumColumnDynamic
  ...
  MediumColumn colTop(
    redeclare final package Medium = Medium,
    final densitySelection=BuildingSystems.Airflow.Multizone.Types.densitySelection.fromBottom,
    h=h/2,
  ...
  MediumColumn colBot(
    redeclare final package Medium = Medium,
    final densitySelection=BuildingSystems.Airflow.Multizone.Types.densitySelection.fromTop,
    h=h/2,
    final allowFlowReversal=allowFlowReversal)
...
<a href=\"modelica://BuildingSystems.Airflow.Multizone.MediumColumn\">
BuildingSystems.Airflow.Multizone.MediumColumn</a> instead of this model.
</p>
