...
model ChimneyShaftNoVolume
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume roo(
    V=2.5*5*5,
  ...
  BuildingSystems.Airflow.Multizone.Orifice oriChiTop(
    m=0.5,
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT bou0(
    redeclare package Medium = Medium,
    T=273.15,
    nPorts=2) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={90,50})));
  BuildingSystems.Airflow.Multizone.Orifice oriBot(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) annotation (Placement(transformation(
        origin={110,-20},
  ...
  BuildingSystems.Airflow.Multizone.Orifice oriChiBot(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) annotation (Placement(transformation(
        origin={70,-49},
  ...
  BuildingSystems.Airflow.Multizone.MediumColumn sha(redeclare package Medium = Medium,
      densitySelection=BuildingSystems.Airflow.Multizone.Types.densitySelection.actual) "Shaft of chimney"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},
            {140,100}})),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ChimneyShaftNoVolume.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06),
