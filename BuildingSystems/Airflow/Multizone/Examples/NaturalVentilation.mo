...
model NaturalVentilation
  ...
  BuildingSystems.Airflow.Multizone.MediumColumn colOut(
    redeclare package Medium = Medium,
    h=3,
  ...
  BuildingSystems.Airflow.Multizone.MediumColumn colRooTop(
    redeclare package Medium = Medium,
    h=3,
    densitySelection=BuildingSystems.Airflow.Multizone.Types.densitySelection.fromBottom)
...
experiment(StopTime=7200),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Airflow/Multizone/Examples/NaturalVentilation.mos"
        "Simulate and plot"),
