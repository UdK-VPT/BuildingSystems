...
model ZonalFlow "Model with prescribed air exchange between two volumes"
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume rooB(
    V=volB,
    redeclare package Medium = Medium,
    X_start={0.01,0.99},
    T_start=293.15,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ZonalFlow.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BuildingSystems.Airflow.Multizone.ZonalFlow_m_flow\">BuildingSystems.Airflow.Multizone.ZonalFlow_m_flow</a>.
</li>
<li>
