within BuildingSystems.Airflow.Multizone.Examples;
model ReverseBuoyancy
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volBotEas(
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volTopEas(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    V=2.5*5*10,
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volTopWes(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    T_start=273.15 + 20,
  ...
  BuildingSystems.Airflow.Multizone.DoorDiscretizedOperable dooOpeCloTop(
    redeclare package Medium = Medium,
    LClo=20*1E-4,
    wOpe=1,
    hOpe=2.2,
...
experiment(StopTime=3600),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ReverseBuoyancy.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model is similar than
<a href=\"modelica://BuildingSystems.Airflow.Multizone.Validation.ThreeRoomsContam\">
BuildingSystems.Airflow.Multizone.Validation.ThreeRoomsContam</a> but it has four
