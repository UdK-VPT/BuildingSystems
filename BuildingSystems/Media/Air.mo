...
package Air
  ...
  // the pressure.
  // Otherwise, translateModel("BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume")
...
<a href=\"modelica://BuildingSystems.Media.Air.specificEntropy\">
BuildingSystems.Media.Air.specificEntropy</a>
for temperature.
</p>
</html>", revisions="<html>
<ul>
...
First implementation.
  ...
  constant Modelica.Units.SI.SpecificHeatCapacity cpWatLiq=BuildingSystems.Utilities.Psychrometrics.Constants.cpWatLiq
...
BuildingSystems.Airflow.Multizone</a> compute the mass density using the function
<a href=\"modelica://BuildingSystems.Utilities.Psychrometrics.Functions.density_pTX\">
BuildingSystems.Utilities.Psychrometrics.Functions.density_pTX</a> in which density
...
<a href=\"modelica://BuildingSystems.Fluid.Sources.Examples.TraceSubstancesFlowSource\">
BuildingSystems.Fluid.Sources.Examples.TraceSubstancesFlowSource</a>
...
<a href=\"modelica://BuildingSystems.Utilities.Psychrometrics.Constants\">
BuildingSystems.Utilities.Psychrometrics.Constants</a>.
...
<a href=\"modelica://BuildingSystems.Media.GasesPTDecoupled.MoistAirUnsaturated.enthalpyOfNonCondensingGas\">
