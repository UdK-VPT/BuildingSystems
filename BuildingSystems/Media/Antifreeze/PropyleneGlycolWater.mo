within BuildingSystems.Media.Antifreeze;
package PropyleneGlycolWater
  ...
  extends Modelica.Media.Interfaces.PartialSimpleMedium(
    ...
    a_const=1484,
    T_min=fusionTemperature_TX_a(T = property_T, X_a = X_a),
...
protected
  ...
  <a href=\"modelica://BuildingSystems.Media.Antifreeze.PropyleneGlycolWater\">
  BuildingSystems.Media.Antifreeze.PropyleneGlycolWater</a>.
  </li>
  </ul>
  </html>"));
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Media/Antifreeze/PropyleneGlycolWaterProperties.png\" border=\"1\"
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Media/Antifreeze/PropyleneGlycolWaterError10degC.png\" border=\"1\"
alt=\"Relative variation of specific heat capacity with temperature\"/>
</p>
<p>
The figure below shows the relative error of the the four properties over a
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Media/Antifreeze/PropyleneGlycolWaterError20degC.png\" border=\"1\"
alt=\"Relative variation of specific heat capacity with temperature\"/>
</p>
<p>
...
As is the case for BuildingSystems.Media.Water, this medium package should not be used if
...
<p>
<code>Medium = BuildingSystems.Media.Antifreeze.PropyleneGlycolWater(property_T=293.15, X_a=0.40)</code>
</p>
</html>", revisions="<html>
<ul>
<li>
