within BuildingSystems.Media.Antifreeze.Validation;
model PropyleneGlycolWater
  ...
  extends BuildingSystems.Media.Antifreeze.Validation.BaseClasses.FluidProperties(
    redeclare package Medium =
        BuildingSystems.Media.Antifreeze.Validation.BaseClasses.PropyleneGlycolWater (
          property_T=300,
          X_a=0.05),
    nX_a=7,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Media/Antifreeze/Validation/PropyleneGlycolWater.mos"
        "Simulate and plot"),
