within BuildingSystems.Media.Specialized.Air.Examples;
model PerfectGasTemperatureEnthalpyInversion
  ...
  extends BuildingSystems.Media.Examples.BaseClasses.TestTemperatureEnthalpyInversion(
    redeclare package Medium = BuildingSystems.Media.Specialized.Air.PerfectGas);
  annotation (
experiment(StopTime=1.0),
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Media/Specialized/Air/Examples/PerfectGasTemperatureEnthalpyInversion.mos"
        "Simulate and plot"),
