...
model SteamSaturatedProperties
  ...
  package Medium = BuildingSystems.Media.Steam  "Steam medium model";
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Media/Examples/SteamSaturatedProperties.mos"
        "Simulate and plot"),
...
the <a href=\"modelica://BuildingSystems.Media.Steam\">
BuildingSystems.Media.Steam</a> model (vapor phase) and the
<a href=\"modelica://BuildingSystems.Media.Water\"> BuildingSystems.Media.Water</a>
model (liquid phase). See <a href=\"modelica://BuildingSystems.Media.Steam\">
BuildingSystems.Media.Steam</a> for more information.
</p>
<p>
