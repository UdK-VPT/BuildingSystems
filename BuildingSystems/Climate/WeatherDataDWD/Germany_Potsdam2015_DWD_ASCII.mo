...
block Germany_Potsdam2015_DWD_ASCII
  extends BuildingSystems.Climate.WeatherData.BaseClasses.WeatherDataFileASCII(
  info="Source: DWD",
  filNam=Modelica.Utilities.Files.loadResource("modelica://BuildingSystems/Climate/weather/Germany_Potsdam_2015_DWD.txt"),
  final tabNam="tab1",
...
end Germany_Potsdam2015_DWD_ASCII;
