...
block India_Bombay_Meteonorm_ASCII
  extends BuildingSystems.Climate.WeatherData.BaseClasses.WeatherDataFileASCII(
  info="Source: Meteonorm 7.0",
  filNam=Modelica.Utilities.Files.loadResource("modelica://BuildingSystems/Climate/weather/India_Bombay.txt"),
  final tabNam="tab1",
  ...
  final latitudeDeg = 19.117,
  final longitudeDeg = 72.85,
  final longitudeDeg_0 = 5.0);
  annotation(Documentation(info="<html>source: Meteonorm 7.0</html>"));
end India_Bombay_Meteonorm_ASCII;
