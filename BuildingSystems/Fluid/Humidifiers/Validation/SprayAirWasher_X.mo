within BuildingSystems.Fluid.Humidifiers.Validation;
model SprayAirWasher_X
  ...
  replaceable BuildingSystems.Fluid.Humidifiers.SprayAirWasher_X hum(
    mWatMax_flow=mWat_flow_nominal,
    massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
      constrainedby
    BuildingSystems.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
        redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sensors.MassFractionTwoPort senHum(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
            -100},{200,200}})),
    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Humidifiers/Validation/SprayAirWasher_X.mos"
        "Simulate and plot"),
