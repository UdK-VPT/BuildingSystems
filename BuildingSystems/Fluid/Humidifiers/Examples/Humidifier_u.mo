within BuildingSystems.Fluid.Humidifiers.Examples;
model Humidifier_u "Model that demonstrates the ideal humidifier model"
  ...
  BuildingSystems.Fluid.Humidifiers.Humidifier_u humSte(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Humidifiers.Humidifier_u humDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    mWat_flow_nominal=m_flow_nominal*0.005,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Humidifiers/Examples/Humidifier_u.mos"
        "Simulate and plot"),
