...
model StratifiedUnloadAtMinimumTemperature
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT loa(redeclare package Medium = Medium,
      nPorts=1)
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T masSou(
    nPorts=1,
    redeclare package Medium = Medium,
    m_flow=m_flow_nominal) "Mass flow rate into the tank"
    annotation (Placement(transformation(extent={{242,-130},{222,-110}})));

  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear valTop(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear valMed(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=3000,
    use_inputFilter=false) "Control valve at top"
  ...
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear valBot(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=3000,
    use_inputFilter=false) "Control valve at top"
...
equation
  ...
  annotation (Diagram(
       ...
       __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Storage/Examples/StratifiedUnloadAtMinimumTemperature.mos"
        "Simulate and plot"),
    experiment(
      StopTime=21600,
      Tolerance=1e-06),
