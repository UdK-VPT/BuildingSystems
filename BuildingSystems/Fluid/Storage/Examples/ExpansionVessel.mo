...
// package Medium = Modelica.Media.Water.WaterIF97OnePhase_ph "Medium model";
 package Medium = BuildingSystems.Media.Water "Medium model";
  ...
  BuildingSystems.Fluid.Storage.ExpansionVessel expVes(
...
equation
  ...
  connect(vol.ports[1], expVes.port_a) annotation (Line(
      ...
      color={0,127,255}));
  annotation (
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Storage/Examples/ExpansionVessel.mos"
        "Simulate and plot"),
