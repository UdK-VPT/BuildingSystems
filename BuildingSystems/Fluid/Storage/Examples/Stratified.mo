...
model Stratified "Test model for stratified tank"
 ...
 package Medium = BuildingSystems.Media.Water "Medium model";
  ...
  BuildingSystems.Fluid.Storage.Stratified tanSim(
  ...
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate HOut_flow(redeclare package Medium =
        Medium, m_flow_nominal=0.1) "Enthalpy flow rate"
          ...
          extent={{6,2},{22,18}})));
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate HOut_flow1(redeclare package Medium =
        Medium, m_flow_nominal=0.1) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{18,-36},{34,-20}})));
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Storage/Examples/Stratified.mos"
        "Simulate and plot"),
