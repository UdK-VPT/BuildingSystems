...
model PartialStratified
  ...
  extends BuildingSystems.Fluid.Storage.BaseClasses.PartialTwoPortInterface;
  ...
  // Models
  BuildingSystems.Fluid.MixingVolumes.MixingVolume[nSeg] vol(
...
<p>
See the
<a href=\"modelica://BuildingSystems.Fluid.Storage.UsersGuide\">
BuildingSystems.Fluid.Storage.UsersGuide</a>
