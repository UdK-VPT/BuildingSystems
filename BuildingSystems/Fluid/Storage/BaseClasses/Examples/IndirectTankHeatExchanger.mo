within BuildingSystems.Fluid.Storage.BaseClasses.Examples;
model IndirectTankHeatExchanger
  "Example showing the use of IndirectTankHeatExchanger"
  extends Modelica.Icons.Example;

  package Medium = BuildingSystems.Media.Water "Buildings library model for water";

  BuildingSystems.Fluid.Storage.BaseClasses.IndirectTankHeatExchanger indTanHex(
    nSeg=3,
    CHex=50,
    Q_flow_nominal=3000,
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T bou(
    m_flow=0.1,
    nPorts=1,
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Storage/BaseClasses/Examples/IndirectTankHeatExchanger.mos"
        "Simulate and plot"),
