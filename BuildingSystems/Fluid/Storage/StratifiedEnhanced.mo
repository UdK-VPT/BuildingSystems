...
protected
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate H_a_flow(
  ...
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate[nSeg - 1] H_vol_flow(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate H_b_flow(
    redeclare package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
    final tau=0,
    final allowFlowReversal=allowFlowReversal,
