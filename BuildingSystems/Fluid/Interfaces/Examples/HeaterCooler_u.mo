...
model HeaterCooler_u
 ...
 package Medium = BuildingSystems.Media.Water;
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea1(
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin_1(                       redeclare
    ...
    startTime=0) "Control signal"
            ...
            194}})));
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea2(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea3(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea4(
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass1(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,160},{180,180}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass2(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,116},{180,136}})));
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea5(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea6(
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea7(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u hea8(
    redeclare package Medium = Medium, Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass3(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,0},{180,20}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass4(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,60},{180,80}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass5(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,-164},{180,-144}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass6(               threShold=
        0.05, startTime=600)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass7(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,-284},{180,-264}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass8(               threShold=
        0.05, startTime=600)
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/HeaterCooler_u.mos"
        "Simulate and plot"),
