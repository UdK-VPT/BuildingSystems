...
model PrescribedOutlet_X_wSetOnly
  ...
  extends BuildingSystems.Fluid.Interfaces.Examples.BaseClasses.PrescribedOutletState(
...
__Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/PrescribedOutlet_X_wSetOnly.mos"
        "Simulate and plot"),
