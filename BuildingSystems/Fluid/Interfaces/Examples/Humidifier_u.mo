within BuildingSystems.Fluid.Interfaces.Examples;
model Humidifier_u
 ...
 parameter Modelica.SIunits.MassFlowRate mWat_flow_nominal = 0.001
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sou_1(
    ...
    T=293.15)             annotation (Placement(transformation(extent={{-168,92},
            {-148,112}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_11(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
             annotation (Placement(transformation(extent={{-100,92},{-80,112}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_12(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
             annotation (Placement(transformation(extent={{-100,134},{-80,154}})));
  BuildingSystems.Fluid.Sources.Boundary_pT sin_1(
    redeclare package Medium = Medium,
    use_p_in=true,
    T=288.15,
  ...
  Humidifier hea3(
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_2(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
             annotation (Placement(transformation(extent={{-100,12},{-80,32}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_3(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
  ...
  Humidifier hea4(
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_4(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  BuildingSystems.Fluid.MixingVolumes.MixingVolume mix1(
    redeclare package Medium = Medium,
    V=0.000001,
    nPorts=2,
    m_flow_nominal=0.5,
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass1(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass2(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass3(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass4(
    startTime=0.3,
    threShold=0.05)
  ...
  Humidifier hea5(redeclare package Medium =
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_1(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
             annotation (Placement(transformation(extent={{-100,-110},{-80,-90}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_5(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
  ...
  Humidifier hea7(redeclare package Medium =
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_6(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
             annotation (Placement(transformation(extent={{-100,-190},{-80,-170}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_7(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
  ...
  Humidifier hea8(                               redeclare package Medium =
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res_8(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5)
             annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  BuildingSystems.Fluid.MixingVolumes.MixingVolume mix2(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
            ...
            -160}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass5(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass6(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass7(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass8(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass9(
    startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass10(
     startTime=0.3,
    threShold=0.05)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass11(
    threShold=1E-2,
    startTime=0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass12(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass13(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass14(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass15(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass16(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass17(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass18(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass19(threShold=1E-2, startTime=
        0.3)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality ass20(threShold=1E-2, startTime=
        0.3)
...
protected
  model Humidifier
    ...
    extends BuildingSystems.Fluid.MassExchangers.Humidifier_u;
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/Humidifier_u.mos"
        "Simulate and plot"),
...
Moved model to <code>BuildingSystems.Fluid.Interfaces.Examples</code>.
</li>
<li>
