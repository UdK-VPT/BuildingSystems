...
extends Modelica.Icons.Example;
 package MediumW = BuildingSystems.Media.Water "Medium model";
 package MediumA = BuildingSystems.Media.Air "Medium model";
...
protected
  model SubModel
    ...
    BuildingSystems.Fluid.Interfaces.StaticTwoPortConservationEquation conEqn(
      redeclare package Medium = Medium,
      m_flow_nominal=0.01,
      show_T=true,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/StaticTwoPortConservationEquation.mos"
        "Simulate and plot"),
