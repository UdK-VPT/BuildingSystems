...
equation
  ...
  if use_m_flowInv then
    m_flowInv = BuildingSystems.Utilities.Math.Functions.inverseXRegularized(
                       x=port_a.m_flow,
  ...
  if allowFlowReversal then
    ...
    XiOut = BuildingSystems.Utilities.Math.Functions.regStep(y1=port_b.Xi_outflow,
                                                     y2=port_a.Xi_outflow,
                                                     x=port_a.m_flow,
                                                     x_small=m_flow_small/1E3);
    COut = BuildingSystems.Utilities.Math.Functions.regStep(y1=port_b.C_outflow,
                                                    y2=port_a.C_outflow,
                                                    x=port_a.m_flow,
                                                    x_small=m_flow_small/1E3);
  else
...
BuildingSystems.Fluid.MixingVolumes.BaseClasses.PartialMixingVolume</a>.<br/>
...
<a href=\"modelica://BuildingSystems.Fluid.MassExchangers.Examples.ConstantEffectiveness\">
BuildingSystems.Fluid.MassExchangers.Examples.ConstantEffectiveness</a>.
</li>
<li>
