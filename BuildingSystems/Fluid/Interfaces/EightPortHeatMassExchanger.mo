...
model EightPortHeatMassExchanger
  ...
  extends BuildingSystems.Fluid.Interfaces.PartialEightPortInterface(
  ...
  extends BuildingSystems.Fluid.Interfaces.EightPortFlowResistanceParameters(
 ...
 Modelica.SIunits.HeatFlowRate Q1_flow = vol1.heatPort.Q_flow
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume vol2(
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume vol3(
   ...
   annotation (Placement(transformation(
        ...
        extent={{10,10},{-10,-10}},
        rotation=180)));
  BuildingSystems.Fluid.MixingVolumes.MixingVolume vol4(
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop preDro1(
    redeclare final package Medium = Medium1,
    final m_flow_nominal=m1_flow_nominal,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop preDro2(
    redeclare final package Medium = Medium2,
    final m_flow_nominal=m2_flow_nominal,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop preDro3(
    redeclare final package Medium = Medium3,
    final m_flow_nominal=m3_flow_nominal,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop preDro4(
    redeclare final package Medium = Medium4,
    final m_flow_nominal=m4_flow_nominal,
