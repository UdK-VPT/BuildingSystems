within BuildingSystems.Fluid.Actuators.Dampers.Validation;
model PressureIndependent
  ...
  BuildingSystems.Fluid.Actuators.Dampers.PressureIndependent damPreInd(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
    final dpDamper_nominal=dp_nominal,
    use_inputFilter=false)
...
__Dymola_Commands(
file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Validation/PressureIndependent.mos"
"Simulate and plot"),
Documentation(info="<html>
<p>
This model validates
<a href=\"modelica://BuildingSystems.Fluid.Actuators.Dampers.PressureIndependent\">
BuildingSystems.Fluid.Actuators.Dampers.PressureIndependent</a>
