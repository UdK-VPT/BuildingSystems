within BuildingSystems.Fluid.Actuators.Dampers;
model PressureIndependent
  "Model for an air damper whose mass flow is proportional to the input signal"
  extends BuildingSystems.Fluid.Actuators.BaseClasses.PartialDamperExponential(
...
protected
  ...
  parameter Real[sizeSupSpl] kSupSpl_raw = BuildingSystems.Fluid.Actuators.BaseClasses.exponentialDamper(
...
algorithm
  ...
  y := BuildingSystems.Utilities.Math.Functions.smoothLimit(
    BuildingSystems.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
      x=kTheta,
      x1=kSupSpl[i - 1],
      x2=kSupSpl[i],
      y1=ySupSpl[i - 1],
...
initial equation
  ...
  invSplDer = BuildingSystems.Utilities.Math.Functions.splineDerivatives(x=kSupSpl_raw, y=ySupSpl_raw);
equation
  // From TwoWayPressureIndependent valve model
  m_flow_set = m_flow_nominal*phi;
  dp_min = BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
              m_flow=m_flow_set,
              k=kTotMax,
  ...
  if from_dp then
    ...
    m_flow_y1 = BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
    ...
    m_flow_smooth = noEvent(smooth(2,
        ...
        elseif dp_x >=dp_x2
        then m_flow_y2
        else BuildingSystems.Utilities.Math.Functions.quinticHermite(
                 x=dp_x,
                 x1=dp_x1,
                 x2=dp_x2,
                 y1=m_flow_y1,
                 y2=m_flow_y2,
                 y1d= BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der(
                                     dp=dp_min + dp_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     dp_der=1),
                 y2d=coeff1,
                 y1dd=BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2(
                                     dp=dp_min + dp_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     dp_der=1,
    ...
    dp_y1 = BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
    ...
    dp_smooth = noEvent(smooth(2,
        ...
        then dp_y2
                 ...
                 y1=dp_y1,
                 y2=dp_y2,
                 y1d=BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der(
                                     m_flow=m_flow_set + m_flow_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     m_flow_der=1),
                 y2d=coeff2,
                 y1dd=BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der2(
                                     m_flow=m_flow_set + m_flow_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     m_flow_der=1,
  ...
  y_actual_smooth = BuildingSystems.Utilities.Math.Functions.regStep(
    x=y_internal - y_min,
...
<a href=\"modelica://BuildingSystems.Fluid.Actuators.Valves.TwoWayPressureIndependent\">
BuildingSystems.Fluid.Actuators.Valves.TwoWayPressureIndependent</a>,
...
<a href=\"modelica://BuildingSystems.Fluid.Actuators.BaseClasses.exponentialDamper\">
BuildingSystems.Fluid.Actuators.BaseClasses.exponentialDamper</a>
...
<a href=\"modelica://BuildingSystems.Fluid.Actuators.BaseClasses.PartialDamperExponential\">
BuildingSystems.Fluid.Actuators.BaseClasses.PartialDamperExponential</a>.<br/>
This is for
