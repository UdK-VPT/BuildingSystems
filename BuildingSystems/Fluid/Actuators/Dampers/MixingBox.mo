...
model MixingBox "Outside air mixing box with interlocked air dampers"
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_Sup(redeclare package Medium =
    ...
    "Fluid connector b (positive design flow direction is from port_a to port_b)"
    annotation (Placement(transformation(extent={{110,50},{90,70}})));
  BuildingSystems.Fluid.Actuators.Dampers.Exponential damOA(
  ...
  BuildingSystems.Fluid.Actuators.Dampers.Exponential damExh(
    redeclare final package Medium = Medium,
  ...
  BuildingSystems.Fluid.Actuators.Dampers.Exponential damRec(
    redeclare final package Medium = Medium,
