...
model MixingBox
 ...
 package Medium = BuildingSystems.Media.Air
  ...
  BuildingSystems.Fluid.Actuators.Dampers.MixingBox mixBox(
    mOut_flow_nominal=1,
    mRec_flow_nominal=1,
    mExh_flow_nominal=1,
...
equation
  ...
  connect(bouRet.ports[1], mixBox.port_Ret) annotation (Line(
      ...
      color={0,127,255}));
  annotation (             __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/MixingBox.mos"
        "Simulate and plot"),
