within BuildingSystems.Fluid.Actuators.Dampers.Examples;
model VAVBoxExponential
 ...
 package Medium = BuildingSystems.Media.Air;
  ...
  BuildingSystems.Fluid.Actuators.Dampers.Exponential dam(redeclare package Medium =
  ...
  BuildingSystems.Fluid.Actuators.Dampers.VAVBoxExponential vav(
...
equation
  ...
  connect(sin.ports[2], vav.port_b) annotation (Line(
      ...
      color={0,127,255}));
 annotation (             __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/VAVBoxExponential.mos"
        "Simulate and plot"),
