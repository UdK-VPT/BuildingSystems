...
model Damper
  ...
  BuildingSystems.Fluid.Actuators.Dampers.Exponential res(
  ...
  BuildingSystems.Fluid.Actuators.Dampers.PressureIndependent preIndDpFixed_nominal(
    use_inputFilter=false,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    dpFixed_nominal=5,
  ...
  BuildingSystems.Fluid.Actuators.Dampers.PressureIndependent preIndFrom_dp(
    use_inputFilter=false,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    dpFixed_nominal=0,
  ...
  BuildingSystems.Fluid.Actuators.Dampers.PressureIndependent preInd(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    dpDamper_nominal=10,
    use_inputFilter=false)
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/Damper.mos"
        "Simulate and plot"),
