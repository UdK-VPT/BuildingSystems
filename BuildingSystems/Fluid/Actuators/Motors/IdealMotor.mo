within BuildingSystems.Fluid.Actuators.Motors;
...
the model <a href=\"modelica://BuildingSystems.Fluid.Examples.TwoWayValves\">
BuildingSystems.Fluid.Examples.TwoWayValves</a> sets <code>y=3</code>
