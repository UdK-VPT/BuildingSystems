...
model TwoWayValvesTable "Two way valve with linear opening characteristics"
  ...
  Valves.TwoWayTable valTab(
    ...
    flowCharacteristics=BuildingSystems.Fluid.Actuators.Valves.Data.Linear(),
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/TwoWayValvesTable.mos"
        "Simulate and plot"),
