...
model EvaporatorCondenser
  ...
  extends BuildingSystems.Fluid.Interfaces.TwoPortHeatMassExchanger(redeclare final
  ...
  Modelica.Units.SI.Efficiency eps=BuildingSystems.Utilities.Math.Functions.smoothMin(
      BuildingSystems.Fluid.HeatExchangers.BaseClasses.epsilon_ntuZ(
        NTU,
        0,
        Integer(BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.ConstantTemperaturePhaseChange)),
      0.999,
      1.0e-4) "Effectiveness of heat exchanger";

  Modelica.Blocks.Sources.RealExpression UAeff(
    final y=BuildingSystems.Utilities.Math.Functions.smoothMax(
      x1=UA,
