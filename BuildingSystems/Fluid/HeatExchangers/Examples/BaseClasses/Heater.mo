within BuildingSystems.Fluid.HeatExchangers.Examples.BaseClasses;
partial model Heater "Base class for example model for the heater and cooler"
  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature TBou
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_m_flow mov(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
...
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Examples.AirHeater_T\">
BuildingSystems.Fluid.HeatExchangers.Examples.AirHeater_T</a>
and
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Examples.AirHeater_u\">
BuildingSystems.Fluid.HeatExchangers.Examples.AirHeater_u</a> and
the similar models
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Examples.WaterHeater_T\">
BuildingSystems.Fluid.HeatExchangers.Examples.WaterHeater_T</a>
and
