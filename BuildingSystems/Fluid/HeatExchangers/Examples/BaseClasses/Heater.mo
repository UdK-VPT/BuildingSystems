...
partial model Heater "Base class for example model for the heater and cooler"
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_m_flow fan(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
...
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Examples.Heater_T\">
BuildingSystems.Fluid.HeatExchangers.Examples.Heater_T</a>
and
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Examples.Heater_u\">
BuildingSystems.Fluid.HeatExchangers.Examples.Heater_u</a>.
