...
model WaterHeater_u
  ...
  extends BuildingSystems.Fluid.HeatExchangers.Examples.BaseClasses.Heater(
...
First implementation.
    ...
    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WaterHeater_u.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-6),
