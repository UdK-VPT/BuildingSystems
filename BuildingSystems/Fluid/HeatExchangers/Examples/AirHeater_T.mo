...
BuildingSystems.Fluid.HeatExchangers.Examples.AirHeater_u</a>
...
First implementation.
    ...
    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/AirHeater_T.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-08),
