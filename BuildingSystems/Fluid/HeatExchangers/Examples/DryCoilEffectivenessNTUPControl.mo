...
model DryCoilEffectivenessNTUPControl
 ...
 package Medium2 = BuildingSystems.Media.Air "Medium model for air";
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temSen(
    redeclare package Medium = Medium2,
  ...
  BuildingSystems.Controls.Continuous.LimPID P(
    Ti=30,
    k=0.1,
    Td=1)
    "Controller"
  ...
  BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU hex(
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilEffectivenessNTUPControl.mos"
        "Simulate and plot"),
