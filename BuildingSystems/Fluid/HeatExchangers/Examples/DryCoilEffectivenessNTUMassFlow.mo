...
model DryCoilEffectivenessNTUMassFlow
  ...
  BuildingSystems.Fluid.Sensors.RelativeHumidityTwoPort senRelHum(
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilEffectivenessNTUMassFlow.mos"
        "Simulate and plot"),
