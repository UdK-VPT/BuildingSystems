within BuildingSystems.Fluid.HeatExchangers;
model WetCoilEffectivenessNTU
  ...
  extends BuildingSystems.Fluid.Interfaces.PartialFourPortInterface(
    redeclare replaceable package Medium2 = BuildingSystems.Media.Air);
  extends BuildingSystems.Fluid.Interfaces.FourPortFlowResistanceParameters(
    final computeFlowResistance1=true,
    final computeFlowResistance2=true);

  import con = BuildingSystems.Fluid.Types.HeatExchangerConfiguration;
  import flo = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime;
  ...
  parameter BuildingSystems.Fluid.Types.HeatExchangerConfiguration configuration=
    con.CounterFlow
  ...
  Modelica.Units.SI.HeatFlowRate QLat2_flow=BuildingSystems.Utilities.Psychrometrics.Constants.h_fg
...
protected
  ...
  Real delta1=1E-1
    "Parameter for normalization";
  Real fac1 = BuildingSystems.Utilities.Math.Functions.smoothMin(
    (1/delta * m1_flow/m1_flow_nominal)^2,1,delta1);
  Real fac2 = BuildingSystems.Utilities.Math.Functions.smoothMin(
    (1/delta * m2_flow/m2_flow_nominal)^2,1,delta1);
  Real Qfac = fac1*fac2;

  BuildingSystems.Fluid.HeatExchangers.BaseClasses.WetCoilUARated UAFroRated(
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u heaCoo(
  ...
  BuildingSystems.Fluid.Humidifiers.Humidifier_u heaCooHum_u(
  ...
  BuildingSystems.Fluid.HeatExchangers.BaseClasses.HADryCoil hA(
  ...
  BuildingSystems.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime dryWetCalcs(
  ...
  Modelica.Blocks.Sources.RealExpression m_flow_a1Exp(
    final y=BuildingSystems.Utilities.Math.Functions.regNonZeroPower(
...
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU\">
BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU</a>
computes faster.
</p>
...
see
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.BaseClasses.WetCoilWetRegime\">
BuildingSystems.Fluid.HeatExchangers.BaseClasses.WetCoilWetRegime</a>.
and
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime\">
BuildingSystems.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime</a>.
</p>
...
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Validation.WetCoilEffectivenessNTU\">
BuildingSystems.Fluid.HeatExchangers.Validation.WetCoilEffectivenessNTU</a>.
<h4>References</h4>
