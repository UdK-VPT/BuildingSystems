...
model Heater_T "Heater with prescribed outlet temperature"
  extends BuildingSystems.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
    outCon(
      final QMin_flow = 0,
...
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.SensibleCooler_T\">
BuildingSystems.Fluid.HeatExchangers.SensibleCooler_T</a>.
...
the examples
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Validation.PrescribedOutlet\">
BuildingSystems.Fluid.HeatExchangers.Validation.PrescribedOutlet</a>
and
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.Validation.PrescribedOutlet_dynamic\">
BuildingSystems.Fluid.HeatExchangers.Validation.PrescribedOutlet_dynamic</a>.
</p>
</html>",
revisions="<html>
<ul>
