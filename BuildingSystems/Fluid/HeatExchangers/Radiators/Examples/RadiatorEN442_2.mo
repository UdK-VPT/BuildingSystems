within BuildingSystems.Fluid.HeatExchangers.Radiators.Examples;
model RadiatorEN442_2 "Test model for radiator"
 ...
 parameter Modelica.SIunits.Pressure dp_nominal = 3000
  ...
  BuildingSystems.Fluid.HeatExchangers.Radiators.RadiatorEN442_2 rad1(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.HeatExchangers.Radiators.RadiatorEN442_2 rad2(
    redeclare package Medium = Medium,
...
equation
  ...
  connect(TBCCon1.port, rad1.heatPortCon) annotation (Line(
      ...
      color={191,0,0}));
  annotation (
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Radiators/Examples/RadiatorEN442_2.mos"
        "Simulate and plot"),
