within BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Examples;
model Convector
  extends Modelica.Icons.Example;

  package Medium = BuildingSystems.Media.Water "Water model";

  BuildingSystems.Fluid.Sources.MassFlowSource_T wat(
  ...
  BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector con(
    redeclare package Medium = Medium,
    nBeams=1,
...
equation
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=10),__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/BaseClasses/Examples/Convector.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
The example tests the implementation of
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector\">
BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector</a>.
