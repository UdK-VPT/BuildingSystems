...
model ModificationFactor
  ...
  BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.ModificationFactor mod(
    nBeams=1,
    per(
...
equation
  ...
  annotation (            experiment(StopTime=1),
            __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/BaseClasses/Examples/ModificationFactor.mos"
        "Simulate and plot"),
        Documentation(info="<html>
<p>
This example tests the implementation of
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.ModificationFactor\">
BuildingSystems.Fluid.HeatExchangers.ActiveBeams.BaseClasses.ModificationFactor</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
