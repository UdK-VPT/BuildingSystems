...
model CoolingAndHeating
  ...
  BuildingSystems.Controls.Continuous.LimPID conHea(
    yMax=0.094,
    Td=0,
    reverseAction=false,
    Ti=100,
  ...
  BuildingSystems.Controls.Continuous.LimPID conCoo(
    yMax=0.094,
    reverseAction=true,
    Td=0,
    k=0.5,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{120,120}})),experiment(Tolerance=1e-6, StopTime=172800),__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingAndHeating.mos"
        "Simulate and plot"),
