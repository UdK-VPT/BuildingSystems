...
model CoolingOnly
  ...
  BuildingSystems.Fluid.HeatExchangers.ActiveBeams.Cooling beaCoo(
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            ...
            __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingOnly.mos"
        "Simulate and plot"),
    Icon(coordinateSystem(extent={{-120,-120},{120,120}})),
     Documentation(info="<html>
<p>
This example tests the implementation of <a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.ActiveBeams.Cooling\">
BuildingSystems.Fluid.HeatExchangers.ActiveBeams.Cooling</a>.
