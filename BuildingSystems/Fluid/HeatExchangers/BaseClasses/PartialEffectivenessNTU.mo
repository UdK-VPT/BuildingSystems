...
model PartialEffectivenessNTU
  ...
  extends BuildingSystems.Fluid.HeatExchangers.BaseClasses.PartialEffectiveness(
      sensibleOnly1=true,
      sensibleOnly2=true,
...
initial equation
  ...
  NTU_nominal = if (eps_nominal > 0 and eps_nominal < 1) then
    BuildingSystems.Fluid.HeatExchangers.BaseClasses.ntu_epsilonZ(
    eps=eps_nominal,
    Z=Z_nominal,
...
equation
  ...
  // Effectiveness
  eps = BuildingSystems.Fluid.HeatExchangers.BaseClasses.epsilon_C(
    UA=UA,
    C1_flow=C1_flow,
    C2_flow=C2_flow,
...
defined in
<a href=\"modelica://BuildingSystems.Fluid.Types.HeatExchangerConfiguration\">
BuildingSystems.Fluid.Types.HeatExchangerConfiguration</a>
are supported.
</p>
<p>
