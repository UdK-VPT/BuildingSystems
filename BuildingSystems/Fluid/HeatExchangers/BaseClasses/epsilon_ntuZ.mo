...
algorithm
  ...
  annotation(preferredView="info",
             inverse(NTU=BuildingSystems.Fluid.HeatExchangers.BaseClasses.ntu_epsilonZ(eps=eps, Z=Z, flowRegime=flowRegime)),
           smoothOrder=1,
...
<a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.BaseClasses.epsilon_C\">
BuildingSystems.Fluid.HeatExchangers.BaseClasses.epsilon_C</a>
