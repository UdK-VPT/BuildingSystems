...
function ntu_epsilonZ
  ...
  import f = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime;
...
algorithm
  ...
  elseif (flowRegime == Integer(f.CrossFlowUnmixed)) then
    ...
    NTU := BuildingSystems.Fluid.HeatExchangers.BaseClasses.Internal.solve(
      y_zero=eps,
      x_min=1.5*1e-10,
      x_max=1E6,
      pressure=Z,
  ...
  annotation (preferredView="info",
             inverse(eps=BuildingSystems.Fluid.HeatExchangers.BaseClasses.epsilon_ntuZ(NTU=NTU, Z=Z, flowRegime=flowRegime)),
           smoothOrder=1,
...
<code>BuildingSystems.Utilities.Math.BaseClasses.OneNonLinearEquation</code>.
</li>
<li>
