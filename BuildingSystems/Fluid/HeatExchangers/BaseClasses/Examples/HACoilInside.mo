...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HACoilInside.mos"
        "Simulate and plot"),
        experiment(Tolerance=1e-6, StopTime=15),
        Documentation(info="<html>
        <p>
        Test model for <a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.BaseClasses.HACoilInside\">
        BuildingSystems.Fluid.HeatExchanger.BaseClassess.HACoilInside</a>.
        </p>
        </html>", revisions="<html>
<ul>
<li>
