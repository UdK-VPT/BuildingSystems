...
model HeaterCooler_T
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_T heaHigPow(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.HeatExchangers.HeaterCooler_T heaCooUnl(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000)
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
    ...
    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/HeaterCooler_T.mos"
        "Simulate and plot"),
