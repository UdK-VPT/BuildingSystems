within BuildingSystems.Fluid.HeatExchangers.Validation;
 ...
 package Medium2 = BuildingSystems.Media.Air;
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sou_1(
    ...
    "Boundary condition" annotation (Placement(transformation(extent={{-62,40},
            {-42,60}})));
  BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexPar(
    ...
    configuration=BuildingSystems.Fluid.Types.HeatExchangerConfiguration.ParallelFlow,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
  ...
  BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCou(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
    ...
    m2_flow_nominal=m2_flow,
    Q_flow_nominal=m2_flow*cp2*(24 - 20),
    configuration=BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CounterFlow,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
    annotation (Placement(transformation(extent={{-10,0},{10,20}})));
  BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCroC1Mix(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
    ...
    m2_flow_nominal=m2_flow,
    Q_flow_nominal=m2_flow*cp2*(24 - 20),
    configuration=BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
    annotation (Placement(transformation(extent={{-10,-28},{10,-8}})));
  BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCroC1Unm(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
    ...
    m2_flow_nominal=m2_flow,
    Q_flow_nominal=m2_flow*cp2*(24 - 20),
    configuration=BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
    annotation (Placement(transformation(extent={{-10,-58},{10,-38}})));
  BuildingSystems.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCroUnm(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
    ...
    m2_flow_nominal=m2_flow,
    Q_flow_nominal=m2_flow*cp2*(24 - 20),
    configuration=BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowUnmixed,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/DryCoilEffectivenessNTU.mos"
        "Simulate and plot"),
