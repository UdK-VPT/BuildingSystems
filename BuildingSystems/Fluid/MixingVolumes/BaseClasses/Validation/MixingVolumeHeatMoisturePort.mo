...
model MixingVolumeHeatMoisturePort
  ...
  extends BuildingSystems.Fluid.MixingVolumes.BaseClasses.Validation.MixingVolumeHeatPortWater(
    redeclare package Medium = BuildingSystems.Media.Air,
    redeclare BuildingSystems.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatMoisturePort vol);
...
This is for
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1068\">BuildingSystems, issue 1068</a>.
</li>
<li>
...
__Dymola_Commands(file=
  "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatMoisturePort.mos"
  "Simulate and plot"));
