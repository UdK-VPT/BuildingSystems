within BuildingSystems.Fluid.MixingVolumes.BaseClasses.Validation;
model MixingVolumeHeatPortWater
  "Validation model for setting the initialization of the pressure for water"
  extends Modelica.Icons.Example;

  replaceable package Medium = BuildingSystems.Media.Water constrainedby
    Modelica.Media.Interfaces.PartialMedium "Medium model";

  parameter Integer nEle(min=2)= 3 "Number of volumes"
    annotation(Evaluate=true);

  replaceable BuildingSystems.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort vol[nEle]
    constrainedby BuildingSystems.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort(
...
__Dymola_Commands(file=
  "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatPortWater.mos"
  "Simulate and plot"));
