...
model MixingVolumeMFactor
  ...
  extends BuildingSystems.Fluid.MixingVolumes.Examples.MixingVolumeMassFlow(
  sou(X={0.02,0.98},
      T=Medium.T_default),
  vol(mSenFac=10),
    bou(nPorts=3));
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volMFactor(
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T boundaryMFactor(
    redeclare package Medium = Medium,
    T=300,
    nPorts=1,
    m_flow=1,
...
<p>
See
<a href=\"modelica://BuildingSystems.Fluid.MixingVolumes.Examples.MixingVolumeMassFlow\">
BuildingSystems.Fluid.MixingVolumes.Examples.MixingVolumeMassFlow</a>
...
First implementation.
          ...
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Examples/MixingVolumeMFactor.mos"
        "Simulate and plot"));
