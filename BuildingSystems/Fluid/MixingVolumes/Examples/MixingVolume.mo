within BuildingSystems.Fluid.MixingVolumes.Examples;
model MixingVolume
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sou(             redeclare package Medium
      = Medium, T=293.15,
    use_p_in=true,
    nPorts=3)                                       annotation (Placement(
        transformation(extent={{-70,48},{-50,68}})));
  BuildingSystems.Fluid.Sources.Boundary_pT sin(             redeclare package Medium
      = Medium,
    nPorts=3,
    use_p_in=false,
    p=101325,
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res1(
  ...
  MixingVolumes.MixingVolume vol1(
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res2(
    redeclare each package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality assertEquality
    annotation (Placement(transformation(extent={{160,72},{180,92}})));
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate entFloRat(redeclare package Medium =
        Medium, m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,50},{60,70}})));
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate entFloRat1(redeclare package Medium =
        Medium, m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,0},{60,20}})));
  BuildingSystems.Fluid.MixingVolumes.MixingVolumeMoistAir vol2(
    redeclare package Medium = Medium,
    V=0.1,
    nPorts=2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate entFloRat2(redeclare package Medium =
        Medium, m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,-92},{60,-72}})));
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Examples/MixingVolume.mos"
        "Simulate and plot"),
...
Standard Library with the implementation in the <code>BuildingSystems</code>
