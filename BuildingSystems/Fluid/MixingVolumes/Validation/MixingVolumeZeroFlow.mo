...
model MixingVolumeZeroFlow
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volNonLinSys(
    nPorts=2,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin(nPorts=4, redeclare package Medium =
        Medium) "Sink"
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volT(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volLinSys(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T sou4(
    nPorts=1,
    redeclare package Medium = Medium,
    use_m_flow_in=true,
    use_T_in=true) "Source"
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolume volQflow(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
...
increase the chance of the error being produced for this simple example.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeZeroFlow.mos"
        "Simulate and plot"));
