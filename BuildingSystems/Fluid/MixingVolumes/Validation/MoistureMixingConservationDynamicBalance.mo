...
model MoistureMixingConservationDynamicBalance
  ...
  extends
    BuildingSystems.Fluid.MixingVolumes.Validation.BaseClasses.MoistureMixingConservation(
...
to the fluid.
See <a href=\"modelica://BuildingSystems.Fluid.Interfaces.ConservationEquation\">
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MoistureMixingConservationDynamicBalance.mos"
        "Simulate and plot"));
