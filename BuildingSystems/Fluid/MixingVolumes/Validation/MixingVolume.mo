...
model MixingVolume "Test model for mixing volumes"
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop res1(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop res2(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
  ...
  BuildingSystems.Utilities.Diagnostics.CheckEquality cheEqu1
    "Check for equality of results"
    annotation (Placement(transformation(extent={{156,70},{176,90}})));
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate entFloRat(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,50},{60,70}})));
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate entFloRat1(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,0},{60,20}})));
  ...
  BuildingSystems.Utilities.Diagnostics.CheckEquality cheEqu2
    "Check for equality of results"
    annotation (Placement(transformation(extent={{156,10},{176,30}})));
  BuildingSystems.Fluid.Sensors.EnthalpyFlowRate entFloRat2(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
