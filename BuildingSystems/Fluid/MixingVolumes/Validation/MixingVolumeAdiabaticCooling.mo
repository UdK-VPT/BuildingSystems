...
model MixingVolumeAdiabaticCooling
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT bou(redeclare package Medium = Medium, nPorts=2)
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeAdiabaticCooling.mos"
        "Simulate and plot"),
