...
model TraceSubstanceConservationDynamicBalance
  ...
  extends
    BuildingSystems.Fluid.MixingVolumes.Validation.BaseClasses.TraceSubstanceConservation(
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/TraceSubstanceConservationDynamicBalance.mos"
        "Simulate and plot"));
