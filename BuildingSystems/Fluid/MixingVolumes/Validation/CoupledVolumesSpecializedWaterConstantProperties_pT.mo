...
model CoupledVolumesSpecializedWaterConstantProperties_pT
  ...
  extends BuildingSystems.Fluid.MixingVolumes.Validation.CoupledVolumesWater(
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/910\">IBPSA, issue 910</a>.
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/CoupledVolumesSpecializedWaterConstantProperties_pT.mos"
           "Simulate and plot"));
