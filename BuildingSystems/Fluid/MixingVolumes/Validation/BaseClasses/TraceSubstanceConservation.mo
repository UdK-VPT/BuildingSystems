...
model TraceSubstanceConservation
  ...
  package Medium = BuildingSystems.Media.Air(extraPropertiesNames={substanceName});
  BuildingSystems.Fluid.Sources.MassFlowSource_h sou(
  ...
  BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort senTraSubIn(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0,
    allowFlowReversal=false,
  ...
  BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort senTraSubOut(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0,
    allowFlowReversal=false,
