within BuildingSystems.Fluid.MixingVolumes.Validation.BaseClasses;
model MoistureMixingConservation
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_h sou1(
    redeclare package Medium = Medium,
    nPorts=1,
    m_flow=2,
    X={0,1}) "Air source"
    annotation (Placement(transformation(extent={{-100,10},{-80,30}})));
  BuildingSystems.Fluid.Sources.MassFlowSource_h sou2(
    redeclare package Medium = Medium,
    nPorts=1,
    m_flow=1,
    X={0,1}) "Air source"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BuildingSystems.Fluid.MixingVolumes.MixingVolumeMoistAir vol(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.MixingVolumes.MixingVolumeMoistAir vol1(
    ...
    "Mixing volume for adding water"
              annotation (Placement(transformation(extent={{-60,-20},{-40,-40}})));
  BuildingSystems.Fluid.Sources.Boundary_pT sin(redeclare package Medium = Medium,
      nPorts=1) "Air sink"
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality assMasFra(
      message="Water vapor mass is not conserved", threShold=1E-8)
    "Assert for checking water conservation"
    annotation (Placement(transformation(extent={{140,-40},{160,-60}})));
  BuildingSystems.Fluid.Sensors.MassFractionTwoPort senMasFra(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0,
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality assMasFlo(
    threShold=1E-8,
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality assSpeEnt(
    threShold=1E-5,
