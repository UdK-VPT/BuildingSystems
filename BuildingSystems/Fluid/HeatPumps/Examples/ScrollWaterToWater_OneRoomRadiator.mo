within BuildingSystems.Fluid.HeatPumps.Examples;
...
//------------------------------------------------------------------------------//
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temSup(
    redeclare package Medium = MediumW,
    m_flow_nominal=mHeaPum_flow_nominal,
...
//----------------------------------------------------------------------------//
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_m_flow pumHeaPum(
    redeclare package Medium = MediumW,
    m_flow_nominal=mHeaPum_flow_nominal,
    y_start=1,
    m_flow_start=0.85,
...
//----------------------------------------------------------------------------//
  ...
  BuildingSystems.Fluid.Sources.FixedBoundary preSou(redeclare package Medium = MediumW,
      nPorts=1,
    T=TRadSup_nominal)
    "Source for pressure and to account for thermal expansion of water"
    annotation (Placement(transformation(extent={{90,-140},{70,-120}})));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temRet(redeclare package Medium =
...
//--------------------------------------------------------------------------------------//
  ...
  BuildingSystems.Fluid.Sources.FixedBoundary sou(
    redeclare package Medium = MediumW,
    use_T=true,
    nPorts=1,
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_m_flow pumHeaPumSou(
    redeclare package Medium = MediumW,
    y_start=1,
    m_flow_start=0.85,
    m_flow_nominal=mHeaPum_flow_nominal,
...
First implementation.
    ...
    __Dymola_Commands(file=
     "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/ScrollWaterToWater_OneRoomRadiator.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-08));
