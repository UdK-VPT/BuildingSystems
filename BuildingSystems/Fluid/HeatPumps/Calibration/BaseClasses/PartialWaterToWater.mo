within BuildingSystems.Fluid.HeatPumps.Calibration.BaseClasses;
model PartialWaterToWater
  ...
  BuildingSystems.Fluid.Sources.FixedBoundary sin2(redeclare final package Medium =
  ...
  BuildingSystems.Fluid.Sources.FixedBoundary sin1(redeclare final package Medium =
  ...
  replaceable BuildingSystems.Fluid.HeatPumps.BaseClasses.PartialWaterToWater heaPum
    constrainedby BuildingSystems.Fluid.HeatPumps.BaseClasses.PartialWaterToWater(
