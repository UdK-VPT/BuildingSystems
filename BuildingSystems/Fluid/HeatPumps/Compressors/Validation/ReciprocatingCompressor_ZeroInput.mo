within BuildingSystems.Fluid.HeatPumps.Compressors.Validation;
model ReciprocatingCompressor_ZeroInput
  extends Modelica.Icons.Example;
  BuildingSystems.Fluid.HeatPumps.Compressors.ReciprocatingCompressor com(
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ReciprocatingCompressor_ZeroInput.mos"
        "Simulate and plot"),
    experiment(
