...
model ScrollCompressor_ZeroInput
  ...
  BuildingSystems.Fluid.HeatPumps.Compressors.ScrollCompressor com(
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ScrollCompressor_ZeroInput.mos"
        "Simulate and plot"),
    experiment(
