...
model AntiFreeze "Example for usage of antifreeze model"
  ...
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze antFre
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
  ...
  \"https://github.com/ibpsa/modelica-ibpsa/issues/1576\">#1576</a>)
   ...
   __Dymola_Commands(file=
     "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Controls/Safety/Examples/AntiFreeze.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=100,
