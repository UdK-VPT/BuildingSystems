within BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.Examples;
model MinimalFlowRate
  "Example for usage of minimal flow rate safety control"
  extends BaseClasses.PartialSafety;
  extends Modelica.Icons.Example;
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate minFloRatSaf(
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
  ...
  \"https://github.com/ibpsa/modelica-ibpsa/issues/1576\">#1576</a>)
   ...
   __Dymola_Commands(file=
     "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Controls/Safety/Examples/MinimalFlowRate.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=100,
