...
<p>
  The packages <a href=\"modelica://BuildingSystems.Fluid.HeatPumps\">BuildingSystems.Fluid.HeatPumps</a>
  and <a href=\"modelica://BuildingSystems.Fluid.Chillers\">BuildingSystems.Fluid.Chillers</a> contain
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialHeatPumpCycle\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialHeatPumpCycle</a>.
  This partial model declares all common interfaces, parameters, etc.
</p>

<h5>Heat pump models</h5>
<p>
For heat pumps, the model <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular\">
BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular</a> extends the partial model and adds
...
the heat pump
<a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantCycle\">
BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantCycle</a>.
...
<a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle\">
BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle</a>
...
<ul>
<li>
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.LargeScaleWaterToWater\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.LargeScaleWaterToWater</a>
</li>
<li>
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.AirToWaterTableData2D\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.AirToWaterTableData2D</a>
</li>
<li>
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.CarnotWithLosses\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.CarnotWithLosses</a>
</li>
</ul>
...
<p>
For chillers, the model <a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.Modular\">
BuildingSystems.Fluid.Chillers.ModularReversible.Modular</a> extends the partial model and adds
...
Furthermore, the refrigerant cycle is redeclared to use the one for
the chiller
<a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.BaseClasses.RefrigerantCycle\">
BuildingSystems.Fluid.Chillers.ModularReversible.BaseClasses.RefrigerantCycle</a>.
This refrigerant cycle in turn contains replaceable models for the
cooling and heating operation of the chiller.
Available modules can be found in the package:
<a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle\">
BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle</a>.
For more information on the refrigerant cycle models, refer
to the section <b>Refrigerant cycle models</b>.
</p>
<p>
...
<ul>
<li>
  <a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.LargeScaleWaterToWater\">
  BuildingSystems.Fluid.Chillers.ModularReversible.LargeScaleWaterToWater</a>
</li>
<li>
  <a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.CarnotWithLosses\">
  BuildingSystems.Fluid.Chillers.ModularReversible.CarnotWithLosses</a>
</li>
</ul>
...
<a href=\"modelica://BuildingSystems.Fluid.UsersGuide\">BuildingSystems.Fluid.UsersGuide</a>.
</p>
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle\">
  BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle</a>.
</p>
<p>
  Currently, two modules for refrigerant cycle are implemented.
  First, the <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness</a> model
  uses the same equations as the Carnot models, i.e.  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.Carnot_y\">
  BuildingSystems.Fluid.HeatPumps.Carnot_y</a>.
  Second, the <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D</a> provides performance data
...
<p>
  ...
  The first approach is similar to <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D\">
...
<p>
  ...
  the basic BuildingSystems concept for nominal conditions, explained in
  detail here:
  <a href=\"modelica://BuildingSystems.Fluid.UsersGuide\">BuildingSystems.Fluid.UsersGuide</a>
</p>
<p>
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.TableData2D\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.TableData2D</a>
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.Safety\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.Safety</a>
</p>

<p>
  An important safety control with regard to
  system interaction is the operation envelope. Read the documentation of
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.BaseClasses.PartialOperationalEnvelope\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.BaseClasses.PartialOperationalEnvelope</a>
...
<p>
  The package
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias</a>
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias.BaseClasses.PartialInertia\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias.BaseClasses.PartialInertia
  </a>
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.BaseClasses.PartialIcingFactor\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.BaseClasses.PartialIcingFactor</a>
</p>
<p>
  ...
  added to the BuildingSystems library.
</p>
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity</a>
</p>
