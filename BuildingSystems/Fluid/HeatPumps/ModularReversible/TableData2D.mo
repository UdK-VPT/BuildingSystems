...
model TableData2D
  ...
  extends BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular(
    final use_rev=true,
  ...
  replaceable parameter
    BuildingSystems.Fluid.HeatPumps.ModularReversible.Data.TableData2D.GenericHeatPump datTabHea
    constrainedby
    BuildingSystems.Fluid.HeatPumps.ModularReversible.Data.TableData2D.GenericHeatPump
    "Data table of heat pump"
    annotation (choicesAllMatching=true,
      Placement(transformation(extent={{82,-18},{98,-2}})));
  replaceable parameter BuildingSystems.Fluid.Chillers.ModularReversible.Data.TableData2D.Generic datTabCoo(
