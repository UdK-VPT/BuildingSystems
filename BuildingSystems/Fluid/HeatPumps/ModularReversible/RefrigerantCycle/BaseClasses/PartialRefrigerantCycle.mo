within BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses;
...
equation
  ...
  <li>
    ...
    Adapted based on BuildingSystems implementation. Mainly, the iceFac is added directly
