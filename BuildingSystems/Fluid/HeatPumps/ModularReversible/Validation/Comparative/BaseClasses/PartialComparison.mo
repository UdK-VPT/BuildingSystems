within BuildingSystems.Fluid.HeatPumps.ModularReversible.Validation.Comparative.BaseClasses;
partial model PartialComparison
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin1(redeclare package Medium = Medium1)
    annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        origin={70,30})));
  BuildingSystems.Fluid.Sources.Boundary_pT sin2(redeclare package Medium = Medium2)
    annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        origin={-50,-30})));
...
<a href=\"modelica://BuildingSystems.Fluid.HeatPumps.Examples.Carnot_y\">
BuildingSystems.Fluid.HeatPumps.Examples.Carnot_y</a>
to validate the modular reversible models by means of
comparison to the <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.Carnot_y\">
BuildingSystems.Fluid.HeatPumps.Carnot_y</a> model.
</p>
</html>"));
