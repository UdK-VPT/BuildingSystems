within BuildingSystems.Fluid.HeatPumps.ModularReversible.Examples.BaseClasses;
...
//----------------------------------------------------------------------------//
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temRet(
    redeclare package Medium = MediumWat,
    m_flow_nominal=mCon_flow_nominal,
...
//--------------------------------------------------------------------------------------//
  ...
  Modelica.Blocks.Sources.Pulse cooLoa(
    ...
    startTime=86400/2) if witCoo "Cooling load with step" annotation (Placement(
        ...
        rotation=0,
        origin={-130,70})));
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Examples.BaseClasses.OneRoomRadiatorHeatPumpControl oneRooRadHeaPumCtr(
    final witCoo=witCoo)
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.Examples.ScrollWaterToWater_OneRoomRadiator\">
  BuildingSystems.Fluid.HeatPumps.Examples.ScrollWaterToWater_OneRoomRadiator</a>,
