...
model LargeScaleWaterToWater_OneRoomRadiator
  ...
  BuildingSystems.Fluid.HeatPumps.ModularReversible.LargeScaleWaterToWater heaPum(
    ...
    redeclare
      BuildingSystems.Fluid.HeatPumps.ModularReversible.Data.TableData2D.EN14511.WAMAK_WaterToWater_220kW
      datTabHea,
    redeclare
...
equation
  ...
  annotation (
     ...
     "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Examples/LargeScaleWaterToWater_OneRoomRadiator.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=86400,
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Examples.BaseClasses.PartialOneRoomRadiator\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Examples.BaseClasses.PartialOneRoomRadiator</a>
