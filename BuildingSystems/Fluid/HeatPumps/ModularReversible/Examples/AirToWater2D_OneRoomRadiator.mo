...
model AirToWater2D_OneRoomRadiator
  ...
  BuildingSystems.Fluid.HeatPumps.ModularReversible.AirToWaterTableData2D
    heaPum(
    ...
    redeclare
      ...
      datTabHea,
    redeclare
      BuildingSystems.Fluid.Chillers.ModularReversible.Data.TableData2D.EN14511.Vitocal251A08
      datTabCoo,
    redeclare
...
equation
  ...
  annotation (
   __Dymola_Commands(file=
     "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Examples/AirToWater2D_OneRoomRadiator.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=86400,
