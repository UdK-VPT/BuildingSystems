...
model RefrigerantCycle
  ...
  extends BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialModularRefrigerantCycle;
  ...
  replaceable model RefrigerantCycleHeatPumpCooling =
      BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.NoCooling(
        useInChi=true)
      constrainedby
...
<p>
  ...
  the model <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular</a> and extending models
