...
model EvaporatorCondenserWithCapacity
  ...
  extends BuildingSystems.Fluid.Interfaces.TwoPortHeatMassExchanger(
    redeclare final BuildingSystems.Fluid.MixingVolumes.MixingVolume vol(final V=
...
<p>
  Used in <a href=
  \"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.Modular</a> and <a href=
  \"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.Modular\">
