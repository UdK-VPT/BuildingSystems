...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_VariableSpeed.mos"
        "Simulate and plot"),
    experiment(
...
BuildingSystems.Fluid.HeatPumps.ReciprocatingWaterToWater</a> heat pump model.
</p>
<p>
