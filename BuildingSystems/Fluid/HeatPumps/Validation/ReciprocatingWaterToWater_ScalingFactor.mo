...
model ReciprocatingWaterToWater_ScalingFactor
  ...
  BuildingSystems.Fluid.HeatPumps.ReciprocatingWaterToWater heaPum(
    ...
    per=BuildingSystems.Fluid.HeatPumps.Data.ReciprocatingWaterToWater.Generic(
        etaEle=0.696,
        PLos=100,
        dTSup=9.82,
        UACon=2210,
  ...
  BuildingSystems.Fluid.HeatPumps.ReciprocatingWaterToWater heaPum1(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=1000,
    dp2_nominal=1000,
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_ScalingFactor.mos"
        "Simulate and plot"),
    experiment(
...
<a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ReciprocatingWaterToWater\">
BuildingSystems.Fluid.HeatPumps.ReciprocatingWaterToWater</a> heat pump model. This
