...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ScrollWaterToWater_VariableSpeed.mos"
        "Simulate and plot"),
    experiment(
...
BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater</a> heat pump model.
</p>
<p>
