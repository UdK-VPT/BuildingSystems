...
model ScrollWaterToWater_ScalingFactor
  ...
  BuildingSystems.Fluid.Sources.FixedBoundary sin2(
    redeclare package Medium = Medium2, nPorts=2) "Source side sink"
    annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        origin={-32,20})));
  BuildingSystems.Fluid.Sources.FixedBoundary sin1(
  ...
  BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater heaPum(
    ...
    dp1_nominal=1000,
    dp2_nominal=1000,
    redeclare package ref = BuildingSystems.Media.Refrigerants.R410A,
  ...
  BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater heaPum1(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=1000,
    dp2_nominal=1000,
...
equation
  ...
  connect(mLoa.y, loa1.m_flow_in) annotation (Line(points={{-79,-40},{-69.5,-40},
          {-60,-40}}, color={0,0,127}));
  connect(mSou.y, sou1.m_flow_in)
    annotation (Line(points={{79,-52},{69.5,-52},{60,-52}}, color={0,0,127}));
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ScrollWaterToWater_ScalingFactor.mos"
        "Simulate and plot"),
    experiment(
...
<a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater\">
BuildingSystems.Fluid.HeatPumps.ScrollWaterToWater</a> heat pump model. This
