within BuildingSystems.Fluid.Movers.Data;
record Generic "Generic data record for movers"
  ...
  parameter BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.flowParameters pressure(
    V_flow = {0, 0},
  ...
  parameter BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod etaHydMet=
    if havePressureCurve
    then BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber
    else BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided
    "Efficiency computation method for the hydraulic efficiency etaHyd"
    annotation (Dialog(group="Power computation"));
  parameter BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod etaMotMet=
    if powerOrEfficiencyIsHydraulic and havePressureCurve
    then BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.GenericCurve
    else BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.NotProvided
  ...
  parameter
    ...
    annotation (Dialog(group="Power computation",
                       enable=etaHydMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Efficiency_VolumeFlowRate));
  parameter
    BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters
    motorEfficiency(
      V_flow={0},
    ...
    annotation (Dialog(group="Power computation",
                       enable=etaMotMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_VolumeFlowRate));
  parameter
    BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters_yMot
  ...
  parameter BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.powerParameters power(
    V_flow={0},
    P={0})
    "Power (either consumed or hydraulic) vs. volumetric flow rate"
   annotation (Dialog(group="Power computation",
                      enable =   etaHydMet==
      BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Power_VolumeFlowRate));

  // Peak condition
  parameter BuildingSystems.Fluid.Movers.BaseClasses.Euler.peak peak(
  ...
  final parameter BuildingSystems.Fluid.Movers.BaseClasses.Euler.peak peak_internal=
    BuildingSystems.Fluid.Movers.BaseClasses.Euler.getPeak(pressure=pressure,power=power)
  ...
  final parameter
    BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters_yMot
      motorEfficiency_yMot_generic=
        BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.motorEfficiencyCurve(
  ...
  parameter Real constantSpeed(final min=0, final unit="1") = 1
    "Normalized speed set point, used if inputType = BuildingSystems.Fluid.Types.InputType.Constant"
    annotation (Dialog(group="Normalized speeds"));
...
<pre>
  BuildingSystems.Fluid.Movers.SpeedControlled_y fan(
...
<a href=\"modelica://BuildingSystems.Fluid.Movers.Validation.Pump_y_stratos\">
BuildingSystems.Fluid.Movers.Validation.Pump_y_stratos</a>.
</p>
