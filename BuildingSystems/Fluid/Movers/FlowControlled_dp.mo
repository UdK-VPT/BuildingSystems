...
model FlowControlled_dp
  ...
  extends BuildingSystems.Fluid.Movers.BaseClasses.PartialFlowMachine(
    final preVar=BuildingSystems.Fluid.Movers.BaseClasses.Types.PrescribedVariable.PressureDifference,
      ...
      per(
        final pressure=
          if per.havePressureCurve then
            ...
            BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.flowParameters(
        ...
        final etaHydMet=
          if (per.etaHydMet ==
            ...
            and not per.havePressureCurve then
              BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided
          else per.etaHydMet,
        final etaMotMet=
          if (per.etaMotMet ==
  ...
  Modelica.Blocks.Interfaces.RealInput dp_in(final unit="Pa")
    if inputType == BuildingSystems.Fluid.Types.InputType.Continuous
  ...
  annotation (
    Icon(graphics={
        Text(
          ...
          textColor={0,0,127},
          visible=inputType == BuildingSystems.Fluid.Types.InputType.Continuous or inputType == BuildingSystems.Fluid.Types.InputType.Stages,
          textString=DynamicSelect("dp", if inputType == BuildingSystems.Fluid.Types.InputType.Continuous then String(dp_in, format=".0f") else String(stage)))}),
...
<a href=\"modelica://BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod\">
BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod</a>
and
<a href=\"modelica://BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod\">
BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod</a>.<br/>
This is for
...
<a href=\"modelica://BuildingSystems.Obsolete.Fluid.Movers.FlowControlled_Nrpm\">
BuildingSystems.Obsolete.Fluid.Movers.FlowControlled_Nrpm</a>
and
