...
equation
  ...
  etaHyd = WFlo / BuildingSystems.Utilities.Math.Functions.smoothMax(
  ...
  Q_flow = if homotopyInitialization then
    homotopy(actual=BuildingSystems.Utilities.Math.Functions.regStep(
                      y1=QThe_flow,
                      y2=0,
      ...
      BuildingSystems.Utilities.Math.Functions.regStep(
                      y1=QThe_flow,
                      y2=0,
                      x=noEvent(abs(V_flow))-2*delta_V_flow,
                      x_small=delta_V_flow);
