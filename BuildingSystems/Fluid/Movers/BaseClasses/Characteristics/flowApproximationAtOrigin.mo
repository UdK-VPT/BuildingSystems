...
algorithm
  ...
  // see equation 20 in  BuildingSystems/Resources/Images/Fluid/Movers/UsersGuide/2013-IBPSA-Wetter.pdf
  ...
  // BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.pressure
