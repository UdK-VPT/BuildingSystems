...
model PumpCurveDerivatives
  ...
  BuildingSystems.Utilities.Diagnostics.AssertInequality assIne(threShold=1e-8)
    "Assertion check for positive derivatives"
    annotation (Placement(transformation(extent={{40,-20},{60,0}})));
  BuildingSystems.Fluid.Sensors.RelativePressure relPre1(
  ...
  BuildingSystems.Utilities.Diagnostics.AssertInequality assIne1(threShold=1e-8)
    "Assertion check for positive derivatives"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  BuildingSystems.Utilities.Diagnostics.AssertInequality assIne2(threShold=1e-8)
    "Assertion check for positive derivatives"
