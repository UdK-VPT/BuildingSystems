...
model Power "Power calculation comparison among three mover types"
  ...
  parameter
    ...
    {BuildingSystems.Fluid.Movers.BaseClasses.Characteristics.power(
      per=per.power,
      V_flow=i,
      r_N=1,
      delta=0.01,
      d=BuildingSystems.Utilities.Math.Functions.splineDerivatives(
      x=per.power.V_flow,
      y=per.power.P))
      for i in per.pressure.V_flow})) "Hydraulic and motor efficiency";

  BuildingSystems.Fluid.Movers.SpeedControlled_Nrpm pump_Nrpm(
  ...
  BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM[3] res(
...
equation
  ...
  annotation (    experiment(StopTime=200),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Movers/Validation/Power.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Fluid/Movers/Validation/Power.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
