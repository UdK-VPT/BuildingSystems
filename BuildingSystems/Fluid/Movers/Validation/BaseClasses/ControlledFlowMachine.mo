...
model ControlledFlowMachine
  ...
  BuildingSystems.Fluid.Sensors.MassFlowRate masFloRat2(redeclare package Medium =
        Medium)
  ...
  BuildingSystems.Fluid.Sensors.MassFlowRate masFloRat3(redeclare package Medium =
        Medium)
  ...
  BuildingSystems.Fluid.Sensors.MassFlowRate masFloRat4(redeclare package Medium =
        Medium)
