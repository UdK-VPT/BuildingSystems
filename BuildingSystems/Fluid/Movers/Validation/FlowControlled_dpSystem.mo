...
model FlowControlled_dpSystem
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_dp floConDp(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_dp floConDpSystem(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    allowFlowReversal=false,
    m_flow_nominal=1,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop heaCoi2(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop heaCoi1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Heating coil pressure drop"
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop duct3(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,-70},{20,-50}})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop duct4(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,-110},{20,-90}})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop duct1(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,70},{20,90}})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop duct2(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,30},{20,50}})));
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Movers/Validation/FlowControlled_dpSystem.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example demonstrates and tests the use of
<a href=\"modelica://BuildingSystems.Fluid.Movers.Validation.FlowControlled_dp\">
BuildingSystems.Fluid.Movers.Validation.FlowControlled_dp</a>
