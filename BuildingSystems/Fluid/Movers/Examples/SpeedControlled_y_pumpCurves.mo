...
model SpeedControlled_y_pumpCurves
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sou1(
    ...
    T=293.15) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
          rotation=180,
        origin={128,88})));
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear dp1(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear dp2(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=0.01*dp_nominal,
    filteredOpening=false) "Pressure drop"
  ...
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear dp3(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=0.01*dp_nominal,
    filteredOpening=false) "Pressure drop"
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear dp4(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=0.01*dp_nominal,
    filteredOpening=false) "Pressure drop"
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Movers/Examples/SpeedControlled_y_pumpCurves.mos"
        "Simulate and plot"),
