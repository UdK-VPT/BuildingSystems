...
model RectangularBorefield "Example model of a rectangular borefield"
  ...
  final parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Filling.Bentonite filDat
    annotation (Placement(transformation(extent={{20,40},{40,60}})));
  final parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Soil.SandStone soiDat
    "Soil data" annotation (Placement(transformation(extent={{50,40},{70,60}})));
  final parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Configuration.Template conDat(
    final borCon=BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.SingleUTube,
    final use_Rb=false,
  ...
  final parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Template
    borFieDat(
      final filDat=filDat,
      final soiDat=soiDat,
  ...
  BuildingSystems.Fluid.Geothermal.Borefields.OneUTube borFie(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/Examples/RectangularBorefield.mos"
        "Simulate and plot"),
  experiment(
