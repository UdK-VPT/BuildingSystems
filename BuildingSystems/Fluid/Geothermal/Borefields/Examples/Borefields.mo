within BuildingSystems.Fluid.Geothermal.Borefields.Examples;
model Borefields
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T sou1(
    ...
    T=303.15) "Source" annotation (Placement(transformation(extent={{-92,-10},{
            -72,10}}, rotation=0)));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort T2UTubParIn(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin1(
    ...
    T=283.15) "Sink" annotation (Placement(transformation(extent={{90,-10},{70,
            10}}, rotation=0)));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort T2UTubParOut(
    redeclare package Medium = Medium,
    m_flow_nominal=borFie2UTubParDat.conDat.mBorFie_flow_nominal,
    tau=0)
    "Outlet temperature of the borefield with 2-UTube in parallel configuration"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Example borFieUTubDat(
    conDat=BuildingSystems.Fluid.Geothermal.Borefields.Data.Configuration.Example(
    borCon=BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.SingleUTube))
    annotation (Placement(transformation(extent={{70,-100},{90,-80}})));

  BuildingSystems.Fluid.Geothermal.Borefields.TwoUTubes borFie2UTubSer(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T sou2(
    ...
    T=303.15) "Source" annotation (Placement(transformation(extent={{-92,50},{
            -72,70}},
                  rotation=0)));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort T2UTubSerIn(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin2(
    ...
    T=283.15) "Sink" annotation (Placement(transformation(extent={{90,50},{70,
            70}}, rotation=0)));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort T2UTubSerOut(
    redeclare package Medium = Medium,
    m_flow_nominal=borFie2UTubSerDat.conDat.mBorFie_flow_nominal,
    tau=0)
  ...
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Example borFie2UTubParDat(
    conDat=BuildingSystems.Fluid.Geothermal.Borefields.Data.Configuration.Example(
  ...
  BuildingSystems.Fluid.Geothermal.Borefields.OneUTube borFieUTub(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T sou(
    ...
    T=303.15) "Source" annotation (Placement(transformation(extent={{-92,-70},{
            -72,-50}}, rotation=0)));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TUTubIn(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin(
    ...
    T=283.15) "Sink" annotation (Placement(transformation(extent={{90,-70},{70,
            -50}}, rotation=0)));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TUTubOut(
    redeclare package Medium = Medium,
    m_flow_nominal=borFieUTubDat.conDat.mBorFie_flow_nominal,
    tau=0)
    "Inlet temperature of the borefield with UTube configuration"
    annotation (Placement(transformation(extent={{40,-70},{60,-50}})));
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Example borFie2UTubSerDat(
    conDat=BuildingSystems.Fluid.Geothermal.Borefields.Data.Configuration.Example(
    borCon=BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeSeries))
