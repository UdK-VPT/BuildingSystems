...
model Sandbox "Validation of BorefieldOneUTube based on the experiment of Beier et al. (2011)"
  ...
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Borefield borFieDat "Borefield data"
  ...
  Modelica.Blocks.Sources.CombiTimeTable sandBoxMea(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://BuildingSystems/Resources/Data/Fluid/Geothermal/Borefields/HeatTransfer/Validation/Beier_Smith_Spitler_2011_SandBox.txt"))
...
equation
  ...
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/Validation/Sandbox.mos"
        "Simulate and Plot"),
