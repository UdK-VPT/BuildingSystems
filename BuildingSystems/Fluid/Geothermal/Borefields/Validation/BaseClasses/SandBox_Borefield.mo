...
record SandBox_Borefield
  ...
  extends
    BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Template(
      filDat=BuildingSystems.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Filling(),
      soiDat=BuildingSystems.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Soil(),
      conDat=BuildingSystems.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Configuration());
