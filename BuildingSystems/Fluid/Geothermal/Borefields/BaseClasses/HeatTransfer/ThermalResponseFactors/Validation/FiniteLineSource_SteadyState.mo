...
equation
  ...
  hRea = BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_SteadyState(
    dis = dis,
    len1 = len1,
    burDep1 = burDep1,
    len2 = len2,
  ...
  hMir = BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_SteadyState(
    dis = dis,
    len1 = len1,
    burDep1 = burDep1,
    len2 = len2,
  ...
  h = BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_SteadyState(
    dis = dis,
    len1 = len1,
    burDep1 = burDep1,
    len2 = len2,
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/FiniteLineSource_SteadyState.mos"
        "Simulate and plot"),
