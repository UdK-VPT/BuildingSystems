...
algorithm
  h_ils := if t > 0.0 then
              BuildingSystems.Utilities.Math.Functions.exponentialIntegralE1(dis^2/(4*aSoi*t))
           else
              0.0;
annotation (
Inline=true,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Fluid/Geothermal/Borefields/InfiniteLineSource_01.png\" />
</p>
<p>
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Fluid/Geothermal/Borefields/InfiniteLineSource_02.png\" />
</p>
<p>
where <i>&alpha;<sub>s</sub></i> is the ground thermal diffusivity. The
exponential integral is implemented in
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.exponentialIntegralE1\">BuildingSystems.Utilities.Math.Functions.exponentialIntegralE1</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
