...
algorithm
  sha := BuildingSystems.Utilities.Cryptographics.sha(String(nBor, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(hBor, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(dBor, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(rBor, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(aSoi, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(nSeg, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(nClu, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(nTimSho, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(nTimLon, format=formatStrGen));
  sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(ttsMax, format=formatStrGen));
  for i in 1:nBor loop
    sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(cooBor[i, 1], format=formatStrCoo));
    sha := BuildingSystems.Utilities.Cryptographics.sha(sha + String(cooBor[i, 2], format=formatStrCoo));
  end for;
...
<a href=\"modelica://BuildingSystems.Utilities.Cryptographics.sha\">BuildingSystems.Utilities.Cryptographics.sha</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
