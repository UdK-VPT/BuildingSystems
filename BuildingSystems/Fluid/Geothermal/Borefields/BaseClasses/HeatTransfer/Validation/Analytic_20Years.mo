within BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.Validation;
model Analytic_20Years
  "Long term validation of ground temperature response model"
  extends Modelica.Icons.Example;

  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Template
    borFieDat(conDat(
  ...
  Modelica.Blocks.Sources.CombiTimeTable timTabQ(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://BuildingSystems/Resources/Data/Fluid/Geothermal/Borefields/HeatTransfer/Validation/Analytic_20Years.txt"))
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/Validation/Analytic_20Years.mos"
        "Simulate and plot"),
