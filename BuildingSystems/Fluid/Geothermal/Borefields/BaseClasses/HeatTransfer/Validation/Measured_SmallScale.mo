...
model Measured_SmallScale
  ...
  parameter BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.Validation.BaseClasses.SmallScale_Borefield
  ...
  Modelica.Blocks.Sources.CombiTimeTable meaDat(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://BuildingSystems/Resources/Data/Fluid/Geothermal/Borefields/HeatTransfer/Validation/Cimmino_Bernier_2015_SmallScale.txt"),
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/Validation/Measured_SmallScale.mos"
        "Simulate and plot"),
