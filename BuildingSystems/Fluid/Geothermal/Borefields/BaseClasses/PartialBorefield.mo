within BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses;
partial model PartialBorefield
  ...
  replaceable package Medium = Modelica.Media.Interfaces.PartialMedium "Medium in the component"
      annotation (choices(
        ...
        choice(redeclare package Medium =
            BuildingSystems.Media.Antifreeze.PropyleneGlycolWater (
              property_T=293.15,
              X_a=0.40)
  ...
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Template borFieDat "Borefield data"
  ...
  BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.GroundTemperatureResponse groTemRes(
  ...
  replaceable BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.PartialBorehole borHol constrainedby
    BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.PartialBorehole(
...
protected
  ...
  BuildingSystems.Fluid.BaseClasses.MassFlowRateMultiplier masFloMul(
    redeclare final package Medium = Medium,
    allowFlowReversal=allowFlowReversal,
  ...
  BuildingSystems.Utilities.Math.Average AveTBor(nin=nSeg)
