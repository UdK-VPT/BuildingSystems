...
model InternalResistancesTwoUTube "Validation of InternalResistancesTwoUTube"
  ...
  BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalResistancesTwoUTube
    intRes2UTub(
    hSeg=hSeg,
    T_start=T_start,
    borFieDat=borFieDat,
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TPip3(T=T_start + 25)
    "Wall temperature of pipe 2"
    annotation (Placement(transformation(extent={{30,-50},{10,-30}})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TPip4(T=T_start + 10)
    "Wall temperature of pipe 2"
...
equation
  ...
  experiment(StopTime=3600, Tolerance=1e-6),
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Examples/InternalResistancesTwoUTube.mos"
        "Simulate and plot"),
  Documentation(info="<html>
This example tests the implementation of
<a href=\"modelica://BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalResistancesTwoUTube\">
BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalResistancesTwoUTube</a>
