...
model InternalHEXOneUTube
  ...
  extends BuildingSystems.Fluid.Interfaces.FourPortHeatMassExchanger(
    ...
    redeclare final BuildingSystems.Fluid.MixingVolumes.MixingVolume vol1(
    ...
    redeclare final BuildingSystems.Fluid.MixingVolumes.MixingVolume vol2(
      final energyDynamics=energyDynamics,
      final massDynamics=energyDynamics,
      final prescribedHeatFlowRate=false,
...
equation
    assert(borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.SingleUTube,
...
<a href=\"modelica://BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.Functions.internalResistancesOneUTube\">
BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.Functions.internalResistancesOneUTube</a>.<br/>
This is for
