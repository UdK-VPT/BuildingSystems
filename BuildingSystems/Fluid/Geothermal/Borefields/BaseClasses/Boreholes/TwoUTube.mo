within BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes;
model TwoUTube "Double U-tube borehole heat exchanger"
  extends BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.PartialBorehole;

  BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalHEXTwoUTube
    intHex[nSeg](
    redeclare each final package Medium = Medium,
    each final borFieDat=borFieDat,
    each final hSeg=borFieDat.conDat.hBor/nSeg,
    final dp1_nominal={if i == 1 and borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then dp_nominal elseif i == 1 and borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeSeries
         then dp_nominal/2 else 0 for i in 1:nSeg},
    final dp3_nominal={if i == 1 and borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then dp_nominal elseif i == 1 and borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeSeries
         then dp_nominal/2 else 0 for i in 1:nSeg},
    ...
    each final m1_flow_nominal=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then m_flow_nominal/2 else m_flow_nominal,
    each final m2_flow_nominal=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then m_flow_nominal/2 else m_flow_nominal,
    each final m3_flow_nominal=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then m_flow_nominal/2 else m_flow_nominal,
    each final m4_flow_nominal=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then m_flow_nominal/2 else m_flow_nominal,
    each final m1_flow_small=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then borFieDat.conDat.mBor_flow_small/2 else borFieDat.conDat.mBor_flow_small,
    each final m2_flow_small=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then borFieDat.conDat.mBor_flow_small/2 else borFieDat.conDat.mBor_flow_small,
    each final m3_flow_small=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then borFieDat.conDat.mBor_flow_small/2 else borFieDat.conDat.mBor_flow_small,
    each final m4_flow_small=if borFieDat.conDat.borCon == BuildingSystems.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.DoubleUTubeParallel
         then borFieDat.conDat.mBor_flow_small/2 else borFieDat.conDat.mBor_flow_small,
...
Following major changes to the structure of the BuildingSystems.Fluid.HeatExchangers.Ground package,
