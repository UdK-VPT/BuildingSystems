...
model BoreholeOneUTube "Test for the single U-tube borehole model"
  ...
  extends
    BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.Examples.BaseClasses.PartialBorehole(
      redeclare
  ...
  annotation (
    __Dymola_Commands( file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/Examples/BoreholeOneUTube.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTube\">
BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTubes</a>
