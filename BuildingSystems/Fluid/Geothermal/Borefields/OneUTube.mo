...
model OneUTube
  ...
  extends BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.PartialBorefield(
    redeclare BuildingSystems.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTube borHol);
