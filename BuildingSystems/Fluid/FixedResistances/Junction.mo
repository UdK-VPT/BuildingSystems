...
model Junction
  "Flow splitter with fixed resistance at each port"
    extends BuildingSystems.Fluid.BaseClasses.PartialThreeWayResistance(
    m_flow_small=mDyn_flow_nominal*1e-4,
    mDyn_flow_nominal = sum(abs(m_flow_nominal[:])/3),
    redeclare BuildingSystems.Fluid.FixedResistances.PressureDrop res1(
      from_dp=from_dp,
      ...
      deltaM=deltaM),
    redeclare BuildingSystems.Fluid.FixedResistances.PressureDrop res2(
      from_dp=from_dp,
      ...
      homotopyInitialization=homotopyInitialization,
      deltaM=deltaM),
    redeclare BuildingSystems.Fluid.FixedResistances.PressureDrop res3(
      from_dp=from_dp,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Fluid/FixedResistances/Junction.png\"/>
</p>
<p>
If
...
Based class on
<a href=\"modelica://BuildingSystems.Fluid.BaseClasses.PartialThreeWayFixedResistance\">
BuildingSystems.Fluid.BaseClasses.PartialThreeWayFixedResistance</a>.
</li>
<li>
