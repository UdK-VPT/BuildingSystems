...
model PressureDropsSeries "Test of multiple resistances in series"
 ...
 package Medium = BuildingSystems.Media.Air "Medium model";
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop[nRes] res(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PressureDropsSeries.mos"
        "Simulate and plot"),
