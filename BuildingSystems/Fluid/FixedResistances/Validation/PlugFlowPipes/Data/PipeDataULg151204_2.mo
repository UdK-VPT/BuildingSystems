within BuildingSystems.Fluid.FixedResistances.Validation.PlugFlowPipes.Data;
record PipeDataULg151204_2
  "Experimental data from ULg's pipe test bench from December 4, 2015 (2)"
  extends BuildingSystems.Fluid.FixedResistances.Validation.PlugFlowPipes.Data.BaseClasses.PipeDataULg(
    T_start_out=14.3,
    T_start_in=14.7,
    m_flowIni=1.251,
    final nCol = 6,
    final filNam = Modelica.Utilities.Files.loadResource(
  "modelica://BuildingSystems/Resources/Data/Fluid/FixedResistances/Validation/PlugFlowPipes/PipeDataULg151204_2.mos"));
...
See <a href=\"modelica://BuildingSystems.Fluid.FixedResistances.Validation.PlugFlowPipes.Data.BaseClasses.PipeDataULg\">
BuildingSystems.Fluid.FixedResistances.Validation.PlugFlowPipes.Data.BaseClasses.PipeDataULg</a>
