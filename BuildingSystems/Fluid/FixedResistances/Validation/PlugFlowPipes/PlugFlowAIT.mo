...
model PlugFlowAIT
  ...
  BuildingSystems.Fluid.FixedResistances.Junction splPip1(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.FixedResistances.Junction splPip2(
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (
    experiment(
      ...
      Interval=120,
      Tolerance=1e-006),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/PlugFlowAIT.mos"
        "Simulate and plot"),
...
src=\"modelica://BuildingSystems/Resources/Images/Fluid/FixedResistances/Validation/PlugFlowPipes/AITTestBench.png\"/>
</p>
<h4>Calibration</h4>
