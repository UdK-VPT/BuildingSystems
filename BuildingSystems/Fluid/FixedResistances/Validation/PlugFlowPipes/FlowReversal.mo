...
model FlowReversal
  ...
  package Medium = BuildingSystems.Media.Water "Medium in the pipe";
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/FlowReversal.mos"
        "Simulate and Plot"),
