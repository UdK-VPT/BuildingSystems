...
model HydraulicDiameter
 ...
 package Medium = BuildingSystems.Media.Water "Medium model";
  ...
  BuildingSystems.Fluid.FixedResistances.HydraulicDiameter resLarPip(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=10,
    length=100)
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/HydraulicDiameter.mos"
        "Simulate and plot"),
