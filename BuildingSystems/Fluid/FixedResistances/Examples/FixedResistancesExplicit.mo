...
model FixedResistancesExplicit "Test of multiple resistances in series"
 ...
 package Medium = BuildingSystems.Media.Air;
  BuildingSystems.Fluid.Sources.Boundary_ph sou(
   redeclare package Medium = Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101335,
    use_p_in=true)                    annotation (Placement(transformation(
          extent={{-60,90},{-40,110}})));
  BuildingSystems.Fluid.Sources.Boundary_ph sin(
    redeclare package Medium = Medium,
    nPorts=1,
    use_p_in=false,
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res11(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
    ...
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res12(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
             annotation (Placement(transformation(extent={{20,90},{40,110}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res22(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{20,50},{40,70}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res21(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{-20,50},{0,70}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res31(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
             annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res32(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
             annotation (Placement(transformation(extent={{20,-20},{40,0}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res42(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
    BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM res41(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{-20,-60},{0,-40}})));
  BuildingSystems.Fluid.Sources.MassFlowSource_h bou(
    redeclare package Medium = Medium,
    m_flow=1,
    nPorts=1) annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
  BuildingSystems.Fluid.Sources.MassFlowSource_h bou1(
    redeclare package Medium = Medium,
    m_flow=1,
    nPorts=1)
    annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
  BuildingSystems.Fluid.Sources.Boundary_pT sin1(            redeclare package Medium
      =        Medium, T=273.15 + 10,
    nPorts=2,
    use_p_in=false,
    p=101325)                         annotation (Placement(transformation(
          extent={{120,-40},{100,-20}})));
  BuildingSystems.Fluid.Sources.Boundary_ph sin2(            redeclare package Medium
      =        Medium,
    nPorts=1,
    use_p_in=false,
    p=101325)                         annotation (Placement(transformation(
          extent={{120,50},{100,70}})));
  BuildingSystems.Fluid.Sources.Boundary_ph sou1(            redeclare package Medium
      =        Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101335,
    use_p_in=true)                    annotation (Placement(transformation(
    ...
    offset=101315)
            ...
            110}})));
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFlo1(redeclare package Medium =
        Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,90},{80,110}})));
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFlo2(redeclare package Medium =
        Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFlo3(redeclare package Medium =
        Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-20},{80,0}})));
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFlo4(redeclare package Medium =
        Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-60},{80,-40}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality assertEquality(threShold=1E-1)
    annotation (Placement(transformation(extent={{120,120},{140,140}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality assertEquality1(threShold=1E-1)
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/FixedResistancesExplicit.mos"
        "Simulate and plot"),
