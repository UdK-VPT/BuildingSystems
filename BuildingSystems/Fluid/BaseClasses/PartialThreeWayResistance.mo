within BuildingSystems.Fluid.BaseClasses;
partial model PartialThreeWayResistance
  ...
  replaceable BuildingSystems.Fluid.Interfaces.PartialTwoPortInterface res1
    constrainedby BuildingSystems.Fluid.Interfaces.PartialTwoPortInterface(
  ...
  replaceable BuildingSystems.Fluid.Interfaces.PartialTwoPortInterface res2
    constrainedby BuildingSystems.Fluid.Interfaces.PartialTwoPortInterface(
      redeclare final package Medium = Medium,
      allowFlowReversal=portFlowDirection_2 == Modelica.Fluid.Types.PortFlowDirection.Bidirectional)
    "Partial model, to be replaced with a fluid component"
    annotation (Placement(transformation(extent={{60,-10},{40,10}})));
  replaceable BuildingSystems.Fluid.Interfaces.PartialTwoPortInterface res3
    constrainedby BuildingSystems.Fluid.Interfaces.PartialTwoPortInterface(
      redeclare final package Medium = Medium,
...
<code>BuildingSystems.Fluid.Examples.ResistanceVolumeFlowReversal</code> fails to simulate.
</li>
<li>
