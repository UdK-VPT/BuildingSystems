within BuildingSystems.Fluid.BaseClasses.Validation;
model ActuatorFilter "Validation model for the actuator filter"
  ...
  BuildingSystems.Fluid.BaseClasses.ActuatorFilter act_1(f=fCut, initType=Modelica.Blocks.Types.Init.InitialState)
    "Filter with u_nominal not set"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  BuildingSystems.Fluid.BaseClasses.ActuatorFilter act_2(f=fCut, initType=Modelica.Blocks.Types.Init.InitialState)
  ...
  BuildingSystems.Fluid.BaseClasses.ActuatorFilter act_y_start05(
    f=fCut,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=0.5) "Filter with initial start value for output"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  BuildingSystems.Fluid.BaseClasses.ActuatorFilter act_y_start1(
    f=fCut,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/BaseClasses/Validation/ActuatorFilter.mos"
        "Simulate and plot"),
    experiment(
      StopTime=20,
      Tolerance=1e-06),
...
<a href=\"modelica://BuildingSystems.Fluid.BaseClasses.ActuatorFilter\">
BuildingSystems.Fluid.BaseClasses.ActuatorFilter</a>.
