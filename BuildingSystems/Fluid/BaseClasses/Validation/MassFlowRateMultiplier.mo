...
model MassFlowRateMultiplier "Example use of MassFlowRateMultiplier"
  ...
  BuildingSystems.Fluid.BaseClasses.MassFlowRateMultiplier
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/BaseClasses/Validation/MassFlowRateMultiplier.mos"
        "Simulate and plot"),
    experiment(Tolerance=1e-6, StartTime=0.0, StopTime=10.0),
    Documentation(info="<html>
<p>
This example demonstrates the use of 
<a href=\"modelica://BuildingSystems.Fluid.BaseClasses.MassFlowRateMultiplier\">
BuildingSystems.Fluid.BaseClasses.MassFlowRateMultiplier</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
