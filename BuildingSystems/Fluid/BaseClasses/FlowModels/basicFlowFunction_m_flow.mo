...
algorithm
 ...
 annotation (Inline=false,
             ...
             derivative(order=1, zeroDerivative=k, zeroDerivative=m_flow_turbulent)=
               BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der,
             inverse(m_flow=BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
...
BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp</a>.<br/>
