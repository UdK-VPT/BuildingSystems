within BuildingSystems.Fluid.BaseClasses.FlowModels;
...
algorithm
  ...
  annotation(Inline=false,
           ...
           derivative(order=1, zeroDerivative=k, zeroDerivative=m_flow_turbulent)=
             BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der,
           inverse(dp=BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
...
<a href=\"modelica://BuildingSystems.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp\">basicFlowFunction_dp</a>
is C2 continuous.
...
<code>BuildingSystems.Fluid.FixedResistances.Validation.PressureDropsExplicit</code>
