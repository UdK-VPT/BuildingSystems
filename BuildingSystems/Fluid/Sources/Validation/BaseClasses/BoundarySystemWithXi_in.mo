within BuildingSystems.Fluid.Sources.Validation.BaseClasses;
model BoundarySystemWithXi_in
  "System model for testing boundary condition with mass fraction input"
  extends BuildingSystems.Fluid.Sources.Validation.BaseClasses.BoundarySystem(sou(use_Xi_in=true));
