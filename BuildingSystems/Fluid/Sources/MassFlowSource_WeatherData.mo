...
model MassFlowSource_WeatherData
  ...
  extends BuildingSystems.Fluid.Sources.BaseClasses.PartialAirSource(final verifyInputs=true);
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Bus with weather data"
...
protected
  ...
  BuildingSystems.Utilities.Psychrometrics.X_pTphi x_pTphi if (not singleSubstance)
...
<p>The <a href=\"modelica://BuildingSystems.Utilities.Psychrometrics.X_pTphi\">
BuildingSystems.Utilities.Psychrometrics.X_pTphi</a> block is used with the input data
...
Changed to extend <a href=\"modelica://BuildingSystems.Fluid.Sources.BaseClasses.PartialSource\">
BuildingSystems.Fluid.Sources.BaseClasses.PartialSource</a>. This is for
