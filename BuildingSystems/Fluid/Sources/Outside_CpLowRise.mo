within BuildingSystems.Fluid.Sources;
model Outside_CpLowRise
  ...
  extends BuildingSystems.Fluid.Sources.BaseClasses.Outside;
  ...
  Real CpAct(final unit="1")=
   BuildingSystems.Airflow.Multizone.BaseClasses.windPressureLowRise(
     Cp0=Cp0,
     alpha=alpha,
     G=G)
...
<a href=\"modelica://BuildingSystems.Fluid.Sources.Outside\">
BuildingSystems.Fluid.Sources.Outside</a>,
...
<a href=\"modelica://BuildingSystems.Fluid.Sources.Outside_CpData\">
BuildingSystems.Fluid.Sources.Outside_CpData</a> or
<a href=\"modelica://BuildingSystems.Fluid.Sources.Outside_Cp\">
BuildingSystems.Fluid.Sources.Outside_Cp</a>
...
<code>BuildingSystems.Types.Azimuth.S</code>.
</p>
<p>
...
<a href=\"modelica://BuildingSystems.Airflow.Multizone.BaseClasses.windPressureLowRise\">
...
<p>
This model differs from <a href=\"modelica://BuildingSystems.Fluid.Sources.Outside_CpData\">
BuildingSystems.Fluid.Sources.Outside_CpData</a> by the calculation of the wind pressure coefficient C<sub>p,act</sub>.
...
Documentation changes to explain the difference with <a href=\"modelica://BuildingSystems.Fluid.Sources.Outside_CpData\">
BuildingSystems.Fluid.Sources.Outside_CpData</a>.
</li>
<li>
