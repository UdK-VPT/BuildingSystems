...
model Outside_CpData_Specification
  ...
  BuildingSystems.Fluid.Sources.Outside_CpData nor(
...
equation
  ...
  connect(weaDat.weaBus, nor.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  annotation (__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside_CpData_Specification.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model validates the specification of the wind pressure profile
in the information section of the model
<a href=\"modelica://BuildingSystems.Fluid.Sources.Outside_CpData\">BuildingSystems.Fluid.Sources.Outside_CpData</a>.
