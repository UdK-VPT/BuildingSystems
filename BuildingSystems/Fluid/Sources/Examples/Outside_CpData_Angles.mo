...
model Outside_CpData_Angles
  ...
  BuildingSystems.Fluid.Sources.Outside_CpData symNor(
  ...
  BuildingSystems.Fluid.Sources.Outside_CpData asyNor(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpAsy,
    azi=BuildingSystems.Types.Azimuth.N)
  ...
  BuildingSystems.Fluid.Sources.Outside_CpData asyWes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpAsy,
  ...
  BuildingSystems.Fluid.Sources.Outside_CpData symWes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpSym,
    azi=BuildingSystems.Types.Azimuth.W)
  ...
  BuildingSystems.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    winSpe=1,
    winDirSou=BuildingSystems.BoundaryConditions.Types.DataSource.Input)
...
equation
  ...
  connect(symWes.weaBus, weaDat.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  annotation (__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside_CpData_Angles.mos"
        "Simulate and plot"),
