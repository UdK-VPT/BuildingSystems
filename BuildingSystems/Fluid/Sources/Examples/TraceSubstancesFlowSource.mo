...
model TraceSubstancesFlowSource
  ...
  BuildingSystems.Utilities.Diagnostics.AssertEquality assEqu(threShold=1E-4)
  ...
  MixingVolumes.MixingVolume vol3(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) "Mixing volume"
            ...
            {108,-40}})));
  BuildingSystems.Utilities.Diagnostics.AssertEquality assEqu1(threShold=1E-4)
    "Assert that both volumes have the same concentration"
  ...
  connect(res7.port_b, sin1.ports[2]) annotation (Line(
    ...
    annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
            ...
            experiment(Tolerance=1e-6, StopTime=600),
             __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sources/Examples/TraceSubstancesFlowSource.mos"
        "Simulate and plot"),
