within BuildingSystems.Fluid.FMI.Adaptors;
model Outlet "Adaptor for connecting a fluid outlet to the FMI interface"
  ...
  replaceable package Medium =
    Modelica.Media.Interfaces.PartialMedium "Medium in the component"
      annotation (choices(
        ...
        choice(redeclare package Medium = BuildingSystems.Media.Water "Water")));
  ...
  BuildingSystems.Fluid.FMI.Interfaces.Outlet outlet(
    ...
    redeclare final package Medium=Medium) "Fluid port"
        ...
        transformation(extent={{-110,-10},{-90,10}}),
          iconTransformation(extent={{-110,
            -10},{-90,10}})));
  BuildingSystems.Fluid.FMI.Interfaces.PressureInput p
    if use_p_in "Pressure to be sent to outlet"
      ...
      Placement(transformation(
        ...
        origin={0,-120})));
protected
  output BuildingSystems.Fluid.FMI.Interfaces.FluidProperties bacPro_internal(
    redeclare final package Medium = Medium)
    "Internal connector for fluid properties for back flow";
  BuildingSystems.Fluid.FMI.Interfaces.PressureOutput p_in_internal
    "Internal connector for pressure";

  input BuildingSystems.Fluid.FMI.Interfaces.MassFractionConnector X_w_in_internal
    "Internal connector for mass fraction of forward flow properties";
  output BuildingSystems.Fluid.FMI.Interfaces.MassFractionConnector X_w_out_internal
...
equation
  ...
  if not allowFlowReversal then
    ...
    if Medium.nXi > 0 then
      // This test for nXi is needed for BuildingSystems.Fluid.FMI.Validation.HeaterFan_noReverseFlow
      // to work with BuildingSystems.Media.Water
...
<a href=\"modelica://BuildingSystems.Fluid.FMI.Adaptors.Inlet\">
BuildingSystems.Fluid.FMI.Adaptors.Inlet</a> in order for
