...
model HVAC
  ...
  // otherwise, in BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones
...
protected
  ...
  BuildingSystems.Fluid.FMI.Conversion.AirToOutlet con[nPorts](
      redeclare each final package Medium = Medium,
      each final allowFlowReversal=true)
  ...
  BuildingSystems.Fluid.FMI.BaseClasses.X_w_toX x_w_toX(
    ...
    Icon(coordinateSystem(
        ...
        Polygon(
          ...
          fillPattern=FillPattern.Solid),
            ...
            "modelica://BuildingSystems/Resources/Images/Fluid/FMI/FMI_icon.png"),
            Bitmap(extent={{-96,52},{-24,108}},fileName=
            "modelica://BuildingSystems/Resources/Images/Fluid/FMI/modelica_icon.png")}),
