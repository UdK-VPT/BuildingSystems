within BuildingSystems.Fluid.FMI;
...
<tr>
  <td>
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers\">
  BuildingSystems.Fluid.FMI.ExportContainers</a>
  </td>
  <td>
  <p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort\">
  BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort</a>
  with a replaceable model,
  or extend from
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.PartialTwoPort\">
  BuildingSystems.Fluid.FMI.ExportContainers.PartialTwoPort</a>
  and add components.<br/>
  See
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.Fan\">
  BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.Fan</a>
  and
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume\">
  BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume</a>.
  </p>
  <p>
  ...
  See
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZone\">
  BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZone</a>.
  </p>
  <p>
  To export an HVAC system that serves multiple thermal zones, extend from
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.HVACZones\">
  BuildingSystems.Fluid.FMI.ExportContainers.HVACZones</a>
  and add the HVAC system.<br/>
  See
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones\">
  BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones</a>.
  </p>
  <p>
  To export a single thermal zone, extend from
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.ThermalZone\">
  BuildingSystems.Fluid.FMI.ExportContainers.ThermalZone</a>
  and add the thermal zone.<br/>
  See
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone\">
  BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone</a>.
  </p>
  <p>
  To export multiple thermal zones, extend from
  <a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.ThermalZones\">
  BuildingSystems.Fluid.FMI.ExportContainers.ThermalZones</a>
...
<tr>
  <td>
  <a href=\"modelica://BuildingSystems.Fluid.FMI.Adaptors\">
  BuildingSystems.Fluid.FMI.Adaptors</a>
  </td>
  <td>
  <p>
...
<td>
  <p>
  <a href=\"modelica://BuildingSystems.Fluid.FMI.Conversion\">
  BuildingSystems.Fluid.FMI.Conversion</a>
  </p>
</td>
<td>
  <p>
  Package with blocks that convert between the signal connectors of
  <a href=\"modelica://BuildingSystems.Fluid.FMI.Interfaces\">
  BuildingSystems.Fluid.FMI.Interfaces</a>
...
<p>
The package
<a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs\">
BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs</a>
...
<p>
In the
<a href=\"modelica://BuildingSystems.Fluid\">BuildingSystems.Fluid</a> package,
...
<a href=\"modelica://BuildingSystems.Fluid.FMI\">BuildingSystems.Fluid.FMI</a> package.
...
flow rate, such as
<a href=\"modelica://BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.IdealSource_m_flow\">
BuildingSystems.Fluid.FMI.ExportContainers.Examples.FMUs.IdealSource_m_flow</a>.
</p>
<h4>Notes</h4>
<p>
...
<a href=\"modelica://BuildingSystems.Media.Air\">
BuildingSystems.Media.Air</a>.
...
<p>
For <a href=\"modelica://BuildingSystems.Media.Water\">
BuildingSystems.Media.Water</a>, this setting is not needed
...
<p>
The model
<a href=\"modelica://BuildingSystems.Fluid.FixedResistances.FlowMachine_m_flow\">
BuildingSystems.Fluid.FixedResistances.FlowMachine_m_flow</a>
...
do so by using
<a href=\"modelica://BuildingSystems.Fluid.FMI.IdealSource_m_flow\">
BuildingSystems.Fluid.FMI.IdealSource_m_flow</a>,
...
<a href=\"modelica://BuildingSystems/Resources/Images/Fluid/FMI/UsersGuide/2015-WetterFuchsNouidui.pdf\">
