...
block HVACThermalZoneAir3 "Validation model for the convective HVAC system"
  extends BuildingSystems.Fluid.FMI.ExportContainers.Validation.FMUs.HVACThermalZoneAir1(
    redeclare package Medium = BuildingSystems.Media.Air(extraPropertiesNames={"CO2", "VOC", "CH2O"}));
annotation (
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Validation/FMUs/HVACThermalZoneAir3.mos"
        "Export FMU"));
