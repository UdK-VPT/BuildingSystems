...
block HeaterCooler_T
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed outlet temperature"
   extends BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final BuildingSystems.Fluid.HeatExchangers.HeaterCooler_T com(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HeaterCooler_T.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
