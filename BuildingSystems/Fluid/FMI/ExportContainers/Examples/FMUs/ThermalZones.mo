...
model ThermalZones
  ...
  extends BuildingSystems.Fluid.FMI.ExportContainers.ThermalZones(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZones.mos"
        "Export FMU"));
end ThermalZones;
