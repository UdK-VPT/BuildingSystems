...
block PressureDrop
  "Declaration of an FMU that exports a fixed resistance"
   extends BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     redeclare replaceable package Medium = BuildingSystems.Media.Air, redeclare final
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/PressureDrop.mos"
        "Export FMU"),
    Icon(graphics={
        Rectangle(
          extent={{-64,24},{70,-26}},
