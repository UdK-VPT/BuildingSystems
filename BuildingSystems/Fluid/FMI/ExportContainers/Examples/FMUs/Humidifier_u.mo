...
block Humidifier_u
  "Declaration of an FMU that exports an ideal humidifier"
   extends BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final BuildingSystems.Fluid.MassExchangers.Humidifier_u com(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/Humidifier_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
