...
block HeaterCooler_u
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed heat flow rate"
   extends BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final BuildingSystems.Fluid.HeatExchangers.HeaterCooler_u com(
...
See the
<a href=\"modelica://BuildingSystems.Fluid.FMI.UsersGuide\">user's guide</a>
for the rationale.
</p>
</html>", revisions="<html>
<ul>
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HeaterCooler_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
