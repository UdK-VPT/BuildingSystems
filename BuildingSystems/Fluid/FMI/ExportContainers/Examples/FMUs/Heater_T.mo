...
block Heater_T
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed outlet temperature"
   extends BuildingSystems.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final BuildingSystems.Fluid.HeatExchangers.Heater_T com(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/Heater_T.mos"
        "Export FMU"),
    Icon(graphics={
        Rectangle(
          extent={{70,63},{102,60}},
