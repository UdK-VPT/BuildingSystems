...
block HVACZones
  ...
  extends BuildingSystems.Fluid.FMI.ExportContainers.HVACZones(
    redeclare final package Medium = MediumA,
    nZon = 2,
    nPorts = 3);

  replaceable package MediumA = BuildingSystems.Media.Air "Medium for air";
  replaceable package MediumW = BuildingSystems.Media.Water "Medium for water";
 ...
 // parameter Modelica.SIunits.Volume V=6*10*3 "Room volume";
  ...
  replaceable BuildingSystems.Fluid.HeatExchangers.ConstantEffectiveness cooCoi(
    dp1_nominal=6000,
    dp2_nominal=200,
    show_T=true,
    allowFlowReversal1=allowFlowReversal,
    allowFlowReversal2=allowFlowReversal) constrainedby
    BuildingSystems.Fluid.Interfaces.PartialFourPortInterface(
  ...
  BuildingSystems.Fluid.Sources.Outside out(
    redeclare package Medium = MediumA,
  ...
  BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    pAtmSou=BuildingSystems.BoundaryConditions.Types.DataSource.Parameter,
    TDryBul=TOut_nominal,
    filNam="modelica://BuildingSystems/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos",
    TDryBulSou=BuildingSystems.BoundaryConditions.Types.DataSource.File,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop resSup1(
    redeclare package Medium = MediumA,
    linearized=true,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop resSup2(
    redeclare package Medium = MediumA,
    linearized=true,
    m_flow_nominal=0.5*mA_flow_nominal,
    dp_nominal=10) "Fixed resistance for supply air inlet"
    annotation (Placement(transformation(extent={{70,76},{90,96}})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop resRet1(
    redeclare package Medium = MediumA,
    dp_nominal=200,
    linearized=true,
    m_flow_nominal=0.5*mA_flow_nominal) "Fixed resistance for return air duct"
    annotation (Placement(transformation(extent={{40,50},{20,70}})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop resRet2(
    redeclare package Medium = MediumA,
    dp_nominal=200,
    linearized=true,
    m_flow_nominal=0.5*mA_flow_nominal) "Fixed resistance for return air duct"
...
BuildingSystems.Fluid.FMI.ExportContainers.HVACZones
</a>
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HVACZones.mos"
        "Export FMU"));
end HVACZones;
