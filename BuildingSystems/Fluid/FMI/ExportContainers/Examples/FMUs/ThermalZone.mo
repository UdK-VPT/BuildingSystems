...
model ThermalZone
  ...
  extends BuildingSystems.Fluid.FMI.ExportContainers.ThermalZone(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZone.mos"
        "Export FMU"));
end ThermalZone;
