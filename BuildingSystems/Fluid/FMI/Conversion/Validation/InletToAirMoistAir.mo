...
model InletToAirMoistAir
  "Validation model for inlet to BuildingSystems.Media.Air conversion without trace substances"
  ...
  BuildingSystems.Fluid.FMI.Conversion.InletToAir conAir(
  ...
  BuildingSystems.Fluid.FMI.Conversion.InletToAir conAirRevFlo(redeclare package
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAir.mos"
        "Simulate and plot"),
