...
model AirToOutlet "Validation model for air to outlet conversion"
  ...
  BuildingSystems.Fluid.FMI.Conversion.AirToOutlet conAirNoC(
    redeclare package Medium = BuildingSystems.Media.Air,
    final allowFlowReversal=allowFlowReversal)
    "Converter for air without trace substances"
    annotation (Placement(transformation(extent={{0,50},{20,70}})));

  BuildingSystems.Fluid.FMI.Conversion.AirToOutlet conAirWithC(
  ...
  BuildingSystems.Fluid.FMI.Conversion.AirToOutlet conDryAirNoC(
    redeclare package Medium = Modelica.Media.Air.SimpleAir,
    final allowFlowReversal=allowFlowReversal)
    "Converter for dry air without trace substances"
    annotation (Placement(transformation(extent={{0,-40},{20,-20}})));
  BuildingSystems.Fluid.FMI.Conversion.AirToOutlet conDryAirWithC(
...
<a href=\"modelica://BuildingSystems.Fluid.FMI.Conversion.AirToOutlet\">
BuildingSystems.Fluid.FMI.Conversion.AirToOutlet</a>
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/AirToOutlet.mos"
        "Simulate and plot"),
