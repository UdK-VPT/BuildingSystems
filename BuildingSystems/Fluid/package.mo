...
<p>
The package <code>BuildingSystems.Fluid</code> consists of models
...
<tr>
  ...
  <td>Specific enthalpy <i>h</i> of the outflowing fluid, i.e.,
      ...
      <a href=\"modelica://BuildingSystems.Fluid.Sensors.SpecificEnthalpyTwoPort\">
      BuildingSystems.Fluid.Sensors.SpecificEnthalpyTwoPort</a>.</td>
</tr>
<tr>
  ...
  <td>Independent mixture mass fractions
      ...
      direction can do so using the sensor
      <a href=\"modelica://BuildingSystems.Fluid.Sensors.MassFractionTwoPort\">
      BuildingSystems.Fluid.Sensors.MassFractionTwoPort</a>.
...
<tr>
  ...
  <td>Trace substances <i>c<sub>i</sub>/m</i> close to the connection point, i.e.,
      ...
      Users who need to access the actual value for the given flow
      direction can do so using the sensor
      <a href=\"modelica://BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort\">
      BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort</a>.
      Note that this variable is only present for fluids that declare
      a trace substance such as CO<sub>2</sub>.
      See for example
      <a href=\"modelica://BuildingSystems.Fluid.Sensors.Examples.TraceSubstances\">
      BuildingSystems.Fluid.Sensors.Examples.TraceSubstances</a>.</td>
</tr>
</table>
...
<tr>
  ...
  <td>
     ...
     <br/>
      ...
      See for example
      <a href=\"modelica://BuildingSystems.Fluid.HeatExchangers.WetCoilDiscretized\">
      BuildingSystems.Fluid.HeatExchangers.WetCoilDiscretized</a>.
  </td>
</tr>
</table>
...
<a href=\"modelica://BuildingSystems.Fluid.Interfaces\">
BuildingSystems.Fluid.Interfaces</a>
and from
