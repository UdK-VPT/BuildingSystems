within BuildingSystems.Fluid.Chillers.ModularReversible;
model CarnotWithLosses
  "Reversible chiller using Carnot approach with losses (frost, heat, inertia)"
  extends BuildingSystems.Fluid.Chillers.ModularReversible.Modular(
    ...
    redeclare model RefrigerantCycleChillerCooling =
        ...
        (
        redeclare
          BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.FunctionalIcingFactor
          iceFacCal(redeclare function icingFactor =
              BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.Functions.wetterAfjei1997),
        TAppCon_nominal=TAppCon_nominal,
        TAppEva_nominal=TAppEva_nominal,
        etaCarnot_nominal=etaCarnot_nominal),
...
<p>
  ...
  BuildingSystems.Fluid.Chillers.ModularReversible.Modular</a> and selects the
  constant Carnot effectiveness module for chillers
  (<a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness\">
  BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness</a>)
  and heat pumps
  (<a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness</a>)
