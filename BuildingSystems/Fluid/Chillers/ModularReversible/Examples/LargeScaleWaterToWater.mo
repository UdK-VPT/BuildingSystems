...
model LargeScaleWaterToWater
  ...
  package MediumCon = BuildingSystems.Media.Water "Medium model for condenser";
  package MediumEva = BuildingSystems.Media.Water "Medium model for evaporator";

  BuildingSystems.Fluid.Chillers.ModularReversible.LargeScaleWaterToWater chi(
    redeclare
      BuildingSystems.Fluid.Chillers.ModularReversible.Data.TableData2D.EN14511.Carrier30XWP1012_1MW
      datTab,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/LargeScaleWaterToWater.mos"
        "Simulate and plot"),
