within BuildingSystems.Fluid.Chillers.ModularReversible.Examples;
model Modular
  "Example for modular reversible chiller"
  extends Modelica.Icons.Example;
  package MediumCon = BuildingSystems.Media.Air "Medium model for condenser";
  package MediumEva = BuildingSystems.Media.Water "Medium model for evaporator";

  BuildingSystems.Fluid.Chillers.ModularReversible.Modular chi(
    ...
    redeclare model RefrigerantCycleInertia =
        BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias.VariableOrder
        (
        refIneFreConst=1/300,
        nthOrd=1,
        initType=Modelica.Blocks.Types.Init.InitialState),
    redeclare
      BuildingSystems.Fluid.HeatPumps.ModularReversible.Controls.Safety.Data.Wuellhorst2021
    ...
    redeclare model RefrigerantCycleChillerHeating =
        BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D (
          redeclare
          BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.NoFrosting
          iceFacCal, datTab=
            BuildingSystems.Fluid.HeatPumps.ModularReversible.Data.TableData2D.EN14511.Vitocal251A08()),
    TEvaHea_nominal=303.15,
    TConHea_nominal=298.15)
                 "Modular reversible chiller instance"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  BuildingSystems.Fluid.Sources.MassFlowSource_T souCon(
    nPorts=1,
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T souEva(
    nPorts=1,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sinCon(nPorts=1, redeclare package Medium =
        MediumCon) "Condenser sink" annotation (Placement(transformation(extent={{
            10,-10},{-10,10}}, origin={70,40})));
  BuildingSystems.Fluid.Sources.Boundary_pT sinEva(nPorts=1, redeclare package Medium =
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/Modular.mos"
        "Simulate and plot"),
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.Chillers.ModularReversible.Modular\">
  BuildingSystems.Fluid.Chillers.ModularReversible.Modular</a>.
</p>
</html>"));
end Modular;
