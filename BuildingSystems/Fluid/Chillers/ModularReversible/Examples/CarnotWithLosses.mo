...
model CarnotWithLosses
  ...
  BuildingSystems.Fluid.Chillers.ModularReversible.CarnotWithLosses chi(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/CarnotWithLosses.mos"
        "Simulate and plot"),
