...
model Modular
  ...
  extends
    BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialReversibleRefrigerantMachine(
    ...
    safCtr(redeclare
        BuildingSystems.Fluid.Chillers.ModularReversible.Controls.Safety.OperationalEnvelope
        opeEnv),
    ...
    use_rev=false,
    redeclare final BuildingSystems.Fluid.Chillers.ModularReversible.BaseClasses.RefrigerantCycle refCyc(
  ...
  replaceable model RefrigerantCycleChillerCooling =
      BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle
      (PEle_nominal=0)
    constrainedby
    BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle(
       final useInChi=true,
  ...
  replaceable model RefrigerantCycleChillerHeating =
      BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.NoHeating
      (PEle_nominal=PEle_nominal)
       constrainedby
    BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialHeatPumpCycle(
...
<p>
  ...
  <a href=\"modelica://BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialReversibleRefrigerantMachine\">
  BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialReversibleRefrigerantMachine</a>),
