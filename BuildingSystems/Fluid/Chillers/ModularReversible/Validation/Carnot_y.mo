...
model Carnot_y "Example using the Carnot model approach"
  extends BuildingSystems.Fluid.HeatPumps.ModularReversible.Validation.Comparative.BaseClasses.PartialComparison(
  ...
  BuildingSystems.Fluid.Chillers.Carnot_y chi(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Validation/Carnot_y.mos"
        "Simulate and plot"),
...
<p>
Validation case for <a href=\"modelica://BuildingSystems.Fluid.Chillers.Carnot_y\">
BuildingSystems.Fluid.Chillers.Carnot_y</a>, duplicate of the example
<a href=\"modelica://BuildingSystems.Fluid.Chillers.Examples.Carnot_y\">
BuildingSystems.Fluid.Chillers.Examples.Carnot_y</a>.
</p>
</html>"));
end Carnot_y;
