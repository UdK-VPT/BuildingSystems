within BuildingSystems.Fluid.Chillers.ModularReversible.RefrigerantCycle;
model TableData2D
  ...
  replaceable parameter BuildingSystems.Fluid.Chillers.ModularReversible.Data.TableData2D.Generic datTab
