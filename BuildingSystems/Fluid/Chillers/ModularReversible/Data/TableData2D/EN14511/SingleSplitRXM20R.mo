within BuildingSystems.Fluid.Chillers.ModularReversible.Data.TableData2D.EN14511;
record SingleSplitRXM20R "Daikin_FTXM20R_RXM20R cooling mode"
  extends BuildingSystems.Fluid.Chillers.ModularReversible.Data.TableData2D.Generic(
    dpEva_nominal=0,
    dpCon_nominal=0,
