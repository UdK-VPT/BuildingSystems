within BuildingSystems.Fluid.Sensors.BaseClasses;
partial model PartialAbsoluteSensor
  ...
  parameter Boolean warnAboutOnePortConnection = true
   "Set to false to suppress warning about potential numerical issues, see BuildingSystems.Fluid.Sensors.UsersGuide for more information"
...
initial equation
  ...
  Only connect it to a vectorized fluid port, such as used in 'BuildingSystems.Fluid.MixingVolumes`.
  See BuildingSystems.Fluid.Sensors.UsersGuide for more information.
...
<a href=\"modelica://BuildingSystems.Fluid.Sensors.BaseClasses.PartialFlowSensor\">
BuildingSystems.Fluid.Sensors.BaseClasses.PartialFlowSensor</a>.
</p>
</html>",
revisions="<html>
<ul>
...
Icon(
  graphics={
    Bitmap(
      ...
      extent={{-96,-82},{-64,-50}},
      fileName="modelica://BuildingSystems/Resources/Images/Fluid/Sensors/warningIcon.png")}));
