within BuildingSystems.Fluid.Sensors.Conversions.Examples;
model To_VolumeFraction "Example problem for conversion model"
  ...
  BuildingSystems.Fluid.Sensors.Conversions.To_VolumeFraction conMasVolFra(MMMea=
  ...
  BuildingSystems.Controls.Continuous.LimPID limPID(
  ...
  BuildingSystems.Fluid.Sensors.TraceSubstances senCO2(redeclare package Medium =
  ...
  BuildingSystems.Fluid.Sources.TraceSubstancesFlowSource souCO2(
    use_m_flow_in=true,
    redeclare package Medium = Medium,
    nPorts=1) "CO2 source"
  ...
  BuildingSystems.Fluid.Sources.FixedBoundary sin(
    redeclare package Medium = Medium,
    p=100000,
    C={300E-6}*44.009544/28.9651159,
  ...
  BuildingSystems.Fluid.Sensors.VolumeFlowRate senVolFlo(redeclare package Medium =
  ...
  BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort senTraSubPeo(m_flow_nominal=0.1,
      redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
    "CO2 concentration in absorptance from people"
    annotation (Placement(transformation(extent={{40,60},{60,80}})));
  BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort senTraSubFre(m_flow_nominal=0.1,
      redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Conversions/Examples/To_VolumeFraction.mos"
        "Simulate and plot"),
