...
equation
  ...
  phi = BuildingSystems.Utilities.Psychrometrics.Functions.phi_pTX(
    p=port.p,
    T=T,
    X_w=Xi[1]);
...
<a href=\"modelica://BuildingSystems.Fluid.Sensors.RelativeHumidityTwoPort\">BuildingSystems.Fluid.Sensors.RelativeHumidityTwoPort</a>
