...
model TraceSubstances "Test model for the extra property sensor"
 ...
 package Medium = BuildingSystems.Media.Air(extraPropertiesNames={"CO2"})
  ...
  BuildingSystems.Fluid.Sensors.TraceSubstances senVol(
    redeclare package Medium = Medium, warnAboutOnePortConnection=false)
                                       "Sensor at volume"
    annotation (Placement(transformation(extent={{100,50},{120,70}})));
  BuildingSystems.Fluid.Sensors.TraceSubstances senSou(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT mSin(
    redeclare package Medium = Medium, nPorts=1) "Exhaust air"
    annotation (Placement(transformation(extent={{-42,-62},{-22,-42}})));
  BuildingSystems.Fluid.Sensors.Conversions.To_VolumeFraction masFraSou(
    MMMea=Modelica.Media.IdealGases.Common.SingleGasesData.CO2.MM)
    "Conversion of mass ratio to volume ratio"
    annotation (Placement(transformation(extent={{140,90},{160,110}})));
  BuildingSystems.Fluid.Sensors.Conversions.To_VolumeFraction masFraVol(
    MMMea=Modelica.Media.IdealGases.Common.SingleGasesData.CO2.MM)
    "Conversion of mass ratio to volume ratio"
    annotation (Placement(transformation(extent={{140,50},{160,70}})));
  BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort senTraSub(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Sensors.TraceSubstancesTwoPort senTraSubNoFlorRev(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  BuildingSystems.Fluid.Sensors.PPM senPPM(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false)
    "PPM sensor"
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/TraceSubstances.mos"
        "Simulate and plot"),
