...
model Density "Test model for the density sensor"
  ...
  BuildingSystems.Fluid.Sensors.Density senDenVol(
  ...
  BuildingSystems.Fluid.Sensors.DensityTwoPort senDenFlo(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Density.mos"
        "Simulate and plot"),
