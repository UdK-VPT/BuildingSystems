...
model SpecificEnthalpy "Test model for the enthalpy flow rate sensors"
  ...
  BuildingSystems.Fluid.Sensors.SpecificEnthalpy senFloSou(
    redeclare package Medium = Medium) "Sensor at the flow source"
    annotation (Placement(transformation(extent={{-10,0},{10,20}})));
  BuildingSystems.Fluid.Sensors.SpecificEnthalpyTwoPort senStr(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/SpecificEnthalpy.mos"
