...
model RelativeHumidity "Test model for relative humidity sensor"
  ...
  BuildingSystems.Fluid.Sensors.RelativeHumidity senRelHum(
    redeclare package Medium = Medium)
  ...
  BuildingSystems.Fluid.Sensors.RelativeHumidityTwoPort relHum(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/RelativeHumidity.mos"
        "Simulate and plot"),
