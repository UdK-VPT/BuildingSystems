...
model EntropyFlowRate "Test model for the entropy flow rate sensors"
  ...
  BuildingSystems.Fluid.Sensors.EntropyFlowRate  senS_flow(
  ...
  BuildingSystems.Fluid.Sensors.SpecificEntropyTwoPort  senS(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/EntropyFlowRate.mos"
