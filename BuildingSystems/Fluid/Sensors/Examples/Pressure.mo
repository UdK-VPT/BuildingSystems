...
model Pressure "Test model for the pressure sensor"
  ...
  BuildingSystems.Fluid.Sources.MassFlowSource_T masFloRat(
    redeclare package Medium = Medium,
    use_T_in=false,
    X={0.02,0.98},
    use_m_flow_in=true,
  ...
  BuildingSystems.Fluid.FixedResistances.FixedResistanceDpM dp(
    redeclare package Medium = Medium,
    m_flow_nominal=10,
  ...
  BuildingSystems.Fluid.Sensors.Pressure senPre_a(redeclare package Medium = Medium)
    "Pressure sensor at resistance port a"
    annotation (Placement(transformation(extent={{-22,20},{-2,40}})));
  BuildingSystems.Fluid.Sensors.Pressure senPre_b(redeclare package Medium = Medium)
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Pressure.mos"
        "Simulate and plot"),
