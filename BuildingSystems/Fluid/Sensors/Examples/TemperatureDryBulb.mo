...
model TemperatureDryBulb "Test model for the dry bulb temperature sensor"
 ...
 package Medium = BuildingSystems.Media.Air "Medium model";
  BuildingSystems.Fluid.Sources.Boundary_pT amb(
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temSteSta(
   redeclare package Medium = Medium,
   m_flow_nominal=2,
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort temDynLoss(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    initType=Modelica.Blocks.Types.Init.InitialState,
    transferHeat=true,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/TemperatureDryBulb.mos"
        "Simulate and plot"),
