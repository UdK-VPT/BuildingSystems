...
model TemperatureWetBulb "Test model for the wet bulb temperature sensor"
 ...
 package Medium = BuildingSystems.Media.Air "Medium model"
  ...
  BuildingSystems.Fluid.Sensors.TemperatureWetBulbTwoPort senWetBul(
    redeclare package Medium=Medium,
    m_flow_nominal=1,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Sensors/Examples/TemperatureWetBulb.mos"
        "Simulate and plot"),
