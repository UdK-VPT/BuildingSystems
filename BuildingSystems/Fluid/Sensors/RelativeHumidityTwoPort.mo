...
equation
  ...
  phi_a = BuildingSystems.Utilities.Psychrometrics.Functions.phi_pTX(
    p=port_a.p,
    T=T_a,
    X_w=Xi_a[1]);

  if allowFlowReversal then
    phi_b = BuildingSystems.Utilities.Psychrometrics.Functions.phi_pTX(
      p=port_b.p,
      T=T_b,
      X_w=Xi_b[1]);
...
<a href=\"modelica://BuildingSystems.Fluid.Sensors.UsersGuide\">
