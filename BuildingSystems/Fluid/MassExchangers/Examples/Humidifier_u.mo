within BuildingSystems.Fluid.MassExchangers.Examples;
model Humidifier_u "Model that demonstrates the ideal humidifier model"
  ...
  BuildingSystems.Fluid.MassExchangers.Humidifier_u humSte(
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Controls.Continuous.LimPID con1(
    Td=1,
    k=1,
    Ti=10,
  ...
  BuildingSystems.Fluid.MassExchangers.Humidifier_u humDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    mWat_flow_nominal=m_flow_nominal*0.005,
  ...
  BuildingSystems.Controls.Continuous.LimPID con2(
    Td=1,
    Ti=10,
    k=0.1,
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/MassExchangers/Examples/Humidifier_u.mos"
        "Simulate and plot"),
