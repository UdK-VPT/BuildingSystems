...
model Basic "Example implementation of flow system"
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_dp pmpSouth(
    redeclare package Medium = Medium,
    redeclare replaceable
      BuildingSystems.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    m_flow_nominal=27570/3600,
    inputType=BuildingSystems.Fluid.Types.InputType.Stages,
    ...
    "Pump to south of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-60,-20})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop pipSouth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,18})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop pipSouth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=3) "Pipe 2 to south of building" annotation (Placement(
        ...
        rotation=90,
        origin={-40,18})));
  BuildingSystems.Fluid.Movers.FlowControlled_dp pmpNorth(
    redeclare package Medium = Medium,
    redeclare replaceable
      BuildingSystems.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
     "Pump to north of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={60,-20})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop pipNorth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=5) "Pipe 2 to north of building" annotation (Placement(
        ...
        rotation=90,
        origin={80,18})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop pipNorth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={40,18})));
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear[4] valSouth1(
    each dpFixed_nominal=0,
    each CvData=BuildingSystems.Fluid.Types.CvTypes.OpPoint,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-80,60})));
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear[8] valSouth2(
    each dpFixed_nominal=0,
    each CvData=BuildingSystems.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(extent={{10,10},{-10,-10}},
        rotation=270,
        origin={-40,60})));
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear[4] valNorth1(
    each dpFixed_nominal=0,
    each CvData=BuildingSystems.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={40,60})));
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear[8] valNorth2(
    each dpFixed_nominal=0,
    each CvData=BuildingSystems.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
  ...
  BuildingSystems.Fluid.Actuators.Valves.ThreeWayLinear valSouth(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-60,-50})));
  BuildingSystems.Fluid.Actuators.Valves.ThreeWayLinear valNorth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    dpFixed_nominal={20000,0},
    from_dp=true,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={60,-50})));
  BuildingSystems.Fluid.HeatExchangers.PrescribedOutlet heater(
    m_flow_nominal=10,
    dp_nominal=100,
    redeclare package Medium = Medium,
    use_X_wSet=false)                  "Heating device"
    annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
  BuildingSystems.Fluid.Sources.Boundary_pT bou(nPorts=1,
  ...
  BuildingSystems.Fluid.FixedResistances.Junction spl1(
    m_flow_nominal={10,10,10},
    dp_nominal={10,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  BuildingSystems.Fluid.Movers.FlowControlled_m_flow pumpHea(
    m_flow_nominal=10,
    redeclare BuildingSystems.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2 per,
    redeclare package Medium = Medium,
    inputType=BuildingSystems.Fluid.Types.InputType.Stages,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear valHea(
    each dpFixed_nominal=0,
    each CvData=BuildingSystems.Fluid.Types.CvTypes.OpPoint,
    redeclare package Medium = Medium,
  ...
  BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear valCoo(
    each dpFixed_nominal=0,
    each CvData=BuildingSystems.Fluid.Types.CvTypes.OpPoint,
    redeclare package Medium = Medium,
    each m_flow_nominal=10,
  ...
  BuildingSystems.Fluid.FixedResistances.Junction spl2(
    m_flow_nominal={10,10,10},
    dp_nominal={1000,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
                                       "Splitter"
    annotation (Placement(transformation(extent={{40,-110},{20,-90}})));
  BuildingSystems.Fluid.FixedResistances.Junction spl3(
    m_flow_nominal={10,10,10},
    dp_nominal={10,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Splitter"
    annotation (Placement(transformation(extent={{20,-120},{40,-140}})));
  BuildingSystems.Fluid.Movers.FlowControlled_m_flow pumpCoo(
    m_flow_nominal=10,
    redeclare
      BuildingSystems.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2
      per,
    redeclare package Medium = Medium,
    inputType=BuildingSystems.Fluid.Types.InputType.Stages,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop tabsSouth1[4](
    redeclare each package Medium = Medium,
    ...
    "Pressure drop of southern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-80,90})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop tabsSouth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of southern tabs sections on collector 2" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-40,90})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop tabsNorth1[4](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of northern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={40,90})));
  BuildingSystems.Fluid.FixedResistances.PressureDrop tabsNorth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
...
<p>
Example model demonstrating the use of the <code>BuildingSystems</code> components in a larger system.
This model is extended in
<a href=\"modelica://BuildingSystems.Fluid.Examples.FlowSystem.Simplified1\">
BuildingSystems.Fluid.Examples.FlowSystem.Simplified1</a>,
<a href=\"modelica://BuildingSystems.Fluid.Examples.FlowSystem.Simplified2\">
BuildingSystems.Fluid.Examples.FlowSystem.Simplified2</a>,
<a href=\"modelica://BuildingSystems.Fluid.Examples.FlowSystem.Simplified3\">
BuildingSystems.Fluid.Examples.FlowSystem.Simplified3</a>.
