...
It servers as a demonstration case of how the <code>BuildingSystems</code> library can be used.
</p>
</html>"),
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Examples/SimpleHouse.mos"
        "Simulate and plot"));
end SimpleHouse;
