within BuildingSystems.Fluid.Examples.Performance.BaseClasses;
partial model Example1 "Example 1 partial model"
  ...
  BuildingSystems.Fluid.Actuators.Valves.ThreeWayLinear val(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop[nRes.k] res(
    redeclare package Medium = Medium,
...
<a href=\"modelica://BuildingSystems.Fluid.Examples.Performance.Example1v1\">
BuildingSystems.Fluid.Examples.Performance.Example1v1</a>
and
<a href=\"modelica://BuildingSystems.Fluid.Examples.Performance.Example1v2\">
BuildingSystems.Fluid.Examples.Performance.Example1v2</a>
