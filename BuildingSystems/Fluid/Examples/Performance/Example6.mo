...
<a href=\"modelica://BuildingSystems.Fluid.Examples.Performance.Example7\">
BuildingSystems.Fluid.Examples.Performance.Example7</a>,
...
<pre>
simulateModel(\"BuildingSystems.Fluid.Examples.PerformanceExamples.Example6\", stopTime=100, numberOfIntervals=1, method=\"Rkfix4\", fixedstepsize=0.001, resultFile=\"Example6\");
simulateModel(\"BuildingSystems.Fluid.Examples.PerformanceExamples.Example7\", stopTime=100, numberOfIntervals=1, method=\"Rkfix4\", fixedstepsize=0.001, resultFile=\"Example7\");
</pre>
<p>
...
<p>
<code>
simulateModel(\"BuildingSystems.Fluid.Examples.Performance.Example6\", stopTime=100, numberOfIntervals=1, method=\"Euler\", fixedstepsize=0.001, resultFile=\"Example6\");
</code>
</p>
<p>
...
Submitted: 11th Modelica Conference. Paris, France. Sep. 2015.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Examples/Performance/Example6.mos"
        "Simulate and plot"));
end Example6;
