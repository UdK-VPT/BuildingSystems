...
model SeriesParallelDp
  ...
  FixedResistances.PressureDrop res2(
    ...
    from_dp=false)
                  "Series pressure drop component"
...
and the value of parameter <code>from_dp</code>.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/SeriesParallelDp.mos"
        "Simulate and plot"));
