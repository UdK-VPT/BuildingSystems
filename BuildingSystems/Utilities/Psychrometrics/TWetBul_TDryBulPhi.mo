...
equation
  if approximateWetBulb then
    ...
    TWetBul = (TDryBul * ((1-XiDryBul) *
               BuildingSystems.Utilities.Psychrometrics.Constants.cpAir + XiDryBul *
               BuildingSystems.Utilities.Psychrometrics.Constants.cpSte) + (XiDryBul-XiSat) *
               BuildingSystems.Utilities.Psychrometrics.Constants.h_fg)/
            ( (1-XiSat)*BuildingSystems.Utilities.Psychrometrics.Constants.cpAir + XiSat *
            BuildingSystems.Utilities.Psychrometrics.Constants.cpSte);
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
