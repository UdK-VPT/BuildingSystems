...
equation
  if approximateWetBulb then
    ...
    XiSat  = BuildingSystems.Utilities.Psychrometrics.Functions.X_pSatpphi(
      pSat = BuildingSystems.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TWetBul),
      p =    p,
      phi =  1);
    XiDryBul =BuildingSystems.Utilities.Psychrometrics.Functions.X_pSatpphi(
      p =    p,
      pSat = BuildingSystems.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TDryBul),
      phi =  phi);
    (TWetBul-BuildingSystems.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * BuildingSystems.Utilities.Psychrometrics.Constants.cpAir +
              XiSatRefIn * BuildingSystems.Utilities.Psychrometrics.Constants.cpSte +
              (XiDryBul-XiSatRefIn) * BuildingSystems.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-BuildingSystems.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * BuildingSystems.Utilities.Psychrometrics.Constants.cpAir +
              XiDryBul * BuildingSystems.Utilities.Psychrometrics.Constants.cpSte)  +
    (XiDryBul-XiSatRefIn) * BuildingSystems.Utilities.Psychrometrics.Constants.h_fg;
...
<a href=\"modelica://BuildingSystems.Utilities.Psychrometrics.Examples.TWetBul_TDryBulPhi\">
BuildingSystems.Utilities.Psychrometrics.Examples.TWetBul_TDryBulPhi</a>.
</p>
<p>
For a model that takes the mass fraction instead of the relative humidity as an input, see
<a href=\"modelica://BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulXi\">
BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulXi</a>.
</p>
<h4>References</h4>
<p>
Stull, Roland.
...
<code>BuildingSystems.Utilities.Psychrometrics.Functions.saturationPressure()</code>
and
<code>BuildingSystems.Utilities.Psychrometrics.Functions.saturationPressureLiquid()</code>
