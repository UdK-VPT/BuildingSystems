...
equation
  XWetBul   = BuildingSystems.Utilities.Psychrometrics.Functions.X_pSatpphi(
      pSat=   BuildingSystems.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TWetBul),
      p=     p,
      phi=   1);
  TWetBul = (TDryBul * ((1-XDryBul) * BuildingSystems.Utilities.Psychrometrics.Constants.cpAir +
             XDryBul * BuildingSystems.Utilities.Psychrometrics.Constants.cpSte) +
             (XDryBul-XWetBul) * BuildingSystems.Utilities.Psychrometrics.Constants.h_fg)/
              ( (1-XWetBul)*BuildingSystems.Utilities.Psychrometrics.Constants.cpAir +
              XWetBul * BuildingSystems.Utilities.Psychrometrics.Constants.cpSte);
  annotation (
