...
equation
  if approximateWetBulb then
    ...
    rh_per       = 100 * p/
         BuildingSystems.Utilities.Psychrometrics.Functions.saturationPressure(TDryBul)
         *Xi[iWat]/(Xi[iWat] +
         BuildingSystems.Utilities.Psychrometrics.Constants.k_mair*(1-Xi[iWat]));
    ...
    (TWetBul-BuildingSystems.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * BuildingSystems.Utilities.Psychrometrics.Constants.cpAir +
              XiSatRefIn * BuildingSystems.Utilities.Psychrometrics.Constants.cpSte +
              (Xi[iWat]-XiSatRefIn) * BuildingSystems.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-BuildingSystems.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * BuildingSystems.Utilities.Psychrometrics.Constants.cpAir +
              Xi[iWat] * BuildingSystems.Utilities.Psychrometrics.Constants.cpSte)  +
    (Xi[iWat]-XiSatRefIn) * BuildingSystems.Utilities.Psychrometrics.Constants.h_fg;
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
...
<a href=\"modelica://BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulPhi\">
BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulPhi</a>.
</p>
<h4>References</h4>
<p>
Stull, Roland.
...
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.smoothMin\">
BuildingSystems.Utilities.Math.Functions.smoothMin</a> rather
than <code>min</code>.
</li>
<li>
