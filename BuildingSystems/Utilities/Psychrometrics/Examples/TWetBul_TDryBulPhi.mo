...
model TWetBul_TDryBulPhi "Model to test the wet bulb temperature computation"
 ...
 package Medium = BuildingSystems.Media.Air "Medium model"
  ...
  BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulPhi wetBulPhi(redeclare
  ...
  Modelica.Blocks.Sources.Constant TDryBul(k=283.15) "Dry bulb temperature"
            ...
            {-80,80}})));
  BuildingSystems.Utilities.Psychrometrics.TWetBul_TDryBulPhi wetBulPhiApp(redeclare
