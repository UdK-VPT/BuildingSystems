...
model Phi_pTX "Model to test the relative humidity computation"
 ...
 package Medium = BuildingSystems.Media.Air "Medium model"
  ...
  BuildingSystems.Utilities.Psychrometrics.Phi_pTX phi "Relative humidity"
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Phi_pTX.mos"
        "Simulate and plot"),
