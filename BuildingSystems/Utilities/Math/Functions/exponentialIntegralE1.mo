...
algorithm
    ...
    E1 := if x < 1 then
            BuildingSystems.Utilities.Math.Functions.polynomial(x, a1) - log(x)
          else
           BuildingSystems.Utilities.Math.Functions.polynomial(x, a2)/(BuildingSystems.Utilities.Math.Functions.polynomial(x, b2)*x*exp(x));
