...
algorithm
  if n > 2 then
    ...
    dy_dx :=BuildingSystems.Utilities.Math.Functions.splineDerivatives(
      x=xSup,
      y=ySup,
...
BuildingSystems.Utilities.Math.Functions.interpolate</a> to perform the interpolation.
...
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.Examples.Interpolate\">
BuildingSystems.Utilities.Math.Functions.Examples.Interpolate</a>.
</p>
<p>
...
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.Examples.SmoothInterpolation\">
BuildingSystems.Utilities.Math.Functions.Examples.SmoothInterpolation</a>.
</p>
</html>",
revisions="<html>
<ul>
