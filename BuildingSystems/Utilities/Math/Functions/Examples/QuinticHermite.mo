...
equation
  ...
  y= noEvent(smooth(2,if x>x2 then exp(a*x)
     ...
     else BuildingSystems.Utilities.Math.Functions.quinticHermite(x=x,x1=x1,x2=x2,y1=y1,y2=y2,y1d=y1d,y2d=y2d,y1dd=y1dd,y2dd=y2dd)));
  dy=der(y);
  ddy=der(dy);
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/QuinticHermite.mos"
        "Simulate and plot"));
end QuinticHermite;
