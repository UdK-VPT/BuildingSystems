...
equation
  Y0 = BuildingSystems.Utilities.Math.Functions.besselY0(time);

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/BesselY0.mos"
        "Simulate and plot"),
