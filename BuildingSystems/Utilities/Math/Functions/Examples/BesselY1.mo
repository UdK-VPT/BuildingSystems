...
equation
  Y1 = BuildingSystems.Utilities.Math.Functions.besselY1(time);

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/BesselY1.mos"
        "Simulate and plot"),
