...
equation
  E1 = BuildingSystems.Utilities.Math.Functions.exponentialIntegralE1(time);

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/ExponentialIntegralE1.mos"
        "Simulate and plot"),
