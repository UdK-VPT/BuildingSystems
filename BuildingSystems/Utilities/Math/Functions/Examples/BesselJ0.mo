...
equation
  ...
  J0 = BuildingSystems.Utilities.Math.Functions.besselJ0(time);

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/BesselJ0.mos"
        "Simulate and plot"),
