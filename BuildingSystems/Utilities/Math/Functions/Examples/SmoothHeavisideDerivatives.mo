...
model SmoothHeavisideDerivatives
  ...
  Real y = BuildingSystems.Utilities.Math.Functions.smoothHeaviside(x=time, delta=0.2) "Function value";
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/SmoothHeavisideDerivatives.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This model tests the first and second derivative of the twice Lipschitz continuously differentiable function
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.smoothHeaviside\">
BuildingSystems.Utilities.Math.Functions.smoothHeaviside</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
