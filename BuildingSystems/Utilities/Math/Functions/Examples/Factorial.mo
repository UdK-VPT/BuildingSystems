...
equation
  ...
  fac = BuildingSystems.Utilities.Math.Functions.factorial(n);

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Factorial.mos"
        "Simulate and plot"),
