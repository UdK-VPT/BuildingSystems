...
equation
  ...
  for k in 1:10 loop
    falFac[k] = BuildingSystems.Utilities.Math.Functions.fallingFactorial(n,k);
  end for;

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/FallingFactorial.mos"
        "Simulate and plot"),
