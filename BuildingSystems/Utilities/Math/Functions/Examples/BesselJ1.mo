...
equation
  J1 = BuildingSystems.Utilities.Math.Functions.besselJ1(time);

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/BesselJ1.mos"
        "Simulate and plot"),
