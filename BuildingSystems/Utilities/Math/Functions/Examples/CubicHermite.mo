...
initial algorithm
  ...
  dMonotone := BuildingSystems.Utilities.Math.Functions.splineDerivatives(x=xd, y=yd,
...
algorithm
  ...
  y := BuildingSystems.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
    x=x,
    x1=xd[i],
    x2=xd[i + 1],
    y1=yd[i],
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/CubicHermite.mos"
        "Simulate and plot"),
