...
algorithm
  ...
  y := BuildingSystems.Utilities.Math.Functions.smoothInterpolation(
    x=x,
    xSup=xSup,
    ySup=ySup,
    ensureMonotonicity=false);
  yMonotone := BuildingSystems.Utilities.Math.Functions.smoothInterpolation(
    x=x,
    xSup=xSup,
    ySup=ySup,
    ensureMonotonicity=true);
  // Case with n = 2
  y2 := BuildingSystems.Utilities.Math.Functions.smoothInterpolation(
    x=x,
    xSup=xSup[1:2],
    ySup=ySup[1:2],
    ensureMonotonicity=false);
  y2Monotone := BuildingSystems.Utilities.Math.Functions.smoothInterpolation(
    x=x,
    xSup=xSup[1:2],
    ySup=ySup[1:2],
    ensureMonotonicity=true);
  // Case with n = 1
  y1 := BuildingSystems.Utilities.Math.Functions.smoothInterpolation(
    x=x,
    xSup={xSup[1]},
    ySup={ySup[1]},
    ensureMonotonicity=false);
  y1Monotone := BuildingSystems.Utilities.Math.Functions.smoothInterpolation(
    x=x,
    xSup={xSup[1]},
    ySup={ySup[1]},
    ensureMonotonicity=true);
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/SmoothInterpolation.mos"
        "Simulate and plot"),
...
<p align=\"center\"><img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Utilities/Math/Functions/Examples/cubicHermite.png\"/></p>
<p>
