...
equation
  ...
  for k in 1:10 loop
    if n >= k then
      bin[k] = BuildingSystems.Utilities.Math.Functions.binomial(n,k);
    else
      bin[k] = 0.0;
    end if;
  end for;
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Binomial.mos"
        "Simulate and plot"),
