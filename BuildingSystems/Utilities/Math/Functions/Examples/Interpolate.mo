...
equation
   dp=ramp.y;
   m_flow = BuildingSystems.Utilities.Math.Functions.interpolate(u=dp, xd=xd, yd=yd, d=d);

  annotation (
experiment(
      StopTime=500,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Interpolate.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This example demonstrates the function
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.interpolate\">
BuildingSystems.Utilities.Math.Functions.interpolate</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
Moved to
<a href=\"modelica://BuildingSystems.Utilities.Math.Functions.Examples\">
BuildingSystems.Utilities.Math.Functions</a>
from
<a href=\"modelica://BuildingSystems.Airflow.Multizone.BaseClasses.Examples\">
