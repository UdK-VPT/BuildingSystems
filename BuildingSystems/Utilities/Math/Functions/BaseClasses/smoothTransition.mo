...
annotation(smoothOrder=2,
  derivative(order=1,
          ...
          zeroDerivative=d,
          zeroDerivative=e,
          zeroDerivative=f)=BuildingSystems.Utilities.Math.Functions.BaseClasses.der_smoothTransition,
...
BuildingSystems.Utilities.Math.Functions.BaseClasses.der_2__smoothTransition</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
