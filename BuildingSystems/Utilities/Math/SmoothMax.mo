...
equation
  y =  BuildingSystems.Utilities.Math.Functions.smoothMax(x1=u1, x2=u2, deltaX=deltaX);
...
<a href=\"modelica://BuildingSystems.Utilities.Math.Examples.SmoothMin\">
BuildingSystems.Utilities.Math.Examples.SmoothMin</a>.
</p>
</html>",
revisions="<html>
<ul>
