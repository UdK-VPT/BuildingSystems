...
model IntegerReplicator "Test model for integer replicator"
  ...
  BuildingSystems.Utilities.Math.IntegerReplicator intRep(nout=
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegerReplicator.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Utilities.Math.IntegerReplicator\">
BuildingSystems.Utilities.Math.IntegerReplicator</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
