...
model IntegratorWithReset "Test model for integrator with reset"
  ...
  BuildingSystems.Utilities.Math.IntegratorWithReset intWitRes1(
    y_start=5, reset=BuildingSystems.Types.Reset.Parameter,
    k=0.5,
    y_reset=2)                                      "Integrator with reset"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));

  BuildingSystems.Utilities.Math.IntegratorWithReset intWitRes2(
    y_reset=10,
    y_start=-5,
  ...
  BuildingSystems.Utilities.Math.IntegratorWithReset intNoReset(
  ...
  BuildingSystems.Utilities.Math.IntegratorWithReset intDef
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegratorWithReset.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Utilities.Math.IntegratorWithReset\">
BuildingSystems.Utilities.Math.IntegratorWithReset</a>
