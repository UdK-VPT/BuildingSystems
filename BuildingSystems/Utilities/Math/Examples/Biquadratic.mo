...
model Biquadratic "Test model for biquadratic function"
  ...
  BuildingSystems.Utilities.Math.Biquadratic biquadratic(a={1,2,3,4,5,6})
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/Biquadratic.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Utilities.Math.Biquadratic\">
BuildingSystems.Utilities.Math.Biquadratic</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
