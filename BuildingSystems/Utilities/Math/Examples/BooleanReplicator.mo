...
model BooleanReplicator "Test model for boolean replicator"
  ...
  BuildingSystems.Utilities.Math.BooleanReplicator booRep(nout=
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/BooleanReplicator.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Utilities.Math.BooleanReplicator\">
BuildingSystems.Utilities.Math.BooleanReplicator</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
