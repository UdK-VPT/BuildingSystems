...
model Interpolate "Example model of the Interpolate block"
  ...
  BuildingSystems.Utilities.Math.Interpolate int(
    xd=xd,
    yd=yd,
...
experiment(
      StopTime=500,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/Interpolate.mos"
