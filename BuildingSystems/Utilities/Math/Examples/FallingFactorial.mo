...
model FallingFactorial "Test model for falling factorial function "
  ...
  BuildingSystems.Utilities.Math.FallingFactorial falFac "Falling factorial"
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/FallingFactorial.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Utilities.Math.FallingFactorial\">
BuildingSystems.Utilities.Math.FallingFactorial</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
