...
model QuadraticLinear "Test model for quadraticLinear function "
  ...
  BuildingSystems.Utilities.Math.QuadraticLinear quadraticLinear(a={1,2,3,4,5,6})
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Math/Examples/QuadraticLinear.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Utilities.Math.QuadraticLinear\">
BuildingSystems.Utilities.Math.QuadraticLinear</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
