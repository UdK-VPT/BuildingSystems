within BuildingSystems.Utilities.Math;
block IntegratorWithReset "Output the integral of the input signal"
  ...
  */
  ...
  parameter Real y_reset = 0
    "Value to which integrator is reset, used if reset = BuildingSystems.Types.Reset.Parameter"
    annotation(Evaluate=true,
               Dialog(
                 enable=reset == BuildingSystems.Types.Reset.Parameter,
                 group="Integrator reset"));

  Modelica.Blocks.Interfaces.RealInput y_reset_in
    if reset == BuildingSystems.Types.Reset.Input
  ...
  Modelica.Blocks.Interfaces.BooleanInput trigger
    if reset <> BuildingSystems.Types.Reset.Disabled
...
equation
  ...
  if reset == BuildingSystems.Types.Reset.Disabled then
...
<p>
See <a href=\"modelica://BuildingSystems.Utilities.Math.Examples.IntegratorWithReset\">
BuildingSystems.Utilities.Math.Examples.IntegratorWithReset</a> for an example.
</p>
...
Icon(coordinateSystem(
        ...
        graphics={
          ...
          visible=reset == BuildingSystems.Types.Reset.Input,
          horizontalAlignment=TextAlignment.Left),
        Bitmap(extent={{-54,-50},{60,50}}, fileName=
              "modelica://BuildingSystems/Resources/Images/Utilities/Math/int.png"),
          Text(
            extent={{-88,56},{206,92}},
          lineColor={0,0,0},
          textString="k=%k",
