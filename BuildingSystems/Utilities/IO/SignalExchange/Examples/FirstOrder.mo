within BuildingSystems.Utilities.IO.SignalExchange.Examples;
model FirstOrder
...
equation
  ...
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/IO/SignalExchange/Examples/FirstOrder.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example uses the signal exchange blocks in an original model,
<a href=\"modelica://BuildingSystems.Utilities.IO.SignalExchange.Examples.BaseClasses.OriginalModel\">
BuildingSystems.Utilities.IO.SignalExchange.Examples.BaseClasses.OriginalModel</a>
along with a corresponding model that would result if the original model were
compiled with the BOPTEST parser, <a href=\"modelica://BuildingSystems.Utilities.IO.SignalExchange.Examples.BaseClasses.ExportedModel\">
BuildingSystems.Utilities.IO.SignalExchange.Examples.BaseClasses.ExportedModel</a>
