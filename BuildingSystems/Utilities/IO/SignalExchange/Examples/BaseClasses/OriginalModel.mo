within BuildingSystems.Utilities.IO.SignalExchange.Examples.BaseClasses;
model OriginalModel "Original model"
  ...
  Read rea(
    ...
    KPIs=BuildingSystems.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.None)
