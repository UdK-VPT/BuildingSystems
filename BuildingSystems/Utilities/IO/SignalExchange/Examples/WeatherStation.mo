...
model WeatherStation "Example use of WeatherStation"
  ...
  BuildingSystems.Utilities.IO.SignalExchange.WeatherStation weaSta "Weather station"
...
equation
  ...
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/IO/SignalExchange/Examples/WeatherStation.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example uses the weather station signal exchange block,
<a href=\"modelica://BuildingSystems.Utilities.IO.SignalExchange.WeatherStation\">
BuildingSystems.Utilities.IO.SignalExchange.WeatherStation</a>
