within BuildingSystems.Utilities.IO.Files.BaseClasses;
...
protected
  ...
  BuildingSystems.Utilities.IO.Files.BaseClasses.FileWriterObject filWri=
      BuildingSystems.Utilities.IO.Files.BaseClasses.FileWriterObject(
        insNam,
        fileName,
        nin+1,
        isCombiTimeTable)
  ...
  function writeLine
    ...
    input BuildingSystems.Utilities.IO.Files.BaseClasses.FileWriterObject id "ID of the file writer";
