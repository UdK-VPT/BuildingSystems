within BuildingSystems.Utilities.IO.Files.Validation;
...
wed                12  1   4  -" "Contents of schedule.txt";
  BuildingSystems.Utilities.IO.Files.WeeklySchedule weeSchLin(
    columns={2,3,4,5},
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://BuildingSystems/Resources/Data/schedule.txt"),
    t_offset=1e6) "Weekly schedule example using file data source"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));

  BuildingSystems.Utilities.IO.Files.WeeklySchedule weeSchWin(
    columns={2,3,4,5},
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://BuildingSystems/Resources/Data/scheduleWindows.txt"),
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1860\">IBPSA, #1860</a>.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/IO/Files/Validation/WeeklyScheduleWindowsLineEndings.mos"
        "Simulate and plot"));
