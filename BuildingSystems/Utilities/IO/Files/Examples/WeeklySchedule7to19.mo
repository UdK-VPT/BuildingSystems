...
model WeeklySchedule7to19
  ...
  BuildingSystems.Utilities.IO.Files.WeeklySchedule sch
...
Example of a weekly schedule that outputs 1 from 7:00 to 19:00 on week-days, and 0 otherwise</p>
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/IO/Files/Examples/WeeklySchedule7to19.mos"
        "Simulate and plot"));
