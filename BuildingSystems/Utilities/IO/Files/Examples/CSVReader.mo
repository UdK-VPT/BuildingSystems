...
model CSVReader "Reader for csv files generated by CSVWriter"
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://BuildingSystems//Resources/Data/Utilities/IO/Files/Examples/CSVReader/Data.txt"),
    columns={2,3},
  ...
  annotation (
    ...
    experiment(
      ...
      StopTime=10,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/IO/Files/Examples/CSVReader.mos"
        "Simulate and plot"),
...
<code>BuildingSystems//Resources/Data/Utilities/IO/Files/Examples/CSVReader/Data.txt</code>.
It has the format of a file that can be generated by
<a href=\"modelica://BuildingSystems.Utilities.IO.Files.Examples.CSVWriter\">
BuildingSystems.Utilities.IO.Files.Examples.CSVWriter</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
