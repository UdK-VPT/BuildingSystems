...
model CSVWriter "Example of csv writer use"
  extends BuildingSystems.Utilities.IO.Files.Examples.BaseClasses.PartialCSV;
  ...
  BuildingSystems.Utilities.IO.Files.CSVWriter csvWriter(
    writeHeader=false,
    nin=2,
    samplePeriod=0.3)
...
This model demonstrates the use of the csv file writer.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/IO/Files/Examples/CSVWriter.mos"
        "Simulate and plot"));
end CSVWriter;
