...
model CalendarTimeMonths "Validation model for the calendar time model"
  ...
  BuildingSystems.Utilities.Time.CalendarTime calTim(zerTim=BuildingSystems.Utilities.Time.Types.ZeroTime.NY2015)
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Time/Validation/CalendarTimeMonths.mos"
        "Simulate and plot"),
  Documentation(
    info="<html>
<p>
