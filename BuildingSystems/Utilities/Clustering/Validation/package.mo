within BuildingSystems.Utilities.Clustering;
package Validation "Validation models for clustering functions."
  extends Modelica.Icons.ExamplesPackage;

annotation (Documentation(info="<html>
  <p>This package contains models for validation of clustering functions. The
