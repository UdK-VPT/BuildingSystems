within BuildingSystems.Utilities.Clustering.Validation;
model KMeans_1d "Model that verifies the k-means clustering function for 1d data"
  extends Modelica.Icons.Example;

  parameter Integer n_clusters = 3 "Number of clusters to be generated";
  parameter Real data[:,:] = [1;2;2;3;4] "Test data to be clustered";
...
initial equation
  (centroids, labels, cluster_size) = BuildingSystems.Utilities.Clustering.KMeans(
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Utilities/Clustering/Validation/KMeans_1d.mos"
        "Simulate and plot"),
