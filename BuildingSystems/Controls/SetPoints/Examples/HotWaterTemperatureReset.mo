...
model HotWaterTemperatureReset "Test model for the heating curve"
  ...
  BuildingSystems.Controls.SetPoints.HotWaterTemperatureReset heaCur(
    m=1,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
    TOut_nominal=263.15)
  ...
  BuildingSystems.Controls.SetPoints.HotWaterTemperatureReset heaCur1(
    m=1,
    use_TRoo_in=true,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/SetPoints/Examples/HotWaterTemperatureReset.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Controls/SetPoints/Examples/HotWaterTemperatureReset.png\" border=\"1\" alt=\"Supply and return water temperatures.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
