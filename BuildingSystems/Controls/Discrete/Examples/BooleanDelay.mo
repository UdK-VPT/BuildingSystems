...
model BooleanDelay "Example model for boolean delay"
  ...
  BuildingSystems.Controls.Discrete.BooleanDelay del(samplePeriod=0.1)
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Controls/Discrete/Examples/BooleanDelay.png\" border=\"1\" alt=\"Input and output of the boolean delay.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
