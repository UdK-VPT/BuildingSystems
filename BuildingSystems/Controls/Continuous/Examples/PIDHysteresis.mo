...
model PIDHysteresis "Example model for PID controller with hysteresis"
  ...
  BuildingSystems.Controls.Continuous.PIDHysteresis con(
    pre_y_start=false,
...
equation
  ...
  connect(sine.y, TBC.T) annotation (Line(
      points={{-59,70},{-2,70}},
      color={0,0,127}));
 annotation (                      __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/Continuous/Examples/PIDHysteresis.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Controls/Continuous/Examples/PIDHysteresis.png\" border=\"1\" alt=\"Control error.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
