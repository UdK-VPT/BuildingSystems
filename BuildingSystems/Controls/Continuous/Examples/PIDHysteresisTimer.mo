...
model PIDHysteresisTimer
  ...
  BuildingSystems.Controls.Continuous.PIDHysteresisTimer con(
    yMin=0.3,
    minOffTime=10000,
...
equation
  ...
  connect(sine.y, TBC.T) annotation (Line(
      points={{-59,70},{-2,70}},
      color={0,0,127}));
 annotation (                      __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/Continuous/Examples/PIDHysteresisTimer.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BuildingSystems.Controls.Continuous.Examples.PIDHysteresis\">
BuildingSystems.Controls.Continuous.Examples.PIDHysteresis</a>,
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Controls/Continuous/Examples/PIDHysteresisTimerError.png\" border=\"1\" alt=\"Control error.\"/><br/>
<img src=\"modelica://BuildingSystems/Resources/Images/Controls/Continuous/Examples/PIDHysteresisTimerOutput.png\" border=\"1\" alt=\"Control signal.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
