...
model LimPIDWithReset
  ...
  Controller conWitRes(reset=BuildingSystems.Types.Reset.Parameter)
  ...
  Controller conNoRes(reset=BuildingSystems.Types.Reset.Disabled)
...
<p>
Plant model for
<a href=\"modelica://BuildingSystems.Controls.Continuous.Examples.LimPIDWithReset\">
BuildingSystems.Controls.Continuous.Examples.LimPIDWithReset</a>.
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/Continuous/Examples/LimPIDWithReset.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
