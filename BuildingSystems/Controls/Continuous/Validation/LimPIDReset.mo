within BuildingSystems.Controls.Continuous.Validation;
model LimPIDReset
  ...
  BuildingSystems.Controls.Continuous.LimPID limPIDPar(
    yMax=1,
    yMin=-1,
    reset=BuildingSystems.Types.Reset.Parameter,
    y_reset=0.2,
    Ti=20,
    Td=10,
    k=0.2,
  ...
  BuildingSystems.Controls.Continuous.LimPID limPIDInp(
    y_reset=0.2,
    Td=10,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/Continuous/Validation/LimPIDReset.mos"
        "Simulate and plot"),
...
<a href=\"Modelica://BuildingSystems.Controls.Continuous.LimPID\">BuildingSystems.Controls.Continuous.LimPID</a>
