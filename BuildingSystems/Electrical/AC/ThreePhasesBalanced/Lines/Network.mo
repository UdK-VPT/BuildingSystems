within BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines;
model Network "Three phases balanced AC network"
  extends BuildingSystems.Electrical.Transmission.BaseClasses.PartialNetwork(
    ...
    redeclare replaceable
        BuildingSystems.Electrical.Transmission.LowVoltageCables.Generic commercialCable=grid.cables));
