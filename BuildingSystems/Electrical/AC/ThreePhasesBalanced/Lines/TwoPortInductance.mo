...
model TwoPortInductance "Model of an inductance with two electrical ports"
  extends BuildingSystems.Electrical.AC.OnePhase.Lines.TwoPortInductance(
...
<p>
See model
<a href=\"modelica://BuildingSystems.Electrical.AC.OnePhase.Lines.TwoPortInductance\">
BuildingSystems.Electrical.AC.OnePhase.Lines.TwoPortInductance</a> for more
information.
</p>
</html>"));
