within BuildingSystems.Electrical.AC.ThreePhasesBalanced.Conversion;
model ACACTransformerFull
  "AC AC transformer full model for three phase balanced systems"
  extends BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformerFull(
...
BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformerFull</a> for more
information.
</p>
</html>", revisions="<html>
<ul>
