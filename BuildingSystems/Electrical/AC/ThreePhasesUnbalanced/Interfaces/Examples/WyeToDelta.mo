within BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Examples;
model WyeToDelta "Test for Y to D connection"
  extends Modelica.Icons.Example;

  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToDelta wyeToDelta
    "Conversion of the voltages from Y to D"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Sources.FixedVoltage V1(f=60, V=
        480) "Voltage source"
           annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeWye probe_Y(perUnit=
       false, V_nominal=480)
    "Probe that measures the voltage and the angles on each phase"
    annotation (Placement(transformation(extent={{-30,10},{-10,30}})));
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeWye probeD(perUnit=
        false, V_nominal=480)
    "Probe that measures the voltage and the angles on each phase"
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Interfaces/Examples/WyeToDelta.mos"
        "Simulate and plot"),
