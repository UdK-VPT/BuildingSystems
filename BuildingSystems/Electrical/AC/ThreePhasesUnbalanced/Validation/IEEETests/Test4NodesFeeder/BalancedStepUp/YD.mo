...
model YD
  ...
  extends
    ...
    loadRL(use_pf_in=false,
           loadConn=BuildingSystems.Electrical.Types.LoadConnection.wye_to_delta,
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Validation/IEEETests/Test4NodesFeeder/BalancedStepUp/YD.mos"
        "Simulate and plot"),
