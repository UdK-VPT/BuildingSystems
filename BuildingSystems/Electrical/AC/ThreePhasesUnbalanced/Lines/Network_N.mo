...
model Network_N "Three phases unbalanced AC network with neutral cable"
  extends Transmission.BaseClasses.PartialNetwork(
    redeclare
      BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Terminal4_p terminal,
    redeclare replaceable Transmission.Grids.TestGrid2Nodes grid,
    redeclare BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Lines.Line_N lines(
...
equation
  ...
  for i in 1:grid.nNodes loop
    VAbs[1,i] = BuildingSystems.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal[i].phase[1].v - terminal[i].phase[4].v);
    VAbs[2,i] = BuildingSystems.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal[i].phase[2].v - terminal[i].phase[4].v);
    VAbs[3,i] = BuildingSystems.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal[i].phase[3].v - terminal[i].phase[4].v);
  end for;
  annotation (
...
<p>
See <a href=\"modelica://BuildingSystems.Electrical.Transmission.BaseClasses.PartialNetwork\">
BuildingSystems.Electrical.Transmission.BaseClasses.PartialNetwork</a>
for information about the network model.
</p>
<p>
See <a href=\"modelica://BuildingSystems.Electrical.Transmission.Grids.PartialGrid\">
BuildingSystems.Electrical.Transmission.Grids.PartialGrid</a>
