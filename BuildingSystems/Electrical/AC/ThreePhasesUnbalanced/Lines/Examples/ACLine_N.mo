...
model ACLine_N
  ...
  Line_N line_1(
    ...
    P_nominal=2000,
    V_nominal=480,
    mode=BuildingSystems.Electrical.Types.CableMode.commercial,
    redeclare BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu35
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_N.mos"
        "Simulate and plot"),
