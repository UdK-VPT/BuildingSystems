within BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Lines.Examples;
model ACLine_RLC_N
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_RLC_N.mos"
        "Simulate and plot"),
