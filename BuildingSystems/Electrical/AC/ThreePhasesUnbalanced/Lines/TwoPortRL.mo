...
model TwoPortRL
  ...
  parameter BuildingSystems.Electrical.Types.Load mode(
    ...
    max=BuildingSystems.Electrical.Types.Load.FixedZ_dynamic) = BuildingSystems.Electrical.Types.Load.FixedZ_steady_state
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Lines/twoPortRL.png\"/>
</p>
