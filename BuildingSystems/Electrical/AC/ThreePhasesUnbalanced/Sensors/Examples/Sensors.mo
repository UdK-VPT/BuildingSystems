within BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Sensors.Examples;
...
__Dymola_Commands(file=
 "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sensors/Examples/Sensors.mos"
        "Simulate and plot"));
end Sensors;
