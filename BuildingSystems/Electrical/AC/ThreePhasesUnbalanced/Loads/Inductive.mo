...
model Inductive
  ...
  extends BaseClasses.LoadCtrl(
    redeclare BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive load1(
      pf=pf,
      use_pf_in=use_pf_in),
    redeclare BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive load2(
      pf=pf,
      use_pf_in=use_pf_in),
    redeclare BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive load3(
      pf=pf,
      use_pf_in=use_pf_in));
...
<a href=\"modelica://BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive\">
BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive</a>.
</p>
</html>"));
end Inductive;
