...
partial model LoadCtrl_N
  ...
  extends
    BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.BaseLoadCtrl;
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Terminal4_n terminal
    "Connector for three-phase unbalanced systems with neutral cable"
    annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Connection3to4_n
...
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.PartialLoadCtrl\">
BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.PartialLoadCtrl</a>.
</li>
<li>
