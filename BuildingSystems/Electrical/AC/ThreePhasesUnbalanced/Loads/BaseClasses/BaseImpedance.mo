...
partial model BaseImpedance
  ...
  replaceable BuildingSystems.Electrical.AC.OnePhase.Loads.Impedance
    load1(
    inductive=inductive,
    R=R,
    L=L,
  ...
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToDelta
  ...
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToWyeGround
