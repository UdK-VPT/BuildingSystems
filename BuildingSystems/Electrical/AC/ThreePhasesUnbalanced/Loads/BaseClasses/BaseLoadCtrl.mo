...
partial model BaseLoadCtrl
  ...
  extends BuildingSystems.Electrical.Interfaces.PartialPluggableUnbalanced;
  parameter BuildingSystems.Electrical.Types.LoadConnection loadConn=
    BuildingSystems.Electrical.Types.LoadConnection.wye_to_wyeg
  ...
  parameter BuildingSystems.Electrical.Types.Load mode(
    ...
    max=BuildingSystems.Electrical.Types.Load.VariableZ_y_input)=
    BuildingSystems.Electrical.Types.Load.FixedZ_steady_state "Parameters that specifies the mode of the load (e.g., steady state,
  ...
  parameter Modelica.Units.SI.Power P_nominal=0
    "Nominal power (negative if consumed, positive if generated)" annotation (
      Dialog(group="Nominal conditions", enable=mode <> BuildingSystems.Electrical.Types.Load.VariableZ_P_input));
  ...
  parameter Types.InitMode initMode=BuildingSystems.Electrical.Types.InitMode.zero_current
    "Initialization mode for homotopy operator"
    annotation (Dialog(tab="Initialization"));
  replaceable BuildingSystems.Electrical.Interfaces.Load load1(
    redeclare package PhaseSystem = BuildingSystems.Electrical.PhaseSystems.OnePhase,
    redeclare BuildingSystems.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
  ...
  replaceable BuildingSystems.Electrical.Interfaces.Load load2(
    redeclare package PhaseSystem = BuildingSystems.Electrical.PhaseSystems.OnePhase,
    redeclare BuildingSystems.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    final linearized=linearized,
    final mode=mode,
  ...
  replaceable BuildingSystems.Electrical.Interfaces.Load load3(
    redeclare package PhaseSystem = BuildingSystems.Electrical.PhaseSystems.OnePhase,
    redeclare BuildingSystems.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    final linearized=linearized,
    final mode=mode,
  ...
  Modelica.Blocks.Interfaces.RealInput y1  if plugPhase1 and
    mode == BuildingSystems.Electrical.Types.Load.VariableZ_y_input
  ...
  Modelica.Blocks.Interfaces.RealInput Pow1(unit="W") if plugPhase1 and
    mode == BuildingSystems.Electrical.Types.Load.VariableZ_P_input "Power consumed"
  ...
  Modelica.Blocks.Interfaces.RealInput Pow3(unit="W") if plugPhase3 and
    mode == BuildingSystems.Electrical.Types.Load.VariableZ_P_input "Power consumed"
        ...
        rotation=180,
        origin={120,-80})));
  BuildingSystems.Electrical.Utilities.VoltageControl vCTRL_1(
    redeclare package PhaseSystem = BuildingSystems.Electrical.PhaseSystems.OnePhase,
    redeclare BuildingSystems.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    vThresh=vThresh,
    tDelay=tDelay,
  ...
  BuildingSystems.Electrical.Utilities.VoltageControl vCTRL_2(
    redeclare package PhaseSystem = BuildingSystems.Electrical.PhaseSystems.OnePhase,
    redeclare BuildingSystems.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    vThresh=vThresh,
    tDelay=tDelay,
  ...
  BuildingSystems.Electrical.Utilities.VoltageControl vCTRL_3(
    redeclare package PhaseSystem = BuildingSystems.Electrical.PhaseSystems.OnePhase,
    redeclare BuildingSystems.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    vThresh=vThresh,
    tDelay=tDelay,
  ...
  Interfaces.WyeToDelta
    wyeToDelta if (loadConn == BuildingSystems.Electrical.Types.LoadConnection.wye_to_delta)
    "Wye to delta load connection"
    annotation (Placement(transformation(extent={{-54,0},{-34,20}})));
  Interfaces.WyeToWyeGround
    wyeToWyeGround if (loadConn == BuildingSystems.Electrical.Types.LoadConnection.wye_to_wyeg)
    "Wye to wye grounded connection"
    annotation (Placement(transformation(extent={{-54,-20},{-34,0}})));
protected
  Interfaces.Adapter3to3 adaDel
    if (loadConn == BuildingSystems.Electrical.Types.LoadConnection.wye_to_delta)
    "Adapter"
    annotation (Placement(transformation(extent={{-40,-50},{-60,-30}})));
  Interfaces.Adapter3to3 adaWye
    if (loadConn == BuildingSystems.Electrical.Types.LoadConnection.wye_to_wyeg)
    "Adapter"
...
<a href=\"modelica://BuildingSystems.Electrical.Utilities.VoltageControl\">here</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.Inductive\">
BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.Inductive</a>.
</li>
<li>
