...
model Capacitive
  ...
  extends BaseClasses.LoadCtrl(
    redeclare BuildingSystems.Electrical.AC.OnePhase.Loads.Capacitive load1(pf=pf,
        use_pf_in=use_pf_in),
    redeclare BuildingSystems.Electrical.AC.OnePhase.Loads.Capacitive load2(pf=pf,
        use_pf_in=use_pf_in),
    redeclare BuildingSystems.Electrical.AC.OnePhase.Loads.Capacitive load3(pf=pf,
        use_pf_in=use_pf_in));
...
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl\">
BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl</a>
...
<p>
For more information, see <a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl\">
BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl</a> and
<a href=\"modelica://BuildingSystems.Electrical.AC.OnePhase.Loads.Capacitive\">
BuildingSystems.Electrical.AC.OnePhase.Loads.Capacitive</a>.
</p>
</html>"));
end Capacitive;
