...
model LoadCtrl
  ...
  Lines.Line_N line1(
    ...
    redeclare BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu10
      commercialCable,
    l=400,
    P_nominal=10000,
...
equation
  ...
  annotation (    experiment(Tolerance=1e-6, StopTime=10.0),
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Loads/Examples/LoadCtrl.mos"
        "Simulate and plot"),
