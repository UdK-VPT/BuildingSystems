...
connection secondary side (Voltage step down)"
  ...
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToWyeGround wye_to_wyeg
    "Wye to wye grounded connection"
    annotation (Placement(transformation(extent={{-82,-10},{-62,10}})));
  BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToDelta delta_to_wye
