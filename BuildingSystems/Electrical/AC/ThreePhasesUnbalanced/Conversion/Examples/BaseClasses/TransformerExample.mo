within BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.Examples.BaseClasses;
model TransformerExample
  ...
  replaceable
    BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverter
    tra "Transformer model"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  Loads.Resistive load(
    loadConn=BuildingSystems.Electrical.Types.LoadConnection.wye_to_wyeg,
    P_nominal=-1800e3,
...
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.Examples\">
BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.Examples</a>.
</p>
<p>
