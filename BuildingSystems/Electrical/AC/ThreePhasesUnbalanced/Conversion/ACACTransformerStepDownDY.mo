...
model ACACTransformerStepDownDY
  ...
  extends
    BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverterStepDownDY(
    redeclare BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformer conv1(
      VHigh=VHigh,
      XoverR=XoverR,
      Zperc=Zperc,
      ground_1=ground_1,
    ...
    redeclare BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformer conv2(
      VHigh=VHigh,
      XoverR=XoverR,
      Zperc=Zperc,
      ground_1=ground_1,
    ...
    redeclare BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformer conv3(
      VHigh=VHigh,
      XoverR=XoverR,
      Zperc=Zperc,
      ground_1=ground_1,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Conversion/BaseClasses/DY_a.png\"/>
</p>

<h4>Note:</h4>
<p>
This model reuses models from
<a href=\"modelica://BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformer\">
BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACTransformer</a>.
</p>
<p>
See
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverterStepDownDY\">
BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverterStepDownDY</a> for
