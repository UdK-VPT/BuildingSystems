...
model UnbalancedWindTurbine
  ...
  extends
    BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Sources.BaseClasses.BaseUnbalancedWindTurbine;
  extends
    BuildingSystems.Electrical.AC.ThreePhasesUnbalanced.Sources.BaseClasses.PartialSource;
protected
