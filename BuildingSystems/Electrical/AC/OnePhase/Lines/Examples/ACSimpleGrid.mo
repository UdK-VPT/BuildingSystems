within BuildingSystems.Electrical.AC.OnePhase.Lines.Examples;
...
__Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Lines/Examples/ACSimpleGrid.mos"
        "Simulate and plot"),
