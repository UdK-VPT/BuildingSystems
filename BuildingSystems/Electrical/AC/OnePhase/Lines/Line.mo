...
model Line "Model of an electrical line"
  extends BuildingSystems.Electrical.Transmission.BaseClasses.PartialLine(
    V_nominal(start = 110),
    ...
    commercialCable = BuildingSystems.Electrical.Transmission.Functions.selectCable_low(P_nominal, V_nominal));
protected
  replaceable TwoPortRL line(
    R=R/3,
    L=L/3,
    mode=modelMode) constrainedby
    BuildingSystems.Electrical.Transmission.BaseClasses.PartialTwoPortRLC(
      useHeatPort=true,
      M=M,
...
<a href=\"modelica://BuildingSystems.Electrical.AC.OnePhase.Lines.TwoPortRLC\">
BuildingSystems.Electrical.AC.OnePhase.Lines.TwoPortRLC</a>
...
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines.Line\">
BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines.Line</a>.
</li>
<li>
November 8, 2016, by Michael Wetter:<br/>
...
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\"> BuildingSystems.Electrical.Transmission.Functions.selectCable_low</span>
