...
model TwoPortResistance "Model of a resistance with two electrical ports"
  extends
    BuildingSystems.Electrical.Transmission.BaseClasses.PartialTwoPortResistance(
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/AC/OnePhase/Lines/twoPortR.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
