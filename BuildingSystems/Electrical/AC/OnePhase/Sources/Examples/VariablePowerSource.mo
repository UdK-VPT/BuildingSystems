...
model VariablePowerSource
  ...
  BuildingSystems.Electrical.AC.OnePhase.Sources.Generator generator(phiGen(displayUnit="deg") = 0.26179938779915, f=60)
    "AC generator model"
  ...
  BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive RL(mode=Types.Load.VariableZ_y_input,
      P_nominal=-300,
    V_nominal=120) "Load model"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingSystems.Electrical.AC.OnePhase.Sources.Grid grid(f=60, V=120)
...
equation
  ...
  annotation (    experiment(StopTime=1.0, Tolerance=1e-6),
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Sources/Examples/VariablePowerSource.mos"
        "Simulate and plot"),
