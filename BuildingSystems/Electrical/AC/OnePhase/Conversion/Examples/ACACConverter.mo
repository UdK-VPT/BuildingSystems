...
model ACACConverter
  ...
  BuildingSystems.Electrical.AC.OnePhase.Conversion.ACACConverter
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACACConverter.mos"
        "Simulate and plot"));
end ACACConverter;
