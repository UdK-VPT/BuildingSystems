within BuildingSystems.Electrical.AC.OnePhase.Loads;
model Resistive "Model of a resistive load"
  extends BuildingSystems.Electrical.Interfaces.ResistiveLoad(
...
equation
  ...
  if linearized then
    ...
    if initMode == BuildingSystems.Electrical.Types.InitMode.zero_current then
...
<code>mode</code>, see <a href=\"modelica://BuildingSystems.Electrical.Interfaces.Load\">
BuildingSystems.Electrical.Interfaces.Load</a> for more information.
</p>
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/AC/OnePhase/Loads/NonlinearLoad_labels.png\"/>
</p>
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/AC/OnePhase/Loads/LinearLoad_labels.png\"/>
</p>
...
BuildingSystems.Electrical.Interfaces.ResistiveLoad</a> in order
