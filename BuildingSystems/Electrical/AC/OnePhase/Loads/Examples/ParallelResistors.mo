...
model ParallelResistors
  ...
  BuildingSystems.Electrical.AC.OnePhase.Sources.FixedVoltage
  ...
  BuildingSystems.Electrical.AC.OnePhase.Loads.Resistive R(
    ...
    V_nominal=120) "Variable resistive load"
        ...
        extent={{-10,-10},{10,10}},
        origin={-22,10})));
  BuildingSystems.Electrical.AC.OnePhase.Loads.Resistive R1(
    mode=BuildingSystems.Electrical.Types.Load.FixedZ_steady_state, P_nominal=-1.2e3,
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/ParallelResistors.mos"
        "Simulate and plot"));
