...
model GeneratorLoadGrid "Generator with a load and grid connection"
  ...
  Sources.Generator sou(f=60, phiGen(displayUnit="rad")) "Gas turbine"
        ...
        extent={{-10,10},{10,-10}},
        origin={-30,-10})));
  BuildingSystems.Electrical.AC.OnePhase.Loads.Inductive res(
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Examples/GeneratorLoadGrid.mos"
        "Simulate and plot"),
