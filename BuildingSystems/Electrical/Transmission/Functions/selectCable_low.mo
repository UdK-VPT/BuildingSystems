...
function selectCable_low "This function is used to automatically select the
  ...
  output BuildingSystems.Electrical.Transmission.LowVoltageCables.Generic cable "Cable";
protected
  parameter Real safety_factor = 1.2;
  Modelica.Units.SI.Current I_nominal
    "Nominal current flowing through the line";
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu10 cu10;
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu20 cu20;
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu25 cu25;
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu35 cu35;
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu50 cu50;
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu95 cu95;
  BuildingSystems.Electrical.Transmission.LowVoltageCables.Cu100 cu100;
algorithm

  assert(Transmission.Functions.selectVoltageLevel(V_nominal) == BuildingSystems.Electrical.Types.VoltageLevel.Low,
  "In function BuildingSystems.Electrical.Transmission.Functions.selectCable_low,
...
BuildingSystems.Electrical.Transmission.LowVoltageCables</a>.
</p>
</html>"));
end selectCable_low;
