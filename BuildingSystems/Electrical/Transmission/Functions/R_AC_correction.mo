...
function R_AC_correction
  ...
  input BuildingSystems.Electrical.Transmission.Types.Material material
    "Material of the cable";
  output Real correction "Correction factor";
algorithm
  if material == BuildingSystems.Electrical.Transmission.Types.Material.Al then
    if size == "1/0" then
      correction := 1.0;
  ...
  elseif material == BuildingSystems.Electrical.Transmission.Types.Material.Cu then
    if size == "1/0" then
      correction := 1.0;
    elseif size == "2/0" then
      correction := 1.001;
    ...
    assert(material <> BuildingSystems.Electrical.Transmission.Types.Material.Al and
           material <> BuildingSystems.Electrical.Transmission.Types.Material.Cu,
    "In function BuildingSystems.Electrical.Transmission.Functions.R_AC_Correction,
