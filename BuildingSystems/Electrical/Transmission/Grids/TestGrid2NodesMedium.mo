within BuildingSystems.Electrical.Transmission.Grids;
record TestGrid2NodesMedium
  "Simple model of a grid with 2 nodes and 1 link for medium voltage"
  extends BuildingSystems.Electrical.Transmission.Grids.PartialGrid(
    nNodes=2,
    nLinks=1,
    fromTo=[[1,2]],
    l=[200],
...
<a href=\"modelica://BuildingSystems.Electrical.Transmission.Grids.TestGrid2Nodes\">
BuildingSystems.Electrical.Transmission.Grids.TestGrid2Nodes</a> because it defines a medium voltage
