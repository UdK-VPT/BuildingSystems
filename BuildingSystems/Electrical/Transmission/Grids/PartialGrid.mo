...
record PartialGrid "Partial model that represents a generalized grid"
  ...
  parameter Modelica.Units.SI.Length l[nLinks,1](each min=0)
    "Length of the cable";
  replaceable BuildingSystems.Electrical.Transmission.BaseClasses.BaseCable cables[nLinks]
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/Transmission/Grids/partialGrid.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
