within BuildingSystems.Electrical.Transmission.BaseClasses;
partial model PartialBaseLine "Partial cable line dispersion model"
  ...
  parameter BuildingSystems.Electrical.Types.Load modelMode=BuildingSystems.Electrical.Types.Load.FixedZ_steady_state
    "Select between steady state and dynamic model"
    annotation(Evaluate=true, Dialog(tab="Model", group="Assumptions", enable = use_C), choices(choice=BuildingSystems.Electrical.Types.Load.FixedZ_steady_state
        "Steady state", choice=BuildingSystems.Electrical.Types.Load.FixedZ_dynamic "Dynamic"));
  ...
  parameter BuildingSystems.Electrical.Types.CableMode mode=BuildingSystems.Electrical.Types.CableMode.automatic
  ...
  replaceable parameter
    ...
    BuildingSystems.Electrical.Transmission.BaseClasses.BaseCable
    "Commercial cables options"
    annotation(Evaluate=true, Dialog(tab="Tech. specification", group="Manual mode",
    enable = mode == BuildingSystems.Electrical.Types.CableMode.commercial),
...
<a href=\"modelica://BuildingSystems.Electrical.Transmission.BaseClasses.BaseCable\">
BuildingSystems.Electrical.Transmission.BaseClasses.BaseCable</a> such as (
<a href=\"modelica://BuildingSystems.Electrical.Transmission.LowVoltageCables.Generic\">
BuildingSystems.Electrical.Transmission.LowVoltageCables.Generic</a> or
<a href=\"modelica://BuildingSystems.Electrical.Transmission.MediumVoltageCables.Generic\">
BuildingSystems.Electrical.Transmission.MediumVoltageCables.Generic</a>).
...
<a href=\"modelica://BuildingSystems.Electrical.Transmission.LowVoltageCables\">
BuildingSystems.Electrical.Transmission.LowVoltageCables</a> and
<a href=\"modelica://BuildingSystems.Electrical.Transmission.MediumVoltageCables\">
BuildingSystems.Electrical.Transmission.MediumVoltageCables</a>.
</p>
...
properties can be found in <a href=\"modelica://BuildingSystems.Electrical.Transmission.Functions\">
BuildingSystems.Electrical.Transmission.Functions</a>.
</p>
<p>
...
<a href=\"modelica://BuildingSystems.Electrical.Transmission.MediumVoltageCables.Generic\">
BuildingSystems.Electrical.Transmission.MediumVoltageCables.Generic</a>.<br/>
The example models
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACLineMedium\">
BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACLineMedium</a> and
<a href=\"modelica://BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACSimpleGridMedium\">
BuildingSystems.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACSimpleGridMedium</a>
