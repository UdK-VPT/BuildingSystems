...
record Annealed_Al_500 "Annealed Al cable - AWG 500"
  extends BuildingSystems.Electrical.Transmission.MediumVoltageCables.Generic(
    ...
    d=20.066e-3,
    D=37.592e-3,
    GMR=BuildingSystems.Electrical.Transmission.Functions.computeGMR(d),
    GMD=BuildingSystems.Electrical.Transmission.Functions.computeGMD(0.1905),
    Amp=450);
