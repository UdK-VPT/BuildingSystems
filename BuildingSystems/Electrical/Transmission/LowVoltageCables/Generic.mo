within BuildingSystems.Electrical.Transmission.LowVoltageCables;
record Generic "Data record for a generic low voltage cable"
  ...
  parameter BuildingSystems.Electrical.Types.CharacteristicResistance RCha(start=0)
    "Characteristic resistance of the cable";
  parameter BuildingSystems.Electrical.Types.CharacteristicReactance XCha(start=0)
  ...
  redeclare function extends lineResistance
   ...
   input BuildingSystems.Electrical.Transmission.LowVoltageCables.Generic cable
