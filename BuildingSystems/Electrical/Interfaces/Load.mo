...
model Load "Partial model for a generic load"
  replaceable package PhaseSystem =
    ...
    BuildingSystems.Electrical.PhaseSystems.PartialPhaseSystem "Phase system"
  ...
  parameter BuildingSystems.Electrical.Types.Load mode(
    min=BuildingSystems.Electrical.Types.Load.FixedZ_steady_state,
    max=BuildingSystems.Electrical.Types.Load.VariableZ_y_input) = BuildingSystems.Electrical.Types.Load.FixedZ_steady_state
  ...
  parameter Modelica.Units.SI.Power P_nominal=0
    "Nominal power (negative if consumed, positive if generated). Used if mode <> BuildingSystems.Electrical.Types.Load.VariableZ_P_input"
    annotation (Dialog(group="Nominal conditions", enable=mode <> BuildingSystems.Electrical.Types.Load.VariableZ_P_input));
  ...
  parameter Modelica.Units.SI.Voltage V_nominal(min=0, start=110)
    "Nominal voltage (V_nominal >= 0)" annotation (Evaluate=true, Dialog(group=
          "Nominal conditions", enable=(mode == BuildingSystems.Electrical.Types.Load.FixedZ_dynamic
           or linearized)));
  parameter BuildingSystems.Electrical.Types.InitMode initMode(
  min=BuildingSystems.Electrical.Types.InitMode.zero_current,
  max=BuildingSystems.Electrical.Types.InitMode.linearized) = BuildingSystems.Electrical.Types.InitMode.zero_current
  ...
  Modelica.Blocks.Interfaces.RealInput y(min=0, max=1, unit="1")
    if (mode == BuildingSystems.Electrical.Types.Load.VariableZ_y_input)
  ...
  Modelica.Blocks.Interfaces.RealInput Pow(unit="W")
    if (mode == BuildingSystems.Electrical.Types.Load.VariableZ_P_input)
    "Power consumed" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={100,0})));
  replaceable BuildingSystems.Electrical.Interfaces.Terminal terminal(
...
initial equation
  if mode == BuildingSystems.Electrical.Types.Load.VariableZ_P_input then
...
equation
  ...
  if mode==BuildingSystems.Electrical.Types.Load.FixedZ_steady_state or
     mode==BuildingSystems.Electrical.Types.Load.FixedZ_dynamic then
    y_internal   = 1;
    P_internal = 0;
  elseif mode==BuildingSystems.Electrical.Types.Load.VariableZ_y_input then
    P_internal = 0;
  elseif mode==BuildingSystems.Electrical.Types.Load.VariableZ_P_input then
    y_internal = 1;
  end if;

  // Value of the load, depending on the type: fixed or variable
  if mode==BuildingSystems.Electrical.Types.Load.VariableZ_y_input then
...
<code>mode &lt;&gt; BuildingSystems.Electrical.Types.Load.VariableZ_P_input</code>.
This avoids a warning during translation of
<a href=\"modelica://BuildingSystems.Examples.ChillerPlant.DataCenterRenewables\">
BuildingSystems.Examples.ChillerPlant.DataCenterRenewables</a>.
</li>
<li>
September 4, 2014, by Michael Wetter:<br/>
Changed the parameter from <code>linear</code> to <code>linearized</code>
because <code>BuildingSystems.Fluid</code> also uses <code>linearized</code>.
...
<a href=\"modelica://BuildingSystems.Electrical.Interfaces.Terminal\">
BuildingSystems.Electrical.Interfaces.Terminal</a>
...
<a href=\"modelica://BuildingSystems.Electrical.Types.Load\">BuildingSystems.Electrical.Types.Load</a>:
</p>
...
<!-- ************ -->
<tr>
<td>BuildingSystems.Electrical.Types.Load.FixedZ_steady_state</td>
...
<!-- ************ -->
<tr>
<td>BuildingSystems.Electrical.Types.Load.FixedZ_dynamic</td>
...
<!-- ************ -->
<tr>
<td>BuildingSystems.Electrical.Types.Load.VariableZ_P_input</td>
...
<!-- ************ -->
<tr>
<td>BuildingSystems.Electrical.Types.Load.VariableZ_y_input</td>
