within BuildingSystems.Electrical.DC.Loads.Examples;
model LinearizedLoad "Example model to check the linearized load model"
  ...
  BuildingSystems.Electrical.DC.Loads.Conductor NonlinearLoad(
    linearized=false,
  ...
  BuildingSystems.Electrical.DC.Loads.Conductor LinearLoad(
    mode=BuildingSystems.Electrical.Types.Load.VariableZ_P_input,
    V_nominal=100,
    linearized=true,
...
equation
  ...
  annotation (            experiment(StopTime=1.0, Tolerance=1e-06),
          ...
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/DC/Loads/Examples/LinearizedLoad.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>This example demonstrates the use of a linealized load model <a href=\"modelica://BuildingSystems.Electrical.DC.Loads.Conductor\">BuildingSystems.Electrical.DC.Loads.Conductor</a>. </p>
...
<p align=\"center\"><img src=\"modelica://BuildingSystems/Resources/Images/Electrical/DC/Loads/Examples/DCload_approx.png\" alt=\"image\"/> </p>
