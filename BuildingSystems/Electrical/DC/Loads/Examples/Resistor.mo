...
model Resistor "Example model for resistor"
  ...
  BuildingSystems.Electrical.DC.Loads.Resistor res2(R=2, V_nominal=12) "Resistor"
  ...
  BuildingSystems.Electrical.DC.Loads.Resistor res1(R=2, V_nominal=12) "Resistor"
...
equation
  ...
  annotation (            experiment(StopTime=1.0, Tolerance=1e-06),
          ...
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/DC/Loads/Examples/Resistor.mos"
        "Simulate and plot"),
