...
model VariableLoad "Example using variable loads models"
  ...
  Conductor loa3(
    V_nominal=12,
    P_nominal=0,
    mode=BuildingSystems.Electrical.Types.Load.VariableZ_P_input) "Load"
...
equation
  ...
  annotation (            experiment(StopTime=1.0, Tolerance=1e-06),
          ...
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/DC/Loads/Examples/VariableLoad.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example shows how to use three different types of load models.
Each load is of type <a href=\"modelica://BuildingSystems.Electrical.DC.Loads.Conductor\">
BuildingSystems.Electrical.DC.Loads.Conductor</a>.
</p>
<p>
