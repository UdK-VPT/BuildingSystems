...
equation
  ...
  connect(constantVoltage.terminal, RC_dyn.terminal_n) annotation (Line(
      ...
      smooth=Smooth.None));
  annotation (
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/DC/Lines/Examples/RCModel.mos"
        "Simulate and plot"),
...
two connectors (see <a href=\"modelica://BuildingSystems.Electrical.DC.Lines.TwoPortRCLine\">
BuildingSystems.Electrical.DC.Lines.TwoPortRCLine</a> for more details).
</p>
<p>
