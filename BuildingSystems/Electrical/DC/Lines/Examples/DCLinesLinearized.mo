within BuildingSystems.Electrical.DC.Lines.Examples;
model DCLinesLinearized
  "Example model to test the possible combinations between line and load models"
  extends BuildingSystems.Electrical.DC.Lines.Examples.DCLines(linearLoads = true);

  annotation (Documentation(info="<html>
<p>
This model is the linearized version of the model
<a href=\"modelica://BuildingSystems.Electrical.DC.Lines.Examples.DCLines\">
BuildingSystems.Electrical.DC.Lines.Examples.DCLines</a> and
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/DC/Lines/Examples/DCLinesLinearized.mos"
        "Simulate and plot"));
