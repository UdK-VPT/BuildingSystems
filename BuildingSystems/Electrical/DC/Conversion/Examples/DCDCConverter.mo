within BuildingSystems.Electrical.DC.Conversion.Examples;
model DCDCConverter "Test model DC to DC converter"
  extends Modelica.Icons.Example;
  BuildingSystems.Electrical.DC.Loads.Conductor resistor(
  ...
  BuildingSystems.Electrical.DC.Sources.ConstantVoltage sou(V=120)
    "Voltage source"
    annotation (Placement(transformation(extent={{-90,-10},{-70,10}})));
  BuildingSystems.Electrical.DC.Conversion.DCDCConverter conDCDC(
    VHigh=120,
    VLow=60,
    eta=0.9,
    i_n(start=0)) "DC/DC transformer"
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
  BuildingSystems.Electrical.DC.Loads.Conductor conductor(mode=BuildingSystems.Electrical.Types.Load.VariableZ_P_input,
      V_nominal=60,
  ...
  BuildingSystems.Electrical.DC.Sensors.GeneralizedSensor sen "Power sensor"
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/DC/Conversion/Examples/DCDCConverter.mos"
        "Simulate and plot"),
