within BuildingSystems.Electrical.DC.Sensors;
...
equation
  ...
  V = BuildingSystems.Electrical.PhaseSystems.TwoConductor.systemVoltage(terminal_n.v);
  I = BuildingSystems.Electrical.PhaseSystems.TwoConductor.systemCurrent(terminal_n.i);
  P = BuildingSystems.Electrical.PhaseSystems.TwoConductor.activePower(v=terminal_n.v, i=terminal_n.i);
