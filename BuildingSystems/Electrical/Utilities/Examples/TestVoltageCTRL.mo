within BuildingSystems.Electrical.Utilities.Examples;
model TestVoltageCTRL
  "This test check the correctness of the voltage controller model"
  extends Modelica.Icons.Example;
  VoltageControl voltageControl(
  redeclare BuildingSystems.Electrical.DC.Interfaces.Terminal_p terminal,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildingSystems/Resources/Images/Electrical/Utilities/Examples/VoltCTRL.png\"/>
</p>
<p>
...
<i>t = 5</i> s to change the signal to one.
          ...
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Electrical/Utilities/Examples/TestVoltageCTRL.mos"
        "Simulate and plot"),
    experiment(
      StopTime=10,
      Tolerance=1e-6));
