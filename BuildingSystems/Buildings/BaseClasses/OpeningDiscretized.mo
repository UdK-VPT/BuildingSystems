...
equation
  ...
  for i in 1:nCom loop
    ...
    dVAB_flow[i] = dV_flow[i]*
      BuildingSystems.Utilities.Math.Functions.smoothHeaviside(x=dV_flow[i], delta=
...
Adaption of the class DoorDiscretized to general openings for doors and Windows.
</li>
<li>
