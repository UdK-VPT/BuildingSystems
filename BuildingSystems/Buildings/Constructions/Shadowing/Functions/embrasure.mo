...
function embrasure
  ...
  input Modelica.Units.SI.Length height "Height of the embrasure";
  input Modelica.Units.SI.Length width "Width of the embrasure";
  input Modelica.Units.SI.Length depth "Depth of the embrasure";
