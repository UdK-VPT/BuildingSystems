...
model WallThermal1DNodesFlexGeo
  ...
  Modelica.Blocks.Sources.Sine width(
    ...
    f=1/86400,
    startTime=0,
    offset=2) annotation (Placement(transformation(extent={{-16,18},{-10,24}})));
...
equation
  ...
  connect(wall.position_in, position.y) annotation (Line(points={{2.2,-6},{4,-6},
          {4,-19},{5.7,-19}}, color={0,0,127}));
