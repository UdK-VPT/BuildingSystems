...
model BuildingThermal1Zone1DCylinder_Vis3D
  "1D-thermal cylinder shaped building model with 1 zone under real weather data and 3D visualisation"
  ...
  BuildingSystems.Buildings.BuildingTemplates.Building1Zone1DCylinder_Vis3D building(
    minTempVis3D = 273.15-10.0,
    maxTempVis3D = 273.15+30.0,
    updateInterval = 3600.0, // update intervall for 3D visualisation
    height = 2.8,
    diameter = 2.0,
    nSeg = 10,
    redeclare
...
equation
  ...
  annotation(experiment(StartTime=0, StopTime=31536000),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Buildings/Examples/BuildingThermal1Zone1DCylinder_Vis3D.mos" "Simulate and plot"),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-60,-60},{60,60}}), graphics={Text(extent={{-52,-18},{52,-86}},lineColor={0,0,255},
    textString="Predefined 1D-Thermal building model with 1 zone under real weather data")}),Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-40},{100,40}})));
end BuildingThermal1Zone1DCylinder_Vis3D;
