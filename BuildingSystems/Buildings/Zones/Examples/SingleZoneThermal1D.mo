...
equation
  ...
  connect(ambience.xAir, zone.xAirAmb) annotation (Line(
      points={{-57,5},{-58,5},{-58,-30},{-26,-30},{-26,-8},{-11,-8}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  annotation(experiment(StartTime=0, StopTime=31536000),
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-60,-60},{60,40}}), graphics={
