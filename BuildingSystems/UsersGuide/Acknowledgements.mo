...
class Acknowledgements "Acknowledgements"
  ...
  annotation (Documentation(info="<html>
      ...
      <p>
      The following people from Berlin University of the Arts, Institute for Architecture and Urban Planning, have directly contributed to the implementation of the <code>BuildingSystems</code> library
      </p>
      <ul>
      <li>Christoph Nytsch-Geusen
      </li>
      <li>Alexander Inderfurth
      </li>
      <li>Jens Moeckel
      </li>
      <li>Katharina Mucha
      </li>
      <li>Carles Ribas Tugores
      </li>
      <li>Jorg Raedler
      </li>
      <li>Matthis Thorade
