within BuildingSystems.ThermalZones.ISO13790.Zone5R1C;
model ZoneHVAC "Thermal zone for HVAC based on 5R1C network"
  ...
  replaceable package Medium = Modelica.Media.Interfaces.PartialMedium annotation (
        choices(choice(redeclare package Medium = BuildingSystems.Media.Air "Moist air")));
  ...
  Fluid.MixingVolumes.MixingVolumeMoistAir vol(
    ...
    m_flow_nominal=VRoo*BuildingSystems.Media.Air.dStp*3/3600,
    V=VRoo,
...
<p>
This models is identical to <a href=\"modelica://BuildingSystems.ThermalZones.ISO13790.Zone5R1C.Zone\">
BuildingSystems.ThermalZones.ISO13790.Zone5R1C.Zone</a>, except that a mixing volume is added
