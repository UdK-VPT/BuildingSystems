...
model HeatRadiationParallelSurfaces
  ...
  Modelica.Units.SI.Temperature T2 "Temperature surface 2";
  Modelica.Units.SI.HeatFlux q_flow "Heat flux between surface 1 and surface 2";
equation
  ...
  annotation(experiment(StopTime=3600.0),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/HAM/HeatRadiation/Examples/HeatRadiationParallelSurfaces.mos" "Simulate and plot"),
    Documentation(info="<html>
    <p> This example tests the implementation of
    <a href=\"modelica://BuildingSystems.HAM.HeatRadiation.HeatRadiationParallelSurfaces\">
