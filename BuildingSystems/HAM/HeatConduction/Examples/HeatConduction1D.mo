...
model HeatConduction1D "1D dynamic heat conduction of 5 bodies"
  ...
  Modelica.Blocks.Sources.Sine climate(amplitude=10.0,freqHz=1.0/86400.0,phase=6.2831853071796,offset=273.15+20.0)
...
equation
  ...
  annotation(experiment(StartTime=0,StopTime=172800,Interval = 360),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/HAM/HeatConduction/Examples/HeatConduction1D.mos"
        "Simulate and plot"),
    ...
    textString="1D dynamic heat conduction of 5 bodies")}),Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-40},{100,40}})));
