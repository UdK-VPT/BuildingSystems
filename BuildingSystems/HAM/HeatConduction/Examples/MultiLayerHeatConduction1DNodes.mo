...
equation
  ...
  annotation(experiment(StartTime=0, StopTime=864000,Interval = 3600),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/HAM/HeatConduction/Examples/MultiLayerHeatConduction1DNodes.mos" "Simulate and plot"),
