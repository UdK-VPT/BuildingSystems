...
record Gipskartonplatte =
    ...
    sorTabY={0.0,3.6,5.2,6.3,11.0,17.3,19.0,113.0,124.0,328.0,378.0,400.0},
    myTabX={0.0,1.0},
    myTabY={6.0,6.0},
    lambdaTabX={0.0,650.0},
    lambdaTabY={0.16,0.16},
    dwwTabX={0.0,60.0,100.0,160.0,240.0,320.0,360.0,380.0,400.0},
    dwwTabY={1.0e-16,3.0e-9,8.0e-9,8.0e-9,1.2e-8,1.0e-8,3.0e-7,7.0e-7,1.0e-6},
